...
// dont do any UE4 OpenGLDebug stuff
...
//	static FORCEINLINE bool SupportsResourceView()						{ return true; } // DO NOT USE THIS !!! (for FOpenGLDynamicRHI::RHISetShaderResourceViewParameter())
	// Optional
	...
	{
		if (PreferredPixelFormat == PF_A2B10G10R10)
	...
	{
		// https://answers.unrealengine.com/questions/409649/html5-opengl-backend-doesnt-need-to-flush-gl-comma.html
		// i.e. DO NOTHING // glFlush();
	}
