...
bool FHTML5Socket::SetNonBlocking(bool bIsNonBlocking)
{
 ...
 */
class FSocketBSD* FSocketSubsystemHTML5::InternalBSDSocketFactory(SOCKET Socket, ESocketType SocketType, const FString& SocketDescription, const FName& SocketProtocol)
{
	// return a new socket object
	return new FHTML5Socket(Socket, SocketType, SocketDescription, SocketProtocol, this);
}
