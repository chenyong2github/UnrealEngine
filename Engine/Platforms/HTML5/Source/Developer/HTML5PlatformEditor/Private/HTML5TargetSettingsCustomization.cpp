			...
			[
				...
				[
					...
					.Text(LOCTEXT("HTML5DeprecatedPlatformMessageText",
						"HTML5 platform deprecated!  To be moved as a community supported platform."))
				]
			]
		];
	}
...
{
	IDetailCategoryBuilder& HTML5PlatformDeprecatedCategory = DetailLayout.EditCategory(TEXT("HTML5 Platform Deprecated"));
