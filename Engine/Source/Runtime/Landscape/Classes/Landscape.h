...
public:
	...
	static void SplitHeightmap(ULandscapeComponent* Comp, bool bMoveToCurrentLevel = false, FMaterialUpdateContext* InOutUpdateContext = nullptr, TArray<FComponentRecreateRenderStateContext>* InOutRecreateRenderStateContext = nullptr, bool InReregisterComponent = true);
