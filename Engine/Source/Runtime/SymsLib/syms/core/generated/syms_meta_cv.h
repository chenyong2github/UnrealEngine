...
#define SYMS_CvFrameprocFlags_Extract_LocalBasePointer(f) (SYMS_U32)(((f) >> SYMS_CvFrameprocFlag_LocalBasePointer_SHIFT) & SYMS_CvFrameprocFlag_LocalBasePointer_MASK)
#define SYMS_CvFrameprocFlags_Extract_ParamBasePointer(f) (SYMS_U32)(((f) >> SYMS_CvFrameprocFlag_ParamBasePointer_SHIFT) & SYMS_CvFrameprocFlag_ParamBasePointer_MASK)
