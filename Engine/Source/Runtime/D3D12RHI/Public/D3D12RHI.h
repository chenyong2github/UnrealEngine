...
#ifndef PLATFORM_ALLOW_D3D12_SUBMISSION_GAP_REDCORDER
#define PLATFORM_ALLOW_D3D12_SUBMISSION_GAP_REDCORDER 0
#endif

#if PLATFORM_ALLOW_D3D12_SUBMISSION_GAP_REDCORDER
