...
DEFINE_STAT(STAT_D3D12TransientMemoryPoolAllocated);
DEFINE_STAT(STAT_D3D12TransientMemoryFramePoolUsed);
DEFINE_STAT(STAT_D3D12TransientMemoryFrameCommittedUsed);
DEFINE_STAT(STAT_D3D12TransientMemoryPoolAllocations);
DEFINE_STAT(STAT_D3D12TransientMemoryCommittedAllocations);

DEFINE_STAT(STAT_D3D12TransientMemoryBufferFrameUsed);
DEFINE_STAT(STAT_D3D12TransientMemoryBufferFrameTotalRequested);
DEFINE_STAT(STAT_D3D12TransientMemoryBufferFrameCommittedAllocated);
DEFINE_STAT(STAT_D3D12TransientMemoryBufferPoolAllocations);
DEFINE_STAT(STAT_D3D12TransientMemoryBufferCommittedAllocations);

DEFINE_STAT(STAT_D3D12TransientMemoryTextureFrameUsed);
DEFINE_STAT(STAT_D3D12TransientMemoryTextureFrameTotalRequested);
DEFINE_STAT(STAT_D3D12TransientMemoryTextureFrameCommittedAllocated);
DEFINE_STAT(STAT_D3D12TransientMemoryTexturePoolAllocations);
DEFINE_STAT(STAT_D3D12TransientMemoryTextureCommittedAllocations);
