...
public:
	...
	bool Initialize(const FAudioEncoderConfig& InConfig) override;
	void Shutdown() override;
	void Encode(const FAudioFrame& Frame) override;
	FAudioEncoderConfig GetConfig() const override;
...
bool FWmfAudioEncoder::Initialize(const FAudioEncoderConfig& InConfig)
{
...
void FWmfAudioEncoder::Encode(const FAudioFrame& Frame)
{
	...
	while (true)
	{
		...
		FAVPacket Packet(EPacketType::Audio);
...
FAudioEncoderConfig FWmfAudioEncoder::GetConfig() const
{
	return Config;
}
