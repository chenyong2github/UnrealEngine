...
{
	if (InAnimInstance->GetSkelMeshComponent() && InAnimInstance->GetSkelMeshComponent()->GetSkeletalMesh())
	{
		GatherBoneReferences(InAnimInstance->GetSkelMeshComponent()->GetSkeletalMesh()->GetRefSkeleton());
	}
}
