...
public:
	...
	void DrawIndexedPrimitive(FAGXBuffer const& IndexBuffer, uint32 IndexStride, MTLIndexType IndexType, uint32 PrimitiveType, int32 BaseVertexIndex, uint32 FirstInstance,
