...
/*=============================================================================
	AGXShaderDebugZipFile.cpp: AGX shader RHI implementation.
=============================================================================*/
...
FAGXShaderDebugZipFile::FAGXShaderDebugZipFile(FString LibPath)
	: File(nullptr)
{
	...
	if (File)
	{
		...
		if (bOK)
		{
			...
			if (bOK)
			{
				...
				uint32 FileHeaderFixedSize = sizeof(FileHeader) + sizeof(FAGXZipFileHeader) + sizeof(uint16) + sizeof(FAGXZipFileTrailer);
...
FAGXShaderDebugZipFile::~FAGXShaderDebugZipFile()
{
	if (File)
	{
		delete File;
