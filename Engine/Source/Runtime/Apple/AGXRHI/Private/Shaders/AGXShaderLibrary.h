...
/*=============================================================================
	AGXShaderLibrary.h: AGX RHI Shader Library Class.
=============================================================================*/

#pragma once

class FAGXShaderLibrary final : public FRHIShaderLibrary
{
public:
	static FCriticalSection LoadedShaderLibraryMutex;
	static TMap<FString, FRHIShaderLibrary*> LoadedShaderLibraryMap;

	FAGXShaderLibrary(EShaderPlatform Platform,
						FString const& Name,
...
private:
	...
	class FAGXShaderDebugZipFile* DebugFile;
#endif
};
