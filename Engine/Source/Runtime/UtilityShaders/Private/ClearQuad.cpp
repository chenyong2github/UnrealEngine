...
void ClearUAV(FRDGBuilder& GraphBuilder, FRDGEventName&& PassName, FRDGBufferUAVRef BufferUAV, uint32 Value)
{
...
template <typename T>
void ClearUAV_T(FRDGBuilder& GraphBuilder, FRDGEventName&& PassName, FRDGTextureUAVRef TextureUAV, const T(&ClearValues)[4])
{
	...
	{
		::ClearUAV(RHICmdList, TextureUAV->GetParent()->GetRHI(), TextureUAV->GetRHI(), ClearValues);
	});
}

void ClearUAV(FRDGBuilder& GraphBuilder, FRDGEventName&& PassName, FRDGTextureUAVRef TextureUAV, const float(&ClearValues)[4])
{
	ClearUAV_T(GraphBuilder, Forward<FRDGEventName>(PassName), TextureUAV, ClearValues);
}

void ClearUAV(FRDGBuilder& GraphBuilder, FRDGEventName&& PassName, FRDGTextureUAVRef TextureUAV, const uint32(&ClearValues)[4])
{
	ClearUAV_T(GraphBuilder, Forward<FRDGEventName>(PassName), TextureUAV, ClearValues);
}

void ClearUAV(FRDGBuilder& GraphBuilder, FRDGEventName&& PassName, FRDGTextureUAVRef TextureUAV, const FLinearColor& ClearColor)
{
	ClearUAV_T(GraphBuilder, Forward<FRDGEventName>(PassName), TextureUAV, reinterpret_cast<const float(&)[4]>(ClearColor));
}
