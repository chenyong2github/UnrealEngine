...
namespace Chaos
{
	...
	int32 Chaos_Collision_UseAccumulatedImpulseClipSolve = 1; // Experimental: This requires multiple contact points per iteration per pair, and making sure the contact points don't move too much in body space
