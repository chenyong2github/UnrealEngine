...
namespace Chaos
{
	...
	public:
		...
		static FReal SuggestEpsilon(const TArray<FVec3>& InVertices)
		{
			...
			{
				TVector<FReal, 3> PositionAbs = InVertices[Index].GetAbs();
	...
	public:
		...
		static void MergeFaces(TArray<TPlaneConcrete<FReal, 3>>& InOutPlanes, TArray<TArray<int32>>& InOutFaceVertexIndices, const TArray<FVec3>& Vertices)
		{
