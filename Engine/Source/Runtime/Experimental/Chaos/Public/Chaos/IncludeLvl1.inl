...
//#error "Cannot include level 1 file. If outside chaos this should be in a cpp file and should be undefined after includes are done. Use Non-Unity build to see cpp file"
#endif