...
namespace Chaos
{
	...
	namespace DebugDraw
	{
		...
		CHAOS_API void DrawCollisions(const FRigidTransform3& SpaceTransform, const FPBDConstraintGraph& Graph, FRealSingle ColorScale, const FChaosDebugDrawSettings* Settings = nullptr);
