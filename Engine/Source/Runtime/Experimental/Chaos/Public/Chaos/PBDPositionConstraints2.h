...
class TPBDPositionConstraints2 : public TPBDConstraintContainer<T, d>
{
  public:
	TPBDPositionConstraints2(const T InStiffness = (T)1)
		: Stiffness(InStiffness)
	{}

	TPBDPositionConstraints2(TArray<TVector<T, d>>&& Locations, TArray<TPBDRigidParticleHandle<T,d>*>&& InConstrainedParticles, const T InStiffness = (T)1)
		: Targets(MoveTemp(Locations)), ConstrainedParticles(MoveTemp(InConstrainedParticles)), Stiffness(InStiffness)
	{}

	virtual ~TPBDPositionConstraints2() {}
