...
namespace Chaos
{
	...
	template<typename T, int d>
	class CHAOS_API TPBDConstraintGraph2
	{
	public:
		template <typename T2, int d2>
		friend class TPBDConstraintColor2;
		...
		TPBDConstraintGraph2(const TArray<TGeometryParticleHandle<T,d>*>& Particles);
		virtual ~TPBDConstraintGraph2() {}
		 ...
		 */
		void InitializeGraph(const TArray<TGeometryParticleHandle<T, d>*>& Particles);
		...
		void ResetIslands(const TArray<TGeometryParticleHandle<T, d>*>& Particles);
		 ...
		 */
		void UpdateIslands(const TArray<TGeometryParticleHandle<T, d>*>& Particles, TSet<TGeometryParticleHandle<T,d>*>& ActiveParticles);
	...
	private:
		...
		void ComputeIslands(const TArray<TGeometryParticleHandle<T,d>*>& Particles, TSet<TGeometryParticleHandle<T,d>*>& ActiveParticles);
		void ComputeIsland(const TArray<TGeometryParticleHandle<T, d>*>& Particles, const int32 Node, const int32 Island,
