...
namespace Chaos
{
	...
	namespace Collisions
	{
		...
		template<typename T, int d>
		void CHAOS_API UpdateManifold(TRigidBodyMultiPointContactConstraint<T, d>& Constraint, const TRigidTransform<T, d>& ATM, const TRigidTransform<T, d>& BTM, const T CullDistance);
