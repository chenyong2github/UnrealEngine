...
public:
	...
	void SetScale(const FVec2& InScale) { Scale = FVec2(FMath::Clamp((FReal)InScale.X, (FReal)0.01, (FReal)10.), FMath::Clamp((FReal)InScale.Y, (FReal)0.01, (FReal)10.)); }  // TODO: Fix FVec2 PS4 double to float conversion error as to remove extra cast to FReal
