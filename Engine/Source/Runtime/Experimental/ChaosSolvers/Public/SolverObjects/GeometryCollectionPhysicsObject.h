...
class CHAOSSOLVERS_API FGeometryCollectionPhysicsObject : public TSolverObject<FGeometryCollectionPhysicsObject>
{
public:
	...
	FGeometryCollectionPhysicsObject() = delete;
	FGeometryCollectionPhysicsObject(UObject* InOwner, FGeometryDynamicCollection* InDynamicCollection, FInitFunc InInitFunc, FCacheSyncFunc InCacheSyncFunc, FFinalSyncFunc InFinalSyncFunc);
	virtual ~FGeometryCollectionPhysicsObject();
	...
	void BufferCommand(Chaos::FPBDRigidsSolver* InSolver, const FFieldSystemCommand& Command) { Commands.Add(Command); }
	...
	*/
	void ContiguousIndices(TArray<ContextIndex>& IndicesArray, const Chaos::FPBDRigidsSolver* RigidSolver, EFieldResolutionType ResolutionType, bool bForce);
