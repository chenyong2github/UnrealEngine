...
void UMeshSelectionSet::AddIndices(EMeshSelectionElementType ElementType, const TArray<int>& Indices)
{
...
void UMeshSelectionSet::RemoveIndices(EMeshSelectionElementType ElementType, const TArray<int>& Indices)
{
	TArray<int>& CurElements = GetElements(ElementType);
