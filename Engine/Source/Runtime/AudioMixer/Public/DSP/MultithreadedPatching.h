...
{
	/**
	 * This class can be thought of as an output
	 */
	struct AUDIOMIXER_API FPatchOutput
	{
	public:
	...
	/**
	 * Safe handle to a FPatchOutput. Should only be used by a single thread.
	 */
	class AUDIOMIXER_API FPatchInput
	{
	public:
	 ...
	 */
	class AUDIOMIXER_API FPatchMixer
	{
	public:
		/** Constructor. */
		FPatchMixer();
		...
		FORCEINLINE FPatchInput AddNewInput(int32 MaxLatencyInSamples, float InGain);
	 ...
	 */
	class AUDIOMIXER_API FPatchSplitter
	{
	public:
		/** Constructor. */
		FPatchSplitter();
		 ...
		 */
		FORCEINLINE FPatchOutputStrongPtr AddNewPatch(int32 MaxLatencyInSamples, float InGain);
	...
	public:
		 ...
		 * the returned FPatchOutputPtr can be safely destroyed at any point.
		 */
		FORCEINLINE FPatchOutputStrongPtr AddNewOutput(int32 MaxLatencyInSamples, float InGain);
