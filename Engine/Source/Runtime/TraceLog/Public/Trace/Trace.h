...
#define UE_TRACE_EVENT_BEGIN(LoggerName, EventName)			TRACE_PRIVATE_EVENT_BEGIN(LoggerName, EventName)
...
#define UE_TRACE_EVENT_SIZE(LoggerName, EventName)			TRACE_PRIVATE_EVENT_SIZE(LoggerName, EventName)
