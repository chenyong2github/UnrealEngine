...
{
	SLATE_ADD_MEMBER_ATTRIBUTE_DEFINITION(AttributeInitializer, IntAttributeA, EInvalidateWidgetReason::ChildOrder)
		.OnInvalidation(FSlateAttributeDescriptor::FInvalidationDelegate::CreateLambda([](SWidget& Widget)
			{
...
{
	AttributeInitializer.OverrideOnInvalidation("IntAttributeA"
		, FSlateAttributeDescriptor::EInvalidationDelegateOverrideType::ReplacePrevious
		, FSlateAttributeDescriptor::FInvalidationDelegate::CreateLambda([](SWidget& Widget)
			{
	...
	AttributeInitializer.OverrideOnInvalidation("IntAttributeB"
		, FSlateAttributeDescriptor::EInvalidationDelegateOverrideType::ExecuteAfterPrevious
		, FSlateAttributeDescriptor::FInvalidationDelegate::CreateLambda([](SWidget& Widget)
			{
				SAttributeLeftWidget_OnInvalidationChild& Instance = static_cast<SAttributeLeftWidget_OnInvalidationChild&>(Widget);
				Instance.OverrideCallbackValueB = Instance.CallbackValueB;
			}));
	AttributeInitializer.OverrideOnInvalidation("IntAttributeC"
		, FSlateAttributeDescriptor::EInvalidationDelegateOverrideType::ExecuteBeforePrevious
		, FSlateAttributeDescriptor::FInvalidationDelegate::CreateLambda([](SWidget& Widget)
			{
				SAttributeLeftWidget_OnInvalidationChild& Instance = static_cast<SAttributeLeftWidget_OnInvalidationChild&>(Widget);
...
{
	const int NumberOfAttributeInSWidget = 2;
...

	{
		...
		AddErrorIfFalse(AttributeDescriptor.AttributeNum() == 8 + NumberOfAttributeInSWidget, TEXT("")); // H is not counted
