...
namespace CoreStyleConstants
{
	...
	inline const FVector2D Icon5x16(5.0f, 16.0f);
	inline const FVector2D Icon8x4(8.0f, 4.0f);
	inline const FVector2D Icon16x4(16.0f, 4.0f);
	inline const FVector2D Icon8x8(8.0f, 8.0f);
	inline const FVector2D Icon10x10(10.0f, 10.0f);
	inline const FVector2D Icon12x12(12.0f, 12.0f);
	inline const FVector2D Icon12x16(12.0f, 16.0f);
	inline const FVector2D Icon14x14(14.0f, 14.0f);
	inline const FVector2D Icon16x16(16.0f, 16.0f);
	inline const FVector2D Icon18x18(18.0f, 18.0f);
	inline const FVector2D Icon20x20(20.0f, 20.0f);
	inline const FVector2D Icon22x22(22.0f, 22.0f);
	inline const FVector2D Icon24x24(24.0f, 24.0f);
	inline const FVector2D Icon25x25(25.0f, 25.0f);
	inline const FVector2D Icon32x32(32.0f, 32.0f);
	inline const FVector2D Icon40x40(40.0f, 40.0f);
	inline const FVector2D Icon64x64(64.0f, 64.0f);
	inline const FVector2D Icon36x24(36.0f, 24.0f);
	inline const FVector2D Icon128x128(128.0f, 128.0f);
