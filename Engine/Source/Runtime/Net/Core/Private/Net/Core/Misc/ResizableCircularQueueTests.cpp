...
bool FResizableCircularQueueTest::RunTest(const FString& Parameters)
{
	// Test empty
	{
		...
		TestEqual(TEXT("Test empty - Size"), Q.Count(), 0u);
		TestTrue(TEXT("Test empty - IsEmpty"), Q.IsEmpty());
		TestEqual(TEXT("Test empty - Capacity"), Q.AllocatedCapacity(), 0u);
	}
	...
	// Test Push and pop all
	{
		...
		TestEqual(TEXT("Test Push and pop all - Size before"), Q.Count(), 0u);
		...
		TestEqual(TEXT("Test Push and pop all - Size after"), Q.Count(), 0u);
	...
	// Test index wrap
	{
		...
		TestEqual(TEXT("Test index wrap - Size before"), Q.Count(), 0u);
		...
		TestEqual(TEXT("Test index wrap - Size after"), Q.Count(), 0u);
	...
	// Test Trim empty
	{
		...
		TestEqual(TEXT("Test trim empty - Size"), Q.Count(), 0u);
		TestEqual(TEXT("Test trim empty - Capacity"), Q.AllocatedCapacity(), 0u);
	}
