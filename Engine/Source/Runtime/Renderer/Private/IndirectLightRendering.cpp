	...
	for (FViewInfo& View : Views)
	{
		...
		if (DenoiserOutputs.Color || bApplySSAO)
		{
				...
				[PassParameters, &View, PixelShader, PermutationVector](FRHICommandList& RHICmdList)
			{
				...
				{
					GraphicsPSOInit.BlendState = TStaticBlendState<CW_RGBA, BO_Add, BF_DestAlpha, BF_One, BO_Add, BF_DestAlpha, BF_Zero>::GetRHI();
				}
				else
				{
					GraphicsPSOInit.BlendState = TStaticBlendState<CW_RGB, BO_Add, BF_One, BF_One, BO_Add, BF_One, BF_Zero>::GetRHI();
				}
