...
BEGIN_SHADER_PARAMETER_STRUCT(FVolumetricCloudCommonShaderParameters, )
	...
	SHADER_PARAMETER_ARRAY(FMatrix44f,	CloudShadowmapWorldToLightClipMatrix, [2])
	SHADER_PARAMETER_ARRAY(FMatrix44f,	CloudShadowmapWorldToLightClipMatrixInv, [2])
	...
	SHADER_PARAMETER(FMatrix44f,	CloudSkyAOWorldToLightClipMatrixInv)
