...
BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FMobileBasePassUniformParameters, )
	...
	SHADER_PARAMETER(FVector4, DynamicSpotLightShadowBufferSize)
	SHADER_PARAMETER_TEXTURE(Texture2D, DynamicSpotLightShadowTexture)
	SHADER_PARAMETER_SAMPLER(SamplerState, DynamicSpotLightShadowSampler)
