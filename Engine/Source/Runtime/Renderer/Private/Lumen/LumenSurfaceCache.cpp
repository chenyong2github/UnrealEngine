...
const FLumenSurfaceLayerConfig& GetSurfaceLayerConfig(ELumenSurfaceCacheLayer Layer)
{
	static FLumenSurfaceLayerConfig Configs[(uint32)ELumenSurfaceCacheLayer::MAX] =
	{
		...
		{ TEXT("Normal"),	PF_R32G32_UINT,	PF_BC5,		PF_R32G32B32A32_UINT,	FVector(0.0f, 0.0f, 0.0f)		},
		{ TEXT("Emissive"), PF_R32G32_UINT,	PF_BC6H,	PF_R32G32B32A32_UINT,	FVector(1000.0f, 1000.0f, 0.0f)	}
	};
