...
)
{
	...
	// Cast rays
	{
		...
		FIntPoint DispatchResolution(PersistentTracingGroupCount * FLumenRadianceCacheHardwareRayTracingRGS::GetGroupSize() * FLumenRadianceCacheHardwareRayTracingRGS::GetGroupSize(), 1);
