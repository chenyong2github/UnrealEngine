	...
	FRDGBufferRef IndirectArgsBuffer)
{
	...
	PermutationVector.Set<FHairEnvironmentLightingCS::FUseSceneColor>(bUseSceneColor ? 1 : 0);
	PermutationVector = FHairEnvironmentLightingCS::RemapPermutation(PermutationVector);
