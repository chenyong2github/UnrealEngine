...
)
{
	...
	{
		// Emit depth, stencil, and velocity buffers (TODO)
	...
	else
	{
		...
		{
			// Emit scene depth, stencil, and velocity buffers (TODO)
		...
		else
		{
			...
			// Emit stencil and velocity buffers (TODO)
			{
