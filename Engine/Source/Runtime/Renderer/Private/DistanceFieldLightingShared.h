...
public:
	...
	void Initialize()
	{
		...
		TileNumCulledObjects.Initialize(sizeof(uint32), AlignedDimensions.X * AlignedDimensions.Y, PF_R32_UINT, BUF_Static, TEXT("FLightTileIntersectionResources::TileNumCulledObjects"));
		TileStartOffsets.Initialize(sizeof(uint32), AlignedDimensions.X * AlignedDimensions.Y, PF_R32_UINT, BUF_Static, TEXT("FLightTileIntersectionResources::TileStartOffsets"));
		...
		TileArrayData.Initialize(b16BitIndices ? sizeof(uint16) : sizeof(uint32), GAverageObjectsPerShadowCullTile * AlignedDimensions.X * AlignedDimensions.Y * LightTileDataStride, b16BitIndices ? PF_R16_UINT : PF_R32_UINT, BUF_Static, TEXT("FLightTileIntersectionResources::TileArrayData"));
	}
