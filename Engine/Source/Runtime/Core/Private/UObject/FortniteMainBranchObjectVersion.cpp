...
TMap<FGuid, FGuid> FFortniteMainBranchObjectVersion::GetSystemGuids()
{
	...
	SystemGuids.Add(DevGuids.NIAGARASHADERMAP_DERIVEDDATA_VER, FGuid("F2AE85B9ADEE4970806C35D997DD435E"));
	SystemGuids.Add(DevGuids.Niagara_LatestScriptCompileVersion, FGuid("9CFE679BEE95F345BBC06744597AC064"));
