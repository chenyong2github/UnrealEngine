...
TMap<FGuid, FGuid> FUE5MainStreamObjectVersion::GetSystemGuids()
{
	...
	SystemGuids.Add(DevGuids.NANITE_DERIVEDDATA_VER, FGuid("DAC47956CDBF995D96F4520EDB56D875"));
	SystemGuids.Add(DevGuids.NIAGARASHADERMAP_DERIVEDDATA_VER, FGuid("8A37C45D24F2423CBE5F8F371DE33575"));
	SystemGuids.Add(DevGuids.Niagara_LatestScriptCompileVersion, FGuid("28A43FC8EA00004E8B96B946BCA110F6"));
