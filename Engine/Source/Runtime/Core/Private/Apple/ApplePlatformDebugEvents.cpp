...
#define APPLE_PROFILING_SIGNPOST ((!PLATFORM_MAC && __IPHONE_OS_VERSION_MIN_REQUIRED >= __IPHONE_12_0) || PLATFORM_TVOS || (PLATFORM_MAC && __MAC_OS_X_VERSION_MIN_REQUIRED >= __MAC_10_14))
