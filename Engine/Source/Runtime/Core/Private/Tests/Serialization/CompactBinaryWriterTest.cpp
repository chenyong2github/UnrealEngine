...
bool FCbWriterObjectTest::RunTest(const FString& Parameters)
{
	...
	// Test Empty Object
	{
		...
		if (TestEqual(TEXT("FCbWriter(Object, Empty) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Named Empty Object
	{
		...
		Writer.EndObject();
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Object, Empty, Name) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Basic Object
	{
		...
		Writer.EndObject();
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Object, Basic) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Uniform Object
	{
		...
		Writer.EndObject();
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Object, Uniform) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
...
bool FCbWriterArrayTest::RunTest(const FString& Parameters)
{
	...
	// Test Empty Array
	{
		...
		Writer.EndArray();
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Array, Empty) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Named Empty Array
	{
		...
		Writer.EndArray();
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Array, Empty, Name) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Basic Array
	{
		...
		Writer.EndArray();
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Array, Basic) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Uniform Array
	{
		...
		Writer.EndArray();
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Array, Uniform) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
...
bool FCbWriterNullTest::RunTest(const FString& Parameters)
{
	...
	// Test Null
	{
		...
		Writer.Null();
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Null) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Null with Name
	{
		...
		Writer.Null();
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Null, Name) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
			TestEqual(TEXT("FCbWriter(Null, Name).Name()"), Field.Name(), "Null"_ASV);
	...
	// Test Null Array/Object Uniformity
	{
		...
		TestEqual(TEXT("FCbWriter(Null, Uniform) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None);
	}
...
bool FCbWriterBinaryTest::RunTest(const FString& Parameters)
{
	...
	// Test Empty Binary
	{
		...
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Binary, Empty) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Basic Binary
	{
		...
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Binary, Array) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
			TestEqual(TEXT("FCbWriter(Binary, Array).Name()"), Field.Name(), "Binary"_ASV);
...
bool FCbWriterStringTest::RunTest(const FString& Parameters)
{
	...
	// Test Empty Strings
	{
		...
		FCbFieldRefIterator Fields = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(String, Empty) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Basic Strings
	{
		...
		FCbFieldRefIterator Fields = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(String, Basic) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
			for (FCbField Field : Fields)
			{
				TestEqual(TEXT("FCbWriter(String, Basic).Name()"), Field.Name(), "String"_ASV);
	...
	// Test Long Strings
	{
		...
		FCbFieldRefIterator Fields = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(String, Long) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
			for (FCbField Field : Fields)
			{
	...
	// Test Non-ASCII String
	{
		...
		FCbFieldRefIterator Fields = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(String, Unicode) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
			for (FCbField Field : Fields)
			{
...
bool FCbWriterIntegerTest::RunTest(const FString& Parameters)
{
	...
	auto TestInt32 = [this, &Writer](int32 Value)
	{
		...
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Integer, Int32) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	auto TestUInt32 = [this, &Writer](uint32 Value)
	{
		...
		Writer.Integer(Value);
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Integer, UInt32) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	auto TestInt64 = [this, &Writer](int64 Value)
	{
		...
		Writer.Integer(Value);
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Integer, Int64) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	auto TestUInt64 = [this, &Writer](uint64 Value)
	{
		...
		Writer.Integer(Value);
		FCbFieldRef Field = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Integer, UInt64) Validate"), ValidateCompactBinary(*Field.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
...
bool FCbWriterFloatTest::RunTest(const FString& Parameters)
{
	...
	// Test Float32
	{
		...
		FCbFieldRefIterator Fields = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Float, Single) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Float64
	{
		...
		FCbFieldRefIterator Fields = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Float, Double) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
...
bool FCbWriterBoolTest::RunTest(const FString& Parameters)
{
	...
	// Test Bool Values
	{
		...
		FCbFieldRefIterator Fields = Writer.Save();
		if (TestEqual(TEXT("FCbWriter(Bool) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
		{
	...
	// Test Bool Array/Object Uniformity
	{
		...
		FCbFieldRefIterator Fields = Writer.Save();
		TestEqual(TEXT("FCbWriter(Bool, Uniform) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None);
	}
...
bool FCbWriterBinaryHashTest::RunTest(const FString& Parameters)
{
	...
	FCbFieldRefIterator Fields = Writer.Save();
	if (TestEqual(TEXT("FCbWriter(BinaryHash) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
	{
...
bool FCbWriterFieldHashTest::RunTest(const FString& Parameters)
{
	...
	FCbFieldRefIterator Fields = Writer.Save();
	if (TestEqual(TEXT("FCbWriter(FieldHash) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
	{
		const FBlake3Hash* CheckValue = Values;
		for (FCbField Field : Fields)
		{
...
bool FCbWriterUuidTest::RunTest(const FString& Parameters)
{
	...
	FCbFieldRefIterator Fields = Writer.Save();
	if (TestEqual(TEXT("FCbWriter(Uuid) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
	{
...
bool FCbWriterDateTimeTest::RunTest(const FString& Parameters)
{
	...
	FCbFieldRefIterator Fields = Writer.Save();
	if (TestEqual(TEXT("FCbWriter(DateTime) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
	{
...
bool FCbWriterTimeSpanTest::RunTest(const FString& Parameters)
{
	...
	FCbFieldRefIterator Fields = Writer.Save();
	if (TestEqual(TEXT("FCbWriter(TimeSpan) Validate"), ValidateCompactBinaryRange(*Fields.Buffer(), ECbValidateMode::All), ECbValidateError::None))
	{
...
bool FCbWriterComplexTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("FCbWriter(Complex) Validate"), ValidateCompactBinary(*Object.Buffer(), ECbValidateMode::All), ECbValidateError::None);
...
bool FCbWriterStreamTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("FCbWriter(Stream) Validate"), ValidateCompactBinary(*Object.Buffer(), ECbValidateMode::All), ECbValidateError::None);
