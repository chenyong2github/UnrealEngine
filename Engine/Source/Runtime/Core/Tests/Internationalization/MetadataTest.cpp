...
TEST_CASE("Core::Internationalization::FLocMetadataValue::Metadata", "[Core][Internationalization][Smoke]")
{
	...
	// Testing the bool meta data value type
	{
		...
		{
			TestAddError(TEXT("MetadataValueBool and its Clone are not unique objects."));
		}
	...
	// Testing string metadata value type
	{
		...
		{
			TestAddError(TEXT("MetadataValueString and its Clone are not unique objects."));
		}
	...
	// Testing object metadata value type
	{
		...
		TestFalse(TEXT("MetadataValueString and its Clone are not unique objects."), MetadataValueObjectA == MetadataValueObjectAClone);
