...
TEST_CASE_METHOD(FAutomationTestFixture, "Core::Containers::FBitArray::Misc", "[Core][Containers][Smoke]")
{
	...
	BitArrayTest.ConstructAndTestConstructors();
	BitArrayTest.TestEqualityOperator();
	BitArrayTest.TestOtherConstructorAndAssignment();
	BitArrayTest.TestLessThan();
	BitArrayTest.TestRemoveAt();
	BitArrayTest.TestRemoveAtSwap();
	BitArrayTest.TestSerialize();
	BitArrayTest.TestAdd();
	BitArrayTest.TestAddFromRange();
	BitArrayTest.TestInsert();
	BitArrayTest.TestInsertFromRange();
	BitArrayTest.TestSetRange();
	BitArrayTest.TestGetRange();
	BitArrayTest.TestEmpty();
	BitArrayTest.TestReserve();
	BitArrayTest.TestReset();
...
TEST_CASE_METHOD(FAutomationTestFixture, "Core::Containers::FBitArray::MemmoveBitsWordOrder", "[Core][Containers][Smoke]")
{
	...
	BitArrayMemoryTest.TestMemmoveBitsWordOrder();
	BitArrayMemoryTest.TestModularizeWordOffset();
}
