...
TEST_CASE_METHOD(FAutomationTestFixture, "Core::Hash::FBlake3::Smoke Test", "[Core][Math][Smoke]")
{
	...
	const FBlake3TestCase TestCases[] =
	{
		...
		{MaxInputLength, TEXTVIEW("62b6960e1a44bcc1eb1a611a8d6235b6b4b78f32e7abc4fb4c6cdcce94895c47")},
	};
	...
	for (const FBlake3TestCase& TestCase : TestCases)
	{
		...
		INFO(FString::Printf(TEXT("BLAKE3(%u)"), TestCase.InputLength));
		CHECK(FStringView(HashHex)==TestCase.Hash);
	}
}
