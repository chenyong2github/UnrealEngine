...
TEST_CASE("Core::Serialization::FCbField::Validate Compact Binary", "[Core][Serialization][Smoke]")
{
...
TEST_CASE("Core::Serialization::FCbField::Validate Compact Binary Range", "[Core][Serialization][Smoke]")
{
...
TEST_CASE("Core::Serialization::FCbField::Validate Compact Binary Attachment", "[Core][Serialization][Smoke]")
{
	auto Validate = [](std::initializer_list<uint8> Data, ECbValidateMode Mode = ECbValidateMode::All) -> ECbValidateError
	{
...
TEST_CASE("Core::Serialization::FCbField::Validate Compact Binary Package", "[Core][Serialization][Smoke]")
{
	const uint8 BinaryValue[] = { 0, 1, 2, 3 };
	const FMemoryView BinaryView = MakeMemoryView(BinaryValue);
