...
//#ifdef _MSC_VER
//#pragma message(__FILE__"(6): warning : #include Containers/StringView.h instead of Misc/StringView.h")
//#else
//#pragma message("#include Containers/StringView.h instead of Misc/StringView.h")
//#endif

>>>> ORIGINAL //Fortnite/Dev-EngineMerge/Engine/Source/Runtime/Core/Public/Misc/StringView.h#2
...
==== THEIRS //Fortnite/Dev-EngineMerge/Engine/Source/Runtime/Core/Public/Misc/StringView.h#3
namespace StringViewPrivate
{
	/**
	 * Trait testing whether a range type is compatible with the view type
...
template <typename CharType, typename ViewType>
inline int32 GetNum(const TStringViewImpl<CharType, ViewType>& String)
{
	return String.Len();
}
...
inline int32 GetNum(const FStringView& String) { return String.Len(); }
inline int32 GetNum(const FAnsiStringView& String) { return String.Len(); }
inline int32 GetNum(const FWideStringView& String) { return String.Len(); }

#include "StringView.inl"
==== YOURS //mnoland_workpc_ue4main/Engine/Source/Runtime/Core/Public/Misc/StringView.h
