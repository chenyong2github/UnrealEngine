...
#pragma warning(disable: 4746) // volatile access of '<expression>' is subject to /volatile											https://docs.microsoft.com/en-us/cpp/error-messages/compiler-warnings/compiler-warning-c4746?view=msvc-170
