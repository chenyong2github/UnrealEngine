...
//The android surface orientations defined in C++ map to the values in https://developer.android.com/reference/android/view/Surface#ROTATION_0
namespace EAndroidSurfaceOrientation
{
	enum Type
	{
		ROTATION_0,
