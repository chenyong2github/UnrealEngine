...
#include <atomic>
 ...
 #if WITH_EDITOR && PLATFORM_WINDOWS && !UE_BUILD_SHIPPING && COUNTERSTRACE_ENABLED
  #define STALL_DETECTOR 1
 #else // WITH_EDITOR && PLATFORM_WINDOWS && !UE_BUILD_SHIPPING && COUNTERSTRACE_ENABLED
  #define STALL_DETECTOR 0
 #endif // WITH_EDITOR && PLATFORM_WINDOWS && !UE_BUILD_SHIPPING && COUNTERSTRACE_ENABLED
