...
FORCEINLINE float VectorGetComponentDynamic(VectorRegister Vec, uint32 ElementIndex)
{
...
FORCEINLINE void VectorMatrixMultiply( void *Result, const void* Matrix1, const void* Matrix2 )
{
	...
	R.val[0] = vmulq_n_f32(B.val[0], A.val[0][0]);
	R.val[0] = vfmaq_n_f32(R.val[0], B.val[1], A.val[0][1]);
	R.val[0] = vfmaq_n_f32(R.val[0], B.val[2], A.val[0][2]);
	R.val[0] = vfmaq_n_f32(R.val[0], B.val[3], A.val[0][3]);

	// Second row of result (Matrix1[1] * Matrix2).
	R.val[1] = vmulq_n_f32(B.val[0], A.val[1][0]);
	R.val[1] = vfmaq_n_f32(R.val[1], B.val[1], A.val[1][1]);
	R.val[1] = vfmaq_n_f32(R.val[1], B.val[2], A.val[1][2]);
	R.val[1] = vfmaq_n_f32(R.val[1], B.val[3], A.val[1][3]);

	// Third row of result (Matrix1[2] * Matrix2).
	R.val[2] = vmulq_n_f32(B.val[0], A.val[2][0]);
	R.val[2] = vfmaq_n_f32(R.val[2], B.val[1], A.val[2][1]);
	R.val[2] = vfmaq_n_f32(R.val[2], B.val[2], A.val[2][2]);
	R.val[2] = vfmaq_n_f32(R.val[2], B.val[3], A.val[2][3]);

	// Fourth row of result (Matrix1[3] * Matrix2).
	R.val[3] = vmulq_n_f32(B.val[0], A.val[3][0]);
	R.val[3] = vfmaq_n_f32(R.val[3], B.val[1], A.val[3][1]);
	R.val[3] = vfmaq_n_f32(R.val[3], B.val[2], A.val[3][2]);
	R.val[3] = vfmaq_n_f32(R.val[3], B.val[3], A.val[3][3]);
#else
	// First row of result (Matrix1[0] * Matrix2).
	R.val[0] = vmulq_n_f32(B.val[0], A.val[0][0]);
	R.val[0] = vmlaq_n_f32(R.val[0], B.val[1], A.val[0][1]);
	R.val[0] = vmlaq_n_f32(R.val[0], B.val[2], A.val[0][2]);
	R.val[0] = vmlaq_n_f32(R.val[0], B.val[3], A.val[0][3]);

	// Second row of result (Matrix1[1] * Matrix2).
	R.val[1] = vmulq_n_f32(B.val[0], A.val[1][0]);
	R.val[1] = vmlaq_n_f32(R.val[1], B.val[1], A.val[1][1]);
	R.val[1] = vmlaq_n_f32(R.val[1], B.val[2], A.val[1][2]);
	R.val[1] = vmlaq_n_f32(R.val[1], B.val[3], A.val[1][3]);

	// Third row of result (Matrix1[2] * Matrix2).
	R.val[2] = vmulq_n_f32(B.val[0], A.val[2][0]);
	R.val[2] = vmlaq_n_f32(R.val[2], B.val[1], A.val[2][1]);
	R.val[2] = vmlaq_n_f32(R.val[2], B.val[2], A.val[2][2]);
	R.val[2] = vmlaq_n_f32(R.val[2], B.val[3], A.val[2][3]);

	// Fourth row of result (Matrix1[3] * Matrix2).
	R.val[3] = vmulq_n_f32(B.val[0], A.val[3][0]);
	R.val[3] = vmlaq_n_f32(R.val[3], B.val[1], A.val[3][1]);
	R.val[3] = vmlaq_n_f32(R.val[3], B.val[2], A.val[3][2]);
	R.val[3] = vmlaq_n_f32(R.val[3], B.val[3], A.val[3][3]);
#endif
...
#else
	Result = vmlaq_n_f32(Result, M.val[1], VecP[1]);
	Result = vmlaq_n_f32(Result, M.val[2], VecP[2]);
	Result = vmlaq_n_f32(Result, M.val[3], VecP[3]);
#endif
