...
FORCEINLINE float VectorGetComponentImpl(VectorRegister Vec)
{
...
{
	OutEvens = _mm_shuffle_ps(Lo, Hi, SHUFFLEMASK(0, 2, 0, 2));
	OutOdds = _mm_shuffle_ps(Lo, Hi, SHUFFLEMASK(1, 3, 1, 3));
}
