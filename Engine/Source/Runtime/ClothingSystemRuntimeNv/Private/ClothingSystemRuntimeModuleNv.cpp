...
#if WITH_NVCLOTH
void FClothingSystemRuntimeModuleNv::DelayLoadNvCloth()
{
#if PLATFORM_WINDOWS
...
void FClothingSystemRuntimeModuleNv::ShutdownNvClothLibs()
{
#if PLATFORM_WINDOWS
...
#if PLATFORM_WINDOWS
void FClothingSystemRuntimeModuleNv::DelayLoadNvCloth_Windows()
{
...
void FClothingSystemRuntimeModuleNv::ShutdownNvCloth_Windows()
{
	if(NvClothHandle)
	{
...
#if PLATFORM_MAC
void FClothingSystemRuntimeModuleNv::DelayLoadNvCloth_Mac()
{
...
void FClothingSystemRuntimeModuleNv::ShutdownNvCloth_Mac()
{
	if(NvClothHandle)
	{
		FPlatformProcess::FreeDllHandle(NvClothHandle);
