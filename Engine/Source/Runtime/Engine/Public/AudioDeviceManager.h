...
public:
	...
	inline bool operator==(const FAudioDeviceHandle& Other) const
	{
		return DeviceId == Other.DeviceId;
	}

	inline bool operator==(const FAudioDevice*& Other) const
	{
		return Device == Other;
	}

	inline bool operator==(FAudioDevice*& Other) const
	{
		return Device == Other;
	}

	inline bool operator==(const Audio::FDeviceId& Other) const
	{
