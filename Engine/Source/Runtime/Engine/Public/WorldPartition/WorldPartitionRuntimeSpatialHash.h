...
struct FSpatialHashStreamingGrid
{
	...
	// Used by PIE/Game
	void GetCells(const TArray<FWorldPartitionStreamingSource>& Sources, TSet<const UWorldPartitionRuntimeCell*>& Cells) const;
	void GetAlwaysLoadedCells(TSet<const UWorldPartitionRuntimeCell*>& Cells) const;
