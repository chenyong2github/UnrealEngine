...
public:
	...
	virtual int32 StrataDiffuseBSDF(int32 Albedo, int32 Roughness, int32 SSSProfileId, int32 SSSProfileRadiusScale, int32 Normal, uint8 SharedNormalIndex) = 0;
...
public:
	...
	{
		return Compiler->StrataDiffuseBSDF(Albedo, Roughness, SSSProfileId, SSSProfileRadiusScale, Normal, SharedNormalIndex);
	}
