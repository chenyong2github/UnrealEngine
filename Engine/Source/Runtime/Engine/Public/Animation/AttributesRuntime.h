...
namespace UE
{
	namespace Anim
	{
		...
		struct ENGINE_API Attributes
		{
			...
			static void CopyAndRemapAttributes(const FHeapAttributeContainer& SourceAttributes, FStackAttributeContainer& OutAttributes, const TMap<int32, int32>& BoneMapToSource, const FBoneContainer& RequiredBones);
