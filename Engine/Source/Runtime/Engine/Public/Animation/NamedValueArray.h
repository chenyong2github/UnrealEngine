...
#define DO_ANIM_NAMED_VALUE_SORTING_CHECKS		(DO_GUARD_SLOW || WITH_DEV_AUTOMATION_TESTS)
#define DO_ANIM_NAMED_VALUE_DUPLICATE_CHECKS	(DO_GUARD_SLOW || WITH_DEV_AUTOMATION_TESTS)
