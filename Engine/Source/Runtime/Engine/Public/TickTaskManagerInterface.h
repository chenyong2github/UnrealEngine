...
public:
	...
	*/
	...
	virtual void GetEnabledTickFunctionCounts(UWorld* InWorld, TSortedMap<FName, int32, FDefaultAllocator, FNameSortIndexes>& TickContextToCountMap, int32& EnabledCount, bool bDetailed) = 0;
