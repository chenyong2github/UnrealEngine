...
public:
	...
	virtual FUniqueNetIdPtr CreateUniquePlayerId(const FString& Str, FName Type = NAME_None) { return nullptr; }
	/** @return the unique id for a given local user on the given OnlineSubsystem */
	virtual FUniqueNetIdPtr GetUniquePlayerId(UWorld* World, int32 LocalUserNum, FName Type = NAME_None) { return nullptr; }
