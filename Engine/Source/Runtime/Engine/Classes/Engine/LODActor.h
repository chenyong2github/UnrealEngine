...
public:
	...
	TArray<UInstancedStaticMeshComponent*> GetInstancedStaticMeshComponents() const { TArray<UInstancedStaticMeshComponent*> ISM; InstancedStaticMeshComponents.GenerateValueArray(ISM); return ISM; }
