...
class UMeshDescriptionBulkDataWrapper;
...
struct FStaticMeshSourceModel
{
	 ...
	 */
	UPROPERTY(Transient)
	UStaticMeshDescription* StaticMeshDescription;
	 ...
	 */
	UPROPERTY()
	UMeshDescriptionBulkDataWrapper* StaticMeshDescriptionBulkData;
#endif
	 ...
	 * - if there's valid MeshDescriptionBulkData, unpack it from that
	 ...
	 */
	UStaticMeshDescription* GetCachedStaticMeshDescription() const { return StaticMeshDescription; }
...
public:
	 ...
	 */
	ENGINE_API void ModifyMeshDescription(int32 LodIndex, bool bAlwaysMarkDirty = true);

	/**
	 * Performs a Modify on StaticMeshDescription objects for all LODs
	 */
	ENGINE_API void ModifyAllMeshDescriptions(bool bAlwaysMarkDirty = true);

	/**
	 * Performs a Modify on the hi-res StaticMeshDescription
	 */
	ENGINE_API void ModifyHiResMeshDescription(bool bAlwaysMarkDirty = true);
