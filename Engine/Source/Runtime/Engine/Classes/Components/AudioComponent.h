...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set Boolean Parameter", DeprecatedFunction, DeprecationMessage = "5.0 - Moved to AudioParameterControllerInterface"), Category = "Audio|Parameter")
	...
	// Sets a named Int32
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set Integer Parameter", DeprecatedFunction, DeprecationMessage = "5.0 - Moved to AudioParameterControllerInterface"), Category = "Audio|Parameter")
	...
	// Sets a named Float
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set Float Parameter", DeprecatedFunction, DeprecationMessage = "5.0 - Moved to AudioParameterControllerInterface"), Category = "Audio|Parameter")
