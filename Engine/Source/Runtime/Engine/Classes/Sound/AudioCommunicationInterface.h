...
#include "AudioCommunicationInterface.generated.h"

UINTERFACE(MinimalApi, BlueprintType, meta = (CannotImplementInterfaceInBlueprint))
class UAudioCommunicationInterface : public UInterface
{
	GENERATED_UINTERFACE_BODY()
};

class IAudioCommunicationInterface : public IInterface
{
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Communication|Primitive")
	virtual void SetBool(FName Name, bool Value) = 0;
	
	// Sets a named Boolean Array 
	UFUNCTION(BlueprintCallable, Category = "Communication|Array")
