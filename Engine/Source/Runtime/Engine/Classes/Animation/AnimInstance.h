...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category="Animation", meta=(BlueprintThreadSafe, DeprecatedFunction, DeprecationMessage="Please use UKismetAnimationLibrary::CalculateDirection instead"))
