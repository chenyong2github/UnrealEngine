...
namespace UE
{
	namespace Anim
	{
		...
		public:
			...
			{
				BlendData.ForEachUniqueAttribute([&, OutAttributes](typename FAttributeBlendData::template TSingleRawIterator& It) -> void
				{
					while (It.Next())
					{						
			...
			{
				BlendData.ForEachAttributeSet([&, OutAttributes](typename FAttributeBlendData::template TAttributeSetRawIterator& It) -> void
				{
					const FAttributeId& Identifier = It.GetIdentifier();
					const ECustomAttributeBlendType BlendType = Attributes::GetAttributeBlendType(Identifier);
			...
			{
				BlendData.ForEachUniqueAttribute([&, OutAdditiveAttributes](typename FAttributeBlendData::template TSingleRawIterator& It) -> void
				{
					while (It.Next())
					{
						const uint8* Attribute = It.GetValuePtr();
