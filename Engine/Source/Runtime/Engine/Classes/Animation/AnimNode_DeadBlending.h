...
private:
	...
	TBitArray<TInlineAllocator<256>> CurveValid;
	TArray<float, TInlineAllocator<32>> CurveValues;
	TArray<float, TInlineAllocator<32>> CurveVelocities;
	TArray<float, TInlineAllocator<32>> CurveDecayHalfLives;
