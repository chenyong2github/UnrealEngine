...
{
	UE_LOG(LogWorldPartition, Verbose, TEXT("[Cook][PopulateGeneratedPackage] Processing %s"), *FWorldPartitionCookPackage::MakeFullPath(GeneratedPackage.GeneratedRootPath, GeneratedPackage.RelativePath));
	...
	{
		UE_LOG(LogWorldPartition, Error, TEXT("[Cook][PopulateGeneratedPackage] Could not find WorldPartitionCookPackage for %s"), *FWorldPartitionCookPackage::MakeFullPath(GeneratedPackage.GeneratedRootPath, GeneratedPackage.RelativePath));
		bIsSuccess = false;
	}

	UE_LOG(LogWorldPartition, Verbose, TEXT("[Cook][PopulateGeneratedPackage] Gathered %u modified packages for %s"), ModifiedPackages.Num() , *FWorldPartitionCookPackage::MakeFullPath(GeneratedPackage.GeneratedRootPath, GeneratedPackage.RelativePath));
	...
	TArray<UPackage*>& OutModifiedPackages)
{
	...
	bIsSuccess &= MapGeneratePackageToCookPackage(GeneratedPackages);
...
bool FWorldPartitionCookPackageSplitter::MapGeneratePackageToCookPackage(const TArray<ICookPackageSplitter::FGeneratedPackageForPreSave>& GeneratedPackages)
{
	bool bIsSucces = true;
	for (const ICookPackageSplitter::FGeneratedPackageForPreSave& GeneratedPackage : GeneratedPackages)
	{
		IWorldPartitionCookPackageGenerator* CookPackageGenerator = nullptr;
		FWorldPartitionCookPackage* CookPackage = nullptr;
		if (CookContext.GetCookPackageGeneratorAndPackage(GeneratedPackage.GeneratedRootPath, GeneratedPackage.RelativePath, CookPackageGenerator, CookPackage))
		{
			CookPackage->GeneratedPackage = GeneratedPackage.Package;
		}
		else
		{
			UE_LOG(LogWorldPartition, Error, TEXT("[Cook][MapGeneratePackageToCookPackage] Could not find WorldPartitionCookPackage for %s"), *FWorldPartitionCookPackage::MakeFullPath(GeneratedPackage.GeneratedRootPath, GeneratedPackage.RelativePath));
			bIsSucces = false;
		}
	}
