...
public:
	...
	FORCEINLINE void AddTickFunctionToMap(TSortedMap<FName, int32, FDefaultAllocator, FNameSortIndexes>& ClassNameToCountMap, FTickFunction* Function, bool bDetailed)
	{
	...
	void AddTickFunctionsToMap(TSortedMap<FName, int32, FDefaultAllocator, FNameSortIndexes>& ClassNameToCountMap, int32& EnabledCount, bool bDetailed)
	{
...
private:
	...
	virtual void GetEnabledTickFunctionCounts(UWorld* InWorld, TSortedMap<FName, int32, FDefaultAllocator, FNameSortIndexes>& TickContextToCountMap, int32& EnabledCount, bool bDetailed)
	{
		check(InWorld);
		check(InWorld->TickTaskLevel);
