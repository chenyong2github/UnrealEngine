...
protected:
	...
	*/	
	...
	virtual int32 StrataEyeBSDF(int32 DiffuseColor, int32 Roughness, int32 IrisMask, int32 IrisDistance, int32 EmissiveColor, int32 CorneaNormal, int32 IrisNormal, const FString& SharedLocalBasisIndexMacro) override;
