...
enum EPackageFlags
{
	...
	PKG_NotExternallyReferenceable  = 0x00000800,   ///< (Not Implemented) Objects in this package cannot be referenced in a different plugin or mount point (i.e /Game -> /Engine)
