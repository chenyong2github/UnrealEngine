...
public:
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="TypedElementFramework|List", meta=(ScriptMethod))
	static UTypedElementInterface* GetElementInterface(const FTypedElementListProxy ElementList, const FTypedElementHandle& ElementHandle, const TSubclassOf<UTypedElementInterface>& BaseInterfaceType)
	{
		FTypedElementListConstPtr ElementListPtr = ElementList.GetElementList();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="TypedElementFramework|List", meta=(ScriptMethod))
	static bool HasElements(const FTypedElementListProxy ElementList, const TSubclassOf<UTypedElementInterface>& BaseInterfaceType = nullptr)
	{
		FTypedElementListConstPtr ElementListPtr = ElementList.GetElementList();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="TypedElementFramework|List", meta=(ScriptMethod))
	static int32 CountElements(const FTypedElementListProxy ElementList, const TSubclassOf<UTypedElementInterface>& BaseInterfaceType = nullptr)
	{
		FTypedElementListConstPtr ElementListPtr = ElementList.GetElementList();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="TypedElementFramework|List", meta=(ScriptMethod))
	static TArray<FTypedElementHandle> GetElementHandles(const FTypedElementListProxy ElementList, const TSubclassOf<UTypedElementInterface>& BaseInterfaceType = nullptr)
	{
		FTypedElementListConstPtr ElementListPtr = ElementList.GetElementList();
