...
public:
	...
	*/
	...
	virtual bool AssertEqual_Rotator(const FRotator& Actual, const FRotator& Expected, const FString& What, float Tolerance = 1.e-4f, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertEqual_Vector(const FVector& Actual, const FVector& Expected, const FString& What, float Tolerance = 1.e-4f, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertEqual_Vector2D(const FVector2D& Actual, const FVector2D& Expected, const FString& What, float Tolerance = 1.e-4f, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertNotEqual_Vector2D(const FVector2D& Actual, const FVector2D& NotExpected, const FString& What, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertEqual_Vector4(const FVector4& Actual, const FVector4& Expected, const FString& What, float Tolerance = 1.e-4f, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertNotEqual_Vector4(const FVector4& Actual, const FVector4& NotExpected, const FString& What, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertEqual_Plane(const FPlane& Actual, const FPlane& Expected, const FString& What, float Tolerance = 1.e-4f, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertNotEqual_Plane(const FPlane& Actual, const FPlane& NotExpected, const FString& What, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertEqual_Quat(const FQuat& Actual, const FQuat& Expected, const FString& What, float Tolerance = 1.e-4f, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertNotEqual_Quat(const FQuat& Actual, const FQuat& NotExpected, const FString& What, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertEqual_Matrix(const FMatrix& Actual, const FMatrix& Expected, const FString& What, float Tolerance = 1.e-4f, const UObject* ContextObject = nullptr);
	...
	virtual bool AssertNotEqual_Matrix(const FMatrix& Actual, const FMatrix& NotExpected, const FString& What, const UObject* ContextObject = nullptr);
