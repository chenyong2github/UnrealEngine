...
void FDatasmithMeshExporterImpl::ClearUDatasmithMeshPool()
{
	...
	auto ClearUObjectFlags = [SharedPromise, PooledMeshes(MoveTemp(PooledMeshes))]()
	{
...
#if IS_PROGRAM
	TFuture<void> ObjectFlagsSetFuture = SharedPromise->GetFuture();
