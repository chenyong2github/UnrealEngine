...
static const FPlatformInfo AllPlatformInfoArray[] = {
	...
	BuildPlatformInfo(TEXT("PS4Client"),				TEXT("PS4Client"),			LOCTEXT("PS4Client", "PlayStation 4 (Client-only)"),			EPlatformType::Client,	EPlatformFlags::None,			FPlatformIconPaths(TEXT("Launcher/PS4/Platform_PS4_24x"), TEXT("Launcher/PS4/Platform_PS4_128x")),									TEXT("-client"),									TEXT("PS4"),		EPlatformSDKStatus::Unknown,	TEXT("/Platforms/PS4/GettingStarted"),																	IsAvailableOnWindows,											TEXT("PS4"),		TEXT("PS4"),		false,					false,					true,			TEXT("PS4"),		TEXT("Console")),
	...
	BuildPlatformInfo(TEXT("XboxOneClient"),			TEXT("XboxOneClient"),		LOCTEXT("XboxOneClient", "Xbox One (Client-only)"),				EPlatformType::Client,	EPlatformFlags::None,			FPlatformIconPaths(TEXT("Launcher/XboxOne/Platform_XboxOne_24x"), TEXT("Launcher/XboxOne/Platform_XboxOne_128x")),					TEXT("-client"),									TEXT("XboxOne"),	EPlatformSDKStatus::Unknown,	TEXT("/Platforms/XboxOne/GettingStarted"),																IsAvailableOnWindows,											TEXT("XboxOne"),	TEXT("XboxOne"),	false,					true,					true,			TEXT("XboxOne"),	TEXT("Console")),
	...
	BuildPlatformInfo(TEXT("SwitchClient"),				TEXT("SwitchClient"),		LOCTEXT("SwitchClient", "Switch (Client-only)"),				EPlatformType::Client,	EPlatformFlags::None,			FPlatformIconPaths(TEXT("Launcher/Switch/Platform_Switch_24x"), TEXT("Launcher/Switch/Platform_Switch_128x")),						TEXT("-client"),									TEXT(""),			EPlatformSDKStatus::Unknown,	TEXT(""),																								IsAvailableOnWindows,											TEXT("Switch"),		TEXT("Switch"),		false,					true,					true,			TEXT("Switch"),		TEXT("Console")),
