...
UE::DerivedData::FCacheRecordBuilder UE::DerivedData::CreateCacheRecordBuilder(const FCacheKey& Key)
{
	return FCacheRecordBuilder(new Private::FCacheRecordBuilderInternal(Key));
}
