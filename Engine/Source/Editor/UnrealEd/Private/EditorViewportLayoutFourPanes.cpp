...
TSharedRef<SWidget> FEditorViewportLayoutFourPanes::MakeViewportLayout(const FString& LayoutString)
{
	...
	TSharedRef<IEditorViewportLayoutEntity> Viewport3 = FactoryViewport(*ViewportType2, Args);
