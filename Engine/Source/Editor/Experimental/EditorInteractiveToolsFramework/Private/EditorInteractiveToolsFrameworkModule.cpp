...
void FEditorInteractiveToolsFrameworkModule::StartupModule()
{
	...
	AddMeshDescriptionSourceBuilder(MakeMeshDescriptionSourceForStaticMesh);
	UE_LOG(LogTemp, Warning, TEXT("FEditorInteractiveToolsFrameworkModule StartupModule"));
}
