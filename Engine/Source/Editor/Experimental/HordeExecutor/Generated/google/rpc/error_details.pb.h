...
class RetryInfo PROTOBUF_FINAL :
...
class QuotaFailure_Violation PROTOBUF_FINAL :
...
class QuotaFailure PROTOBUF_FINAL :
...
public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_google_2frpc_2ferror_5fdetails_2eproto);
    return ::descriptor_table_google_2frpc_2ferror_5fdetails_2eproto.file_level_metadata[4];
  }
...
class PreconditionFailure_Violation PROTOBUF_FINAL :
...
class PreconditionFailure PROTOBUF_FINAL :
...
class ResourceInfo PROTOBUF_FINAL :
...
class Help_Link PROTOBUF_FINAL :
...
class LocalizedMessage PROTOBUF_FINAL :
...
inline void ErrorInfo::set_reason(std::string&& value) {
  
  reason_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:google.rpc.ErrorInfo.reason)
}
inline void ErrorInfo::set_reason(const char* value) {
  ...
  reason_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:google.rpc.ErrorInfo.reason)
}
inline void ErrorInfo::set_reason(const char* value,
    size_t size) {
  ...
  reason_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:google.rpc.ErrorInfo.reason)
}
...
inline void ErrorInfo::set_domain(std::string&& value) {
  
  domain_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:google.rpc.ErrorInfo.domain)
}
inline void ErrorInfo::set_domain(const char* value) {
  ...
  domain_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:google.rpc.ErrorInfo.domain)
}
inline void ErrorInfo::set_domain(const char* value,
    size_t size) {
  ...
  domain_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:google.rpc.ErrorInfo.domain)
}
...
inline const std::string& RequestInfo::_internal_serving_data() const {
  return serving_data_.Get();
}
inline void RequestInfo::_internal_set_serving_data(const std::string& value) {
  
  serving_data_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void RequestInfo::set_serving_data(const char* value) {
  ...
  serving_data_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void RequestInfo::set_serving_data(const char* value,
  ...
  serving_data_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* RequestInfo::_internal_mutable_serving_data() {
  ...
  return serving_data_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* RequestInfo::release_serving_data() {
  ...
  return serving_data_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RequestInfo::set_allocated_serving_data(std::string* serving_data) {
  ...
  serving_data_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), serving_data,
      GetArena());
