...
{
	const FText MenuItemName = LOCTEXT("ObjectMixerEditorMenuItem", "Object Mixer");
	...
	FTabSpawnerEntry& BrowserSpawnerEntry = FGlobalTabmanager::Get()->RegisterNomadTabSpawner(
		...
		.SetTooltipText(LOCTEXT("ObjectMixerEditorMenuItemTooltip", "Open an Object Mixer instance."))
