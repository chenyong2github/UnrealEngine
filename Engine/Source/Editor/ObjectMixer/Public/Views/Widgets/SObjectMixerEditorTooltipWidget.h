...
class OBJECTMIXEREDITOR_API SObjectMixerEditorTooltipWidget : public SCompoundWidget
{
public:
	
	SLATE_BEGIN_ARGS(SObjectMixerEditorTooltipWidget)
	{}
	...
	static TSharedRef<SToolTip> MakeTooltip(const FString InCommandName, const FString InHelpString)
	{
		return
			...
			[
				...
				[
					SNew(SObjectMixerEditorTooltipWidget, InCommandName, InHelpString)
				]
			];
	}
