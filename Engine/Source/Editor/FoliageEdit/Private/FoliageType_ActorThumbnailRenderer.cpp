...
void UFoliageType_ActorThumbnailRenderer::Draw(UObject* Object, int32 X, int32 Y, uint32 Width, uint32 Height, FRenderTarget* RenderTarget, FCanvas* Canvas)
{
	UFoliageType_Actor* FoliageType = Cast<UFoliageType_Actor>(Object);
	if (FoliageType == nullptr || FoliageType->ActorClass == nullptr)
	{
	...
	Super::Draw(FoliageType->ActorClass->ClassGeneratedBy, X, Y, Width, Height, RenderTarget, Canvas);
}
