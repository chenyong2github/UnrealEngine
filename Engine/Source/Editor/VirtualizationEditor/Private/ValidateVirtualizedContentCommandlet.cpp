...
TArray<FString> UValidateVirtualizedContentCommandlet::FindVirtualizedPackages(const TArray<FString>& PackagePaths)
{
...
bool UValidateVirtualizedContentCommandlet::TryValidateContent(const TCHAR* DebugName, const TArray<FString>& Packages)
{
...
bool UValidateVirtualizedContentCommandlet::TryValidateDirectory(const FString& Directory)
{
