...
bool FBlueprintActionDatabase::IsPinTypeAllowed(const FEdGraphPinType& InPinType)
{
	...
	{
		if(const UScriptStruct* ScriptStruct = CastChecked<UScriptStruct>(InPinType.PinSubCategoryObject, ECastCheckedType::NullAllowed))
		{
	...
	{
		if(const UEnum* Enum = CastChecked<UEnum>(InPinType.PinSubCategoryObject, ECastCheckedType::NullAllowed))
		{
	...
	{
		if(const UClass* Class = CastChecked<UClass>(InPinType.PinSubCategoryObject, ECastCheckedType::NullAllowed))
		{
