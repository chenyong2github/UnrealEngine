...
void UK2Node_EaseFunction::AllocateDefaultPins()
{
	...
	UEdGraphPin* AlphaPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Float, FEaseFunctionNodeHelper::GetAlphaPinName());
	...
	UEdGraphPin* BlendExpPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Float, FEaseFunctionNodeHelper::GetBlendExpPinName());
		...
		Pin->PinName == FEaseFunctionNodeHelper::GetResultPinName())
	{
		...
		if (Pin->LinkedTo.Num() > 0)
		{
			...
			if (bChanged)
			{
				...
				if (InstigatorPin->PinType.PinCategory == UEdGraphSchema_K2::PC_Float)
				{
