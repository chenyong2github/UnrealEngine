...
public:
	...
	/** If enabled, deprecated functions will be visible in the context menu and will be available for override implementation. Deprecated classes will be available in the class dropdown menu on nodes with class pins. */
	UPROPERTY(EditAnywhere, config, Category = Workflow)
	bool bExposeDeprecatedFunctionsAndClasses;
