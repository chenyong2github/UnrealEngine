...
public:
	...
	virtual bool HasStreamedMips(URuntimeVirtualTextureComponent* InComponent) const = 0;
	...
	virtual bool BuildStreamedMips(URuntimeVirtualTextureComponent* InComponent) const = 0;
