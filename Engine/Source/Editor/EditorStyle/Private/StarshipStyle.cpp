...
void FStarshipEditorStyle::FStyle::SetupClassIconsAndThumbnails()
{
	...
	// Actor Classes Outliner
	{
		...
		const FClassIconInfo AssetTypesSVG[] = {
			...
			{TEXT("TakePreset")},
			{TEXT("TakeRecorderLevelSequenceSource")},
			{TEXT("TakeRecorderLiveLinkSource")},
			{TEXT("TakeRecorderMicrophoneAudioSource")},
			{TEXT("TakeRecorderNearbySpawnedActorSource")},
			{TEXT("TakeRecorderWorldSource")},
			{TEXT("TargetPoint")},
