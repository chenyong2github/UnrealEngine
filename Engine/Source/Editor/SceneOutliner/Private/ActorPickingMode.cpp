...
namespace SceneOutliner
{
	...
	void FActorPickingMode::OnItemSelectionChanged(FTreeItemPtr Item, ESelectInfo::Type SelectionType, const FItemSelection& Selection)
	{
	...
	void FActorPickingMode::OnFilterTextCommited(FItemSelection& Selection, ETextCommit::Type CommitType)
	{
