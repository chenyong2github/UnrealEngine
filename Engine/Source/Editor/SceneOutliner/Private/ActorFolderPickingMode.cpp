...
namespace SceneOutliner
{
	...
	void FActorFolderPickingMode::OnItemSelectionChanged(FTreeItemPtr Item, ESelectInfo::Type SelectionType, const FItemSelection& Selection)
	{
	...
	void FActorFolderPickingMode::OnFilterTextCommited(FItemSelection& Selection, ETextCommit::Type CommitType)
	{
