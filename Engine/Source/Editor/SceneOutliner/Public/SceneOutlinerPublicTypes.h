...
struct FSceneOutlinerColumnInfo
{
	FSceneOutlinerColumnInfo(ESceneOutlinerColumnVisibility InVisibility, int32 InPriorityIndex, const FCreateSceneOutlinerColumn& InFactory = FCreateSceneOutlinerColumn(), bool inCanBeHidden = true, TOptional<float> InFillSize = TOptional<float>()
		, TAttribute<FText> InColumnLabel = TAttribute<FText>(), bool bInHideMenuContentButton = false, FOnGetContent InOnGetMenuContent = FOnGetContent())
		...
		, bHideMenuContentButton(bInHideMenuContentButton), OnGetHeaderContextMenuContent(InOnGetMenuContent)
	{
	}
	...
	FSceneOutlinerColumnInfo(const FSceneOutlinerColumnInfo& InColumnInfo)
		...
		, bHideMenuContentButton(InColumnInfo.bHideMenuContentButton), OnGetHeaderContextMenuContent(InColumnInfo.OnGetHeaderContextMenuContent)
	{}
