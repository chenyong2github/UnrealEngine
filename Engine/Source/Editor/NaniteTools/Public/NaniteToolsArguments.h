...
class UNaniteAuditErrorArguments : public UEditorConfigBase
{
	...
	bool ProhibitNonOpaqueBlendMode = true;
	...
	UPROPERTY(EditAnywhere, Category = MaterialErrors, meta = (EditorConfig, DisplayName = "Pixel Depth Offset Usage", Tooltip = "Prohibit for pixel depth offset usage in the assigned materials."))
...
class UNaniteAuditOptimizeArguments : public UEditorConfigBase
{
	...
	UPROPERTY(EditAnywhere, Category = MaterialFilters, meta = (EditorConfig, DisplayName = "Non-Opaque Blend Mode", Tooltip = "Ignore non-Nanite meshes using non-opaque blend mode in the assigned materials."))
	bool DisallowNonOpaqueBlendMode = true;

	UPROPERTY(EditAnywhere, Category = MaterialFilters, meta = (EditorConfig, DisplayName = "Vertex Interpolator Usage", Tooltip = "Ignore non-Nanite meshes using vertex interpolator in the assigned materials."))
	bool DisallowVertexInterpolator = true;

	UPROPERTY(EditAnywhere, Category = MaterialFilters, meta = (EditorConfig, DisplayName = "Pixel Depth Offset Usage", Tooltip = "Ignore non-Nanite meshes using pixel depth offset in the assigned materials."))
	bool DisallowPixelDepthOffset = true;

	UPROPERTY(EditAnywhere, Category = MaterialFilters, meta = (EditorConfig, DisplayName = "World Position Offset Usage", Tooltip = "Ignore non-Nanite meshes using world position offset in the assigned materials."))
