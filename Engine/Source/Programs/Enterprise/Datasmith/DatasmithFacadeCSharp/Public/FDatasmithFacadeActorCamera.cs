...
public class FDatasmithFacadeActorCamera : FDatasmithFacadeActor {
  ...
  public FDatasmithFacadeActorCamera(string InElementName, string InElementLabel) : this(DatasmithFacadeCSharpPINVOKE.new_FDatasmithFacadeActorCamera(InElementName, InElementLabel), true) {
  }
