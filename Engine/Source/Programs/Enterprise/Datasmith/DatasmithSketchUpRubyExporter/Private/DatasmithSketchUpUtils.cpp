...
)
{
	...
	InActorElement->SetScale(Scale.x, Scale.y, Scale.z);
	InActorElement->SetRotation(Rotation.X, Rotation.Y, Rotation.Z, Rotation.W);
	InActorElement->SetTranslation(Translation.X, Translation.Y, Translation.Z);
}
