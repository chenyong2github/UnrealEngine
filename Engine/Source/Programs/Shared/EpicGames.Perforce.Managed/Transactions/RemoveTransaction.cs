...
namespace EpicGames.Perforce.Managed
{
	class RemoveTransaction
	{
		...
		void Merge(WorkspaceDirectoryInfo WorkspaceDir, WorkspaceDirectoryInfo NewWorkspaceDir, IoHash StreamDirHash, ThreadPoolWorkQueue Queue)
		{
