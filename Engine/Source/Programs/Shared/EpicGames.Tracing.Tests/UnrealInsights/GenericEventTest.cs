...
namespace EpicGames.Tracing.Tests.UnrealInsights
{
	...
	public class GenericEventTest
	{
		...
		public void Deserialize_Memory_MemoryScope()
		{
			...
			Assert.AreEqual(0x33, Event3.Fields[0].Int!.Value);
		}
		...
		public void Serialize_Memory_MemoryScope()
		{
			...
			{
				GenericEvent.Field.FromInt(0x27),
			}, 45);
			...
			{
				GenericEvent.Field.FromInt(0x33),
			}, 5832765);
		}
		...
		public void Deserialize_Trace_NewTrace()
		{
			...
			Assert.AreEqual(25582215261913, Event.Fields[0].Long!.Value);
			Assert.AreEqual(10000000, Event.Fields[1].Long!.Value);
			Assert.AreEqual(21069, Event.Fields[2].Int!.Value);
		...
		public void Serialize_Trace_NewTrace_Generic()
		{
			...
			{
				GenericEvent.Field.FromLong(25582215261913),
				GenericEvent.Field.FromLong(10000000),
				GenericEvent.Field.FromInt(21069),
				GenericEvent.Field.FromInt(8),
			});
		}
		...
		{
			{
				...
				Assert.AreEqual(2, Event.Fields[0].Int!.Value);
				Assert.AreEqual(171380, Event.Fields[1].Int!.Value);
				Assert.AreEqual(-1, Event.Fields[2].Int!.Value);
				Assert.AreEqual("GameThread", Event.Fields[3].String!);
			}
			
			{
				GenericEvent Event = DeserializeAndAssertGenericEvent(TraceThreadInfoHex2, TraceThreadInfoEvent.EventType, true, 36);
				Assert.AreEqual(3, Event.Fields[0].Int!.Value);
				Assert.AreEqual(0, Event.Fields[1].Int!.Value);
				Assert.AreEqual(2147483647, Event.Fields[2].Int!.Value);
				Assert.AreEqual("Trace", Event.Fields[3].String!);
			}
			
			{
				GenericEvent Event = DeserializeAndAssertGenericEvent(TraceThreadInfoHex3, TraceThreadInfoEvent.EventType, true, 36);
				Assert.AreEqual(4, Event.Fields[0].Int!.Value);
				Assert.AreEqual(441304, Event.Fields[1].Int!.Value);
				Assert.AreEqual(80, Event.Fields[2].Int!.Value);
				Assert.AreEqual("Foreground Worker #0", Event.Fields[3].String!);
			}
		}
		...
		public void Deserialize_Diagnostics_Session2()
		{
			...
			Assert.AreEqual("Win64", Event.Fields[0].String!);
			Assert.AreEqual("UnrealEditor", Event.Fields[1].String!);
			Assert.AreEqual(@" D:\depot\starship-main\QAGame\QAGame.uproject -trace=cpu -game", Event.Fields[2].String!);
			Assert.AreEqual("++UE5+Main", Event.Fields[3].String!);
			Assert.AreEqual("++UE5+Main-CL-17442524", Event.Fields[4].String!);
			Assert.AreEqual(17442524, Event.Fields[5].Int!.Value);
			Assert.AreEqual(3, Event.Fields[6].Int!.Value);
			Assert.AreEqual(4, Event.Fields[7].Int!.Value);
		}
		...
		public void Serialize_Diagnostics_Session2_Generic()
		{
			...
			{
				GenericEvent.Field.FromString("Win64"),
				GenericEvent.Field.FromString("UnrealEditor"),
				GenericEvent.Field.FromString(@" D:\depot\starship-main\QAGame\QAGame.uproject -trace=cpu -game"),
				GenericEvent.Field.FromString("++UE5+Main"),
				GenericEvent.Field.FromString("++UE5+Main-CL-17442524"),
				GenericEvent.Field.FromInt(17442524),
				GenericEvent.Field.FromInt(3),
				GenericEvent.Field.FromInt(4)
			});
		}
		...
		public void CpuProfiler_EventSpec_Deserialize()
		{
			...
			Assert.AreEqual(9524, Event.Fields[0].Int!.Value);
			Assert.AreEqual("K2Node_VariableGet /Engine/EngineSky/BP_Sky_Sphere.BP_Sky_Sphere:UserConstructionScript.K2Node_VariableGet_983", Event.Fields[1].String!);
		}
		
		[TestMethod]
		public void CpuProfiler_EventSpec_Serialize_Generic()
		{
			SerializeAndAssertGenericEvent(CpuProfilerEventSpecHex, CpuProfilerEventSpecEvent.EventType, true, 33, new GenericEvent.Field[]
			{
				GenericEvent.Field.FromInt(9524),
				GenericEvent.Field.FromString("K2Node_VariableGet /Engine/EngineSky/BP_Sky_Sphere.BP_Sky_Sphere:UserConstructionScript.K2Node_VariableGet_983")
			});
		}
		...
		public void CpuProfiler_EventBatch_Deserialize()
		{
			...
			byte[] EventData = Event.Fields[0].Array!;
		...
		public void Deserialize_Logging_LogMessage()
		{
			...
			Assert.AreEqual(140719801695668, Event.Fields[0].Long!.Value);
			Assert.AreEqual(25582215343012, Event.Fields[1].Long!.Value);
			Assert.AreEqual(29, Event.Fields[2].Array!.Length);
			Assert.AreEqual(0x02, Event.Fields[2].Array![0]);
			Assert.AreEqual(0xC2, Event.Fields[2].Array![1]);
			Assert.AreEqual(0x44, Event.Fields[2].Array![2]);
			Assert.AreEqual(0x7E, Event.Fields[2].Array![25]);
		}
		...
		{
			return StringToByteArray(HexData.Replace(" ", ""));
		}
		...
		private static GenericEvent DeserializeAndAssertGenericEvent(string HexData, EventType EventType, bool IsImportant, ushort ExpectedUid, uint? ExpectedSerial = 0)
		{
			...
			Assert.AreEqual(EventType.Fields.Count, Event.Fields.Length);
			return Event;
		}

		private static void SerializeAndAssertGenericEvent(string ExpectedHexData, EventType EventType, bool IsImportant, ushort Uid, GenericEvent.Field[] Fields, uint Serial = 0)
		{
			using MemoryStream Ms = new MemoryStream();
			using BinaryWriter Writer = new BinaryWriter(Ms);
