...
namespace BuildAgent.Issues
{
	...
	class IssueBuild : IComparable<IssueBuild>
	{
		/// <summary>
		...
		/// Constructor
		/// </summary>
		public IssueBuild(int Change, string JobName, string JobUrl, string JobStepName, string JobStepUrl, string ErrorUrl)
		{
			this.Change = Change;
		...
		public int CompareTo(IssueBuild Other)
		{
