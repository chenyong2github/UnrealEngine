	...
	public class ActionTaskSource : TaskSourceBase<ActionTask>
	{
		...
		async Task<ExecuteResponse> RunInternalAsync(ExecuteOperation Operation)
		{
			...
			for(; ;)
			{
				...
				AgentLease Lease = new AgentLease(Operation.Id, LeaseName, null, null, LogFile.Id, LeaseState.Pending, null, true, Payload);
				...
				{
					// Disabled until behavior of OnConnectionLost is fixed
