...
namespace HordeServer.Api
{
	...
	public class SetStreamRequest
	{
		...
		/// <summary>
		/// Path to the config file in Perforce
		/// </summary>
		...
		/// </summary>
		public List<CreateStreamTabRequest>? Tabs { get; set; }

		/// <summary>
		/// Map of agent name to type
		/// </summary>
		public Dictionary<string, CreateAgentTypeRequest>? AgentTypes { get; set; }

		/// <summary>
		/// Map of workspace name to type
		/// </summary>
		public Dictionary<string, CreateWorkspaceTypeRequest>? WorkspaceTypes { get; set; }

		/// <summary>
		/// List of templates to create
		/// </summary>
		public List<CreateTemplateRefRequest>? Templates { get; set; }
	...
	public class GetStreamResponse
	{
		...
		/// <summary>
		/// Last version of the config file that was read
		/// </summary>
		...
		/// <param name="ConfigPath">The config file path on the server</param>
		/// <param name="ConfigChange">Last config change that was read</param>
