...
class FReplicationSystemLowLevelTestsFile : public IPlatformFile
{
public:
	FReplicationSystemLowLevelTestsFile() : LowerLevel(nullptr) {}
...
class FReplicationSystemLowLevelTestsFileModule : public IPlatformFileModule
{
public:
	virtual IPlatformFile* GetPlatformFile() override
	{
		static TUniquePtr<IPlatformFile> AutoDestroySingleton = MakeUnique<FReplicationSystemLowLevelTestsFile>();
		return AutoDestroySingleton.Get();
	}
};

IMPLEMENT_MODULE(FReplicationSystemLowLevelTestsFileModule, ReplicationSystemLowLevelTestsFile);
