...
namespace Jupiter.Implementation
{
    public class NginxRedirectHelper
    {
        ...
        public IActionResult CreateActionResult(BlobContents blobContents)
        {
            ...
            return new NginxRedirectOkResult($"{_nginxSettings.CurrentValue.NginxRootPath}/{s}");
        }
    ...
    public class NginxRedirectOkResult : OkResult
    {
        ...
        public NginxRedirectOkResult(string nginxRedirectPath)
        {
