...
namespace UnrealBuildTool
{
	...
	class VSCodeProjectFileGenerator : ProjectFileGenerator
	{
		...
		protected override void AddTargetForIntellisense(UEBuildTarget Target, ILogger Logger)
		{
			...
			{
				VCEnvironment Environment = VCEnvironment.Create(WindowsPlatform.GetDefaultCompiler(null, Target.Rules.WindowsPlatform.Architecture, Logger), Target.Platform, Target.Rules.WindowsPlatform.Architecture, null, Target.Rules.WindowsPlatform.WindowsSdkVersion, null, Target.Rules.WindowsPlatform.bUseCPPWinRT, Logger);
