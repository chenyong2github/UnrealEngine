	...
	class MakefileGenerator : ProjectFileGenerator
	{
		...
		private bool WriteMakefile()
		{
			...
			if (!String.IsNullOrEmpty(GameProjectName))
			{
				...
				ProjectBuildCommand = $"PROJECTBUILD = bash \"$(UNREALROOTPATH)/Engine/{Unreal.RelativeDotnetDirectory}/dotnet\" \"$(UNREALROOTPATH)/Engine/Binaries/DotNET/UnrealBuildTool.dll\"\n";
			}
