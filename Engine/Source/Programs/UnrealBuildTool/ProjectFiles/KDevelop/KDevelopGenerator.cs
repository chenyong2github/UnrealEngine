...
namespace UnrealBuildTool
{
	...
	class KDevelopGenerator : ProjectFileGenerator
	{
		...
		private void WriteCommandSection(ref StringBuilder FileContent)
		{
			...
			FileContent.Append("Arguments=-f Makefile UnrealEditor UnrealGame ShaderCompileWorker UnrealLightmass InterchangeWorker UnrealPak\n");
			FileContent.Append("Enabled=true\n");
			FileContent.Append("Environment=\n");
			...
			FileContent.Append("Arguments=-f Makefile UnrealEditor UnrealGame ShaderCompileWorker UnrealLightmass InterchangeWorker UnrealPak -clean\n");
			FileContent.Append("Enabled=true\n");
			FileContent.Append("Environment=\n");
			FileContent.Append("Executable=make\n");
