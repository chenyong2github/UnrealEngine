...
namespace UnrealBuildTool
{
	...
	class WindowsPlatform : UEBuildPlatform
	{
		...
		public override void ValidateTarget(TargetRules Target)
		{
			...
			VCEnvironment Environment = VCEnvironment.Create(Target.WindowsPlatform.Compiler, DefaultCppPlatform, Target.WindowsPlatform.Architecture, Target.WindowsPlatform.CompilerVersion, Target.WindowsPlatform.WindowsSdkVersion);
