	...
	class FASTBuild : ActionExecutor
	{
		...
		private void WriteEnvironmentSetup(ILogger Logger)
		{
			...
			try
			{
                ...
                {
					VCEnv = VCEnvironment.Create(WindowsPlatform.GetDefaultCompiler(null, WindowsArchitecture.x64, Logger), UnrealTargetPlatform.Win64, WindowsArchitecture.x64, null, null, null, false, Logger);
				}
            }
			catch (Exception)
			{
