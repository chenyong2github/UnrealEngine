...
namespace AutomationTool
{
	...
	/// </summary>
	public enum JsonSerializeOptions_DEPRECATED
	{
		/// <summary>
		/// No options
		/// </summary>
	...
	public static class Json_DEPRECATED
	{
		...
		{
			return Serialize(Object, JsonSerializeOptions_DEPRECATED.PrettyPrint);
		}
		...
		/// <returns>JSON representation of the object</returns>
		public static string Serialize(object Object, JsonSerializeOptions_DEPRECATED Options)
		{
			...
			if ((Options & JsonSerializeOptions_DEPRECATED.PrettyPrint) != 0)
			{
				Text = Format(Text);
			}
			return Text;
