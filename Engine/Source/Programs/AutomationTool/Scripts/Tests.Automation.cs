...
class TestTestFarm : BuildCommand
{
	public override void ExecuteBuild()
	{
		...
		string Exe = CombinePaths(CmdEnv.LocalRoot, "Engine", "Binaries", "Win64", "UnrealEditor.exe");
...
class TestLog : BuildCommand
{
	public override void ExecuteBuild()
	{
		...
		string EditorExe = CombinePaths(CmdEnv.LocalRoot, @"Engine/Binaries/Win64/UnrealEditor.exe");
...
//    /Fo&quot;D:\BuildFarm\buildmachine_++depot+UE4\Engine\Intermediate\Build\Win64\UnrealEditor\Development\Projects\Module.Projects.cpp.obj&quot;
