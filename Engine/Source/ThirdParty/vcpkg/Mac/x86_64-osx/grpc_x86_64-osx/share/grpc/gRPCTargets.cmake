...
set_target_properties(gRPC::gpr PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "m;pthread;absl::base;absl::memory;absl::status;absl::str_format;absl::strings;absl::synchronization;absl::time;absl::optional"
)
...
set_target_properties(gRPC::grpc PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "ZLIB::ZLIB;c-ares::cares;gRPC::address_sorting;re2::re2;gRPC::upb;m;pthread;absl::flat_hash_map;absl::time;absl::synchronization;absl::inlined_vector;absl::bind_front;absl::statusor;gRPC::gpr;OpenSSL::SSL;OpenSSL::Crypto;gRPC::address_sorting;-framework CoreFoundation"
)
...
set_target_properties(gRPC::grpc_unsecure PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "ZLIB::ZLIB;c-ares::cares;gRPC::address_sorting;re2::re2;gRPC::upb;m;pthread;absl::flat_hash_map;absl::inlined_vector;absl::time;absl::synchronization;absl::statusor;gRPC::gpr;gRPC::address_sorting;-framework CoreFoundation"
)
