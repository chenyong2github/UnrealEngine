...
set_target_properties(unofficial::http_parser::http_parser PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/http_parser.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS unofficial::http_parser::http_parser )
list(APPEND _IMPORT_CHECK_FILES_FOR_unofficial::http_parser::http_parser "${_IMPORT_PREFIX}/lib/http_parser.lib" )
