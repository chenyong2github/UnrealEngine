...
set PATH_TO_ZLIB_INCLUDE=%PATH_TO_ZLIB%\include\Win64\VS2015
...
set PATH_TO_TBB_INCLUDE=%PATH_TO_TBB%\include
set PATH_TO_TBB_LIB=%PATH_TO_TBB%\lib\Win64\vc14

REM Dependency - Blosc
set PATH_TO_BLOSC_INCLUDE=%PATH_TO_THIRDPARTY%\Blosc\Deploy\c-blosc-1.5.0\include
set PATH_TO_BLOSC_LIB=%PATH_TO_THIRDPARTY%\Blosc\Deploy\c-blosc-1.5.0\lib\Win64\VS2019\Release

REM Dependency - Boost
set PATH_TO_BOOST=%PATH_TO_THIRDPARTY%\Boost\boost-1_70_0
set PATH_TO_BOOST_INCLUDE=%PATH_TO_BOOST%\include
set PATH_TO_BOOST_LIB=%PATH_TO_BOOST%\lib\Win64
...
cmake -G "Visual Studio 16 2019" -A x64^
    ...
    -DZLIB_INCLUDE_DIR="%PATH_TO_ZLIB_INCLUDE%"^
    -DZLIB_LIBRARY="%ZLIB_LIBRARY%"^
    -DTBB_INCLUDEDIR="%PATH_TO_TBB_INCLUDE%"^
    -DTBB_LIBRARYDIR="%PATH_TO_TBB_LIB%"^
    -DBLOSC_INCLUDEDIR="%PATH_TO_BLOSC_INCLUDE%"^
    -DBLOSC_LIBRARYDIR="%PATH_TO_BLOSC_LIB%"^
    -DBoost_NO_BOOST_CMAKE=ON^
    -DBoost_NO_SYSTEM_PATHS=ON^
    -DBOOST_INCLUDEDIR="%PATH_TO_BOOST_INCLUDE%"^
    -DBOOST_LIBRARYDIR="%PATH_TO_BOOST_LIB%"^
    -DUSE_PKGCONFIG=OFF^
