This solution builds libs and/or dlls (depending on output configuration) to wrap Windows Mixed Reality cppwinrt apis available in Windows 10 SDK's 17134+ to UE4.
