...
#ifndef WINRT_Microsoft_Holographic_AppRemoting_2_H
#define WINRT_Microsoft_Holographic_AppRemoting_2_H
...
namespace winrt::Microsoft::Holographic::AppRemoting
{
    struct DataChannelCloseHandler : Windows::Foundation::IUnknown
    {
        ...
        DataChannelCloseHandler(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IUnknown(ptr, take_ownership_from_abi) {}
    ...
    struct DataChannelReceivedHandler : Windows::Foundation::IUnknown
    {
        ...
        DataChannelReceivedHandler(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IUnknown(ptr, take_ownership_from_abi) {}
    ...
    struct OnConnectedHandler : Windows::Foundation::IUnknown
    {
        ...
        OnConnectedHandler(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IUnknown(ptr, take_ownership_from_abi) {}
    ...
    struct OnDataChannelCreatedHandler : Windows::Foundation::IUnknown
    {
        ...
        OnDataChannelCreatedHandler(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IUnknown(ptr, take_ownership_from_abi) {}
    ...
    struct OnDisconnectedHandler : Windows::Foundation::IUnknown
    {
        ...
        OnDisconnectedHandler(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IUnknown(ptr, take_ownership_from_abi) {}
    ...
    struct OnListeningHandler : Windows::Foundation::IUnknown
    {
        ...
        OnListeningHandler(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IUnknown(ptr, take_ownership_from_abi) {}
    ...
    struct OnRecognizedSpeechHandler : Windows::Foundation::IUnknown
    {
        ...
        OnRecognizedSpeechHandler(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IUnknown(ptr, take_ownership_from_abi) {}
    ...
    struct OnSendFrameHandler : Windows::Foundation::IUnknown
    {
        ...
        OnSendFrameHandler(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IUnknown(ptr, take_ownership_from_abi) {}
    ...
    inline bool operator==(CertificateValidationResult const& left, CertificateValidationResult const& right) noexcept
    {
    ...
    struct __declspec(empty_bases) PlayerContext : Microsoft::Holographic::AppRemoting::IPlayerContext,
        impl::require<PlayerContext, Microsoft::Holographic::AppRemoting::IPlayerContext2, Windows::Foundation::IClosable>
    {
        ...
        PlayerContext(void* ptr, take_ownership_from_abi_t) noexcept : Microsoft::Holographic::AppRemoting::IPlayerContext(ptr, take_ownership_from_abi) {}
        static Microsoft::Holographic::AppRemoting::PlayerContext Create();
    };
    struct __declspec(empty_bases) RemoteContext : Microsoft::Holographic::AppRemoting::IRemoteContext,
        impl::require<RemoteContext, Windows::Foundation::IClosable>
    {
        RemoteContext(std::nullptr_t) noexcept {}
        RemoteContext(void* ptr, take_ownership_from_abi_t) noexcept : Microsoft::Holographic::AppRemoting::IRemoteContext(ptr, take_ownership_from_abi) {}
