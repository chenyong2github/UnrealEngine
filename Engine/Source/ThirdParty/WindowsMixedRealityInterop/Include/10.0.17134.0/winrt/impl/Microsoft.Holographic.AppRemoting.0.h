...
template <> struct guid<Microsoft::Holographic::AppRemoting::IAuthenticationProvider>{ static constexpr GUID value{ 0xAF3D4CD6,0x8484,0x445A,{ 0xB8,0xB3,0xB9,0x6D,0xA5,0x71,0x1E,0x3E } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::IAuthenticationProviderCallback>{ static constexpr GUID value{ 0xC4BC488F,0x8CD4,0x4118,{ 0xAC,0x15,0x78,0x59,0xF3,0x91,0x66,0x76 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::IAuthenticationReceiver>{ static constexpr GUID value{ 0xDA1E721D,0x0DE9,0x4DEA,{ 0x97,0x60,0x5D,0x21,0x86,0x22,0xEA,0xEB } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::IAuthenticationReceiverCallback>{ static constexpr GUID value{ 0xEBF38C18,0x3F5D,0x4B79,{ 0x95,0x24,0x1C,0x23,0x0D,0xC6,0x9D,0xE8 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::ICertificate>{ static constexpr GUID value{ 0xA0669DB2,0x2157,0x4227,{ 0x88,0x00,0x0A,0x35,0x7C,0x2A,0x29,0x00 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::ICertificateChain>{ static constexpr GUID value{ 0x4415B01F,0xCE8F,0x4599,{ 0xA7,0xC8,0x0B,0x5E,0x6A,0x27,0x77,0x08 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::ICertificateProvider>{ static constexpr GUID value{ 0xEAF80CCD,0x2D8A,0x4F43,{ 0xA6,0x4F,0xBA,0x1F,0x91,0xBD,0xC2,0x5F } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::ICertificateProviderCallback>{ static constexpr GUID value{ 0x6797F815,0xE529,0x4697,{ 0xB6,0x1D,0x68,0xEF,0x50,0x82,0xAD,0x19 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::ICertificateValidationCallback>{ static constexpr GUID value{ 0xC8945A4C,0x33DB,0x4143,{ 0x8C,0x9E,0xAF,0x35,0xA2,0xE5,0x78,0x09 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::ICertificateValidator>{ static constexpr GUID value{ 0xAC9BD062,0xC81E,0x479F,{ 0xB3,0x3C,0xAC,0x97,0x9C,0x67,0x12,0xE5 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::IDataChannel>{ static constexpr GUID value{ 0x66B1E9F7,0x5ECE,0x47F5,{ 0xB7,0x83,0x91,0xDA,0xCA,0xF0,0x61,0x88 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::IPlayerContext>{ static constexpr GUID value{ 0xF1A6F630,0x4427,0x429B,{ 0x82,0xBA,0x9C,0x87,0xF6,0x5D,0xAF,0xE8 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::IPlayerContextStatics>{ static constexpr GUID value{ 0xDFAE5C25,0x4F8A,0x4980,{ 0xB6,0x70,0xA6,0x81,0x14,0x88,0xCD,0x37 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::IRemoteContext>{ static constexpr GUID value{ 0xEED1E1FE,0xFFE2,0x439A,{ 0xA9,0x5C,0x70,0xA5,0x8E,0x6D,0x7A,0xA2 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::IRemoteContextStatics>{ static constexpr GUID value{ 0xAB97C9AB,0x4F28,0x4A07,{ 0xBB,0xC9,0xEF,0xF7,0xDA,0x9E,0xC6,0x40 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::IRemoteSpeech>{ static constexpr GUID value{ 0x1A2B59D5,0x668F,0x41C1,{ 0xB0,0x2B,0x6A,0x7F,0xB5,0x43,0x32,0x91 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::DataChannelCloseHandler>{ static constexpr GUID value{ 0x77467E89,0xA9FD,0x4D8D,{ 0xAE,0xA2,0xBF,0xBB,0xA5,0x0A,0x32,0xA7 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::DataChannelReceivedHandler>{ static constexpr GUID value{ 0xC972E7DD,0xDA67,0x4815,{ 0xB3,0xD4,0x98,0x28,0xDF,0x3A,0x04,0x5C } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::OnConnectedHandler>{ static constexpr GUID value{ 0xBD1BA158,0x486E,0x4F9A,{ 0x9A,0x56,0xE0,0x47,0x71,0x74,0xAD,0xBD } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::OnDataChannelCreatedHandler>{ static constexpr GUID value{ 0xC3502D33,0x218B,0x42C8,{ 0x8B,0xFC,0x17,0x90,0xB3,0x57,0xD8,0xCB } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::OnDisconnectedHandler>{ static constexpr GUID value{ 0xB3B7AD12,0xF720,0x4A49,{ 0x92,0xC3,0xF8,0x25,0x61,0x73,0x30,0xC5 } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::OnRecognizedSpeechHandler>{ static constexpr GUID value{ 0x46E4393B,0x301E,0x4F0C,{ 0xB0,0xFD,0x0D,0x1F,0x48,0x09,0x0E,0x6C } }; };
template <> struct guid<Microsoft::Holographic::AppRemoting::OnSendFrameHandler>{ static constexpr GUID value{ 0x63858100,0x63D6,0x4509,{ 0xB5,0x66,0x1E,0xEF,0x31,0xB3,0x5B,0x77 } }; };
...
{
    event_token OnDataReceived(Microsoft::Holographic::AppRemoting::DataChannelReceivedHandler const& handler) const;
    using OnDataReceived_revoker = event_revoker<Microsoft::Holographic::AppRemoting::IDataChannel>;
    ...
    void OnDataReceived(event_token const& token) const;
    void SendData(array_view<uint8_t const> data, bool guaranteedDelivery) const;
    void Close() const;
    event_token OnClosed(Microsoft::Holographic::AppRemoting::DataChannelCloseHandler const& handler) const;
    using OnClosed_revoker = event_revoker<Microsoft::Holographic::AppRemoting::IDataChannel>;
    OnClosed_revoker OnClosed(auto_revoke_t, Microsoft::Holographic::AppRemoting::DataChannelCloseHandler const& handler) const;
    void OnClosed(event_token const& token) const;
};
...
struct consume_Microsoft_Holographic_AppRemoting_IPlayerContext
{
    ...
    event_token OnConnected(Microsoft::Holographic::AppRemoting::OnConnectedHandler const& handler) const;
    using OnConnected_revoker = event_revoker<Microsoft::Holographic::AppRemoting::IPlayerContext>;
    OnConnected_revoker OnConnected(auto_revoke_t, Microsoft::Holographic::AppRemoting::OnConnectedHandler const& handler) const;
    void OnConnected(event_token const& token) const;
    event_token OnDisconnected(Microsoft::Holographic::AppRemoting::OnDisconnectedHandler const& handler) const;
    using OnDisconnected_revoker = event_revoker<Microsoft::Holographic::AppRemoting::IPlayerContext>;
    ...
    void OnDisconnected(event_token const& token) const;
    ...
    event_token OnDataChannelCreated(Microsoft::Holographic::AppRemoting::OnDataChannelCreatedHandler const& handler) const;
    using OnDataChannelCreated_revoker = event_revoker<Microsoft::Holographic::AppRemoting::IPlayerContext>;
    ...
    void OnDataChannelCreated(event_token const& token) const;
...
struct consume_Microsoft_Holographic_AppRemoting_IRemoteContext
{
    ...
    Microsoft::Holographic::AppRemoting::ConnectionState ConnectionState() const;
    event_token OnConnected(Microsoft::Holographic::AppRemoting::OnConnectedHandler const& handler) const;
    using OnConnected_revoker = event_revoker<Microsoft::Holographic::AppRemoting::IRemoteContext>;
    OnConnected_revoker OnConnected(auto_revoke_t, Microsoft::Holographic::AppRemoting::OnConnectedHandler const& handler) const;
    void OnConnected(event_token const& token) const;
    event_token OnDisconnected(Microsoft::Holographic::AppRemoting::OnDisconnectedHandler const& handler) const;
    using OnDisconnected_revoker = event_revoker<Microsoft::Holographic::AppRemoting::IRemoteContext>;
    OnDisconnected_revoker OnDisconnected(auto_revoke_t, Microsoft::Holographic::AppRemoting::OnDisconnectedHandler const& handler) const;
    void OnDisconnected(event_token const& token) const;
    event_token OnSendFrame(Microsoft::Holographic::AppRemoting::OnSendFrameHandler const& handler) const;
    using OnSendFrame_revoker = event_revoker<Microsoft::Holographic::AppRemoting::IRemoteContext>;
    OnSendFrame_revoker OnSendFrame(auto_revoke_t, Microsoft::Holographic::AppRemoting::OnSendFrameHandler const& handler) const;
    void OnSendFrame(event_token const& token) const;
    void CreateDataChannel(uint8_t channelId, Microsoft::Holographic::AppRemoting::DataChannelPriority const& priority) const;
    event_token OnDataChannelCreated(Microsoft::Holographic::AppRemoting::OnDataChannelCreatedHandler const& handler) const;
    using OnDataChannelCreated_revoker = event_revoker<Microsoft::Holographic::AppRemoting::IRemoteContext>;
    OnDataChannelCreated_revoker OnDataChannelCreated(auto_revoke_t, Microsoft::Holographic::AppRemoting::OnDataChannelCreatedHandler const& handler) const;
    void OnDataChannelCreated(event_token const& token) const;
...
struct consume_Microsoft_Holographic_AppRemoting_IRemoteSpeech
{
    ...
    event_token OnRecognizedSpeech(Microsoft::Holographic::AppRemoting::OnRecognizedSpeechHandler const& handler) const;
    using OnRecognizedSpeech_revoker = event_revoker<Microsoft::Holographic::AppRemoting::IRemoteSpeech>;
    ...
    void OnRecognizedSpeech(event_token const& token) const;
};
...
{
    virtual HRESULT __stdcall GetToken(void* callback) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::IAuthenticationProviderCallback>{ struct type : IInspectable
{
    virtual HRESULT __stdcall TokenReceived(HSTRING token) noexcept = 0;
...
{
    virtual HRESULT __stdcall ValidateToken(HSTRING token, void* callback) noexcept = 0;
    virtual HRESULT __stdcall GetRealm(HSTRING* result) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::IAuthenticationReceiverCallback>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ValidationCompleted(HSTRING token, bool isValid) noexcept = 0;
    virtual HRESULT __stdcall Cancel() noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::ICertificate>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetCertificatePfx(uint32_t* __resultSize, uint8_t** result) noexcept = 0;
    virtual HRESULT __stdcall GetSubjectName(HSTRING* result) noexcept = 0;
    virtual HRESULT __stdcall GetPfxPassword(HSTRING* result) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::ICertificateChain>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetCertificate(uint32_t index, uint32_t* __resultSize, uint8_t** result) noexcept = 0;
    virtual HRESULT __stdcall get_Length(uint32_t* result) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::ICertificateProvider>{ struct type : IInspectable
{
    virtual HRESULT __stdcall GetCertificate(void* callback) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::ICertificateProviderCallback>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CertificateReceived(void* certificate) noexcept = 0;
    virtual HRESULT __stdcall Cancel() noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::ICertificateValidationCallback>{ struct type : IInspectable
{
    virtual HRESULT __stdcall CertificateValidated(struct struct_Microsoft_Holographic_AppRemoting_CertificateValidationResult result) noexcept = 0;
    virtual HRESULT __stdcall Cancel() noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::ICertificateValidator>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ValidateCertificate(void* certificateChain, HSTRING serverName, bool forceRevocationCheck, void* systemValidationResult, void* callback) noexcept = 0;
    virtual HRESULT __stdcall get_PerformSystemValidation(bool* result) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::IDataChannel>{ struct type : IInspectable
{
    virtual HRESULT __stdcall add_OnDataReceived(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_OnDataReceived(event_token token) noexcept = 0;
    virtual HRESULT __stdcall SendData(uint32_t __dataSize, uint8_t* data, bool guaranteedDelivery) noexcept = 0;
    virtual HRESULT __stdcall Close() noexcept = 0;
    virtual HRESULT __stdcall add_OnClosed(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_OnClosed(event_token token) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::IPlayerContext>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Connect(HSTRING hostname, uint16_t port) noexcept = 0;
    virtual HRESULT __stdcall ConnectSecure(HSTRING hostname, uint16_t port, void* authProvider, void* certValidator) noexcept = 0;
    virtual HRESULT __stdcall Listen(HSTRING localHostname, uint16_t handshakePort, uint16_t primaryTransportPort) noexcept = 0;
    virtual HRESULT __stdcall ListenSecure(HSTRING localHostname, uint16_t handshakePort, uint16_t primaryTransportPort, void* provider, void* receiver) noexcept = 0;
    virtual HRESULT __stdcall Disconnect() noexcept = 0;
    virtual HRESULT __stdcall get_ConnectionState(Microsoft::Holographic::AppRemoting::ConnectionState* result) noexcept = 0;
    virtual HRESULT __stdcall add_OnConnected(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_OnConnected(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_OnDisconnected(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_OnDisconnected(event_token token) noexcept = 0;
    virtual HRESULT __stdcall get_PoseMode(Microsoft::Holographic::AppRemoting::CameraPoseMode* result) noexcept = 0;
    virtual HRESULT __stdcall put_PoseMode(Microsoft::Holographic::AppRemoting::CameraPoseMode value) noexcept = 0;
    virtual HRESULT __stdcall BlitRemoteFrame(Microsoft::Holographic::AppRemoting::BlitResult* result) noexcept = 0;
    virtual HRESULT __stdcall CreateDataChannel(uint8_t channelId, Microsoft::Holographic::AppRemoting::DataChannelPriority priority) noexcept = 0;
    virtual HRESULT __stdcall add_OnDataChannelCreated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_OnDataChannelCreated(event_token token) noexcept = 0;
    virtual HRESULT __stdcall get_LastFrameStatistics(struct struct_Microsoft_Holographic_AppRemoting_PlayerFrameStatistics* result) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::IPlayerContextStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(void** result) noexcept = 0;
};};
...
template <> struct abi<Microsoft::Holographic::AppRemoting::IRemoteContext>{ struct type : IInspectable
{
    ...
    virtual HRESULT __stdcall add_OnDisconnected(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_OnDisconnected(event_token token) noexcept = 0;
    virtual HRESULT __stdcall add_OnSendFrame(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_OnSendFrame(event_token token) noexcept = 0;
    virtual HRESULT __stdcall CreateDataChannel(uint8_t channelId, Microsoft::Holographic::AppRemoting::DataChannelPriority priority) noexcept = 0;
    virtual HRESULT __stdcall add_OnDataChannelCreated(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_OnDataChannelCreated(event_token token) noexcept = 0;
    virtual HRESULT __stdcall GetRemoteSpeech(void** result) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::IRemoteContextStatics>{ struct type : IInspectable
{
    virtual HRESULT __stdcall Create(void** result) noexcept = 0;
    virtual HRESULT __stdcall Create2(uint32_t maxBitrateKbps, void** result) noexcept = 0;
    virtual HRESULT __stdcall Create3(uint32_t maxBitrateKbps, bool enableAudio, void** result) noexcept = 0;
    virtual HRESULT __stdcall Create4(uint32_t maxBitrateKbps, bool enableAudio, Microsoft::Holographic::AppRemoting::PreferredVideoCodec preferredVideoCodec, void** result) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::IRemoteSpeech>{ struct type : IInspectable
{
    virtual HRESULT __stdcall ApplyParameters(HSTRING language, void* grammarFile, uint32_t __dictionarySize, HSTRING* dictionary) noexcept = 0;
    virtual HRESULT __stdcall add_OnRecognizedSpeech(void* handler, event_token* token) noexcept = 0;
    virtual HRESULT __stdcall remove_OnRecognizedSpeech(event_token token) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Invoke(uint32_t __dataSize, uint8_t* data) noexcept = 0;
};};
...
{
    virtual HRESULT __stdcall Invoke(void* dataChannel, uint8_t channelId) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::OnDisconnectedHandler>{ struct type : IUnknown
{
    virtual HRESULT __stdcall Invoke(Microsoft::Holographic::AppRemoting::ConnectionFailureReason failureReason) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::OnRecognizedSpeechHandler>{ struct type : IUnknown
{
    virtual HRESULT __stdcall Invoke(struct struct_Microsoft_Holographic_AppRemoting_RecognizedSpeech recognizedSpeech) noexcept = 0;
};};

template <> struct abi<Microsoft::Holographic::AppRemoting::OnSendFrameHandler>{ struct type : IUnknown
{
    virtual HRESULT __stdcall Invoke(void* texture) noexcept = 0;
};};
