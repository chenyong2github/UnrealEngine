...
#include "winrtbase.h"
#include "C:\Program Files (x86)\Windows Kits\10\UnionMetadata\10.0.17134.0\Windows.h"
    ...
    namespace Holographic {
        namespace AppRemoting {
            ...
            struct RecognizedSpeech
            {
                ...
                enum Windows::Media::SpeechRecognition::SpeechRecognitionConfidence Confidence;
...
namespace Microsoft {
    namespace Holographic {
        namespace AppRemoting {
            ...
            public:
                virtual HRESULT STDMETHODCALLTYPE Invoke(
                    /* [in] */enum Microsoft::Holographic::AppRemoting::ConnectionFailureReason failureReason
                    ) = 0;
        ...
        namespace AppRemoting {
            ...
            public:
                ...
                /* [propget] */virtual HRESULT STDMETHODCALLTYPE get_ConnectionState(
                    /* [out, retval] */enum Microsoft::Holographic::AppRemoting::ConnectionState * result
                    ) = 0;
                ...
                virtual HRESULT STDMETHODCALLTYPE CreateDataChannel(
                    /* [in] */byte channelId,
                    /* [in] */enum Microsoft::Holographic::AppRemoting::DataChannelPriority priority
                    ) = 0;
        ...
        namespace AppRemoting {
            ...
            public:
                ...
                /* [overload] */virtual HRESULT STDMETHODCALLTYPE Create4(
                    /* [in] */unsigned int maxBitrateKbps,
                    /* [in] */boolean enableAudio,
                    /* [in] */enum Microsoft::Holographic::AppRemoting::PreferredVideoCodec preferredVideoCodec,
                    /* [out, retval] */Microsoft::Holographic::AppRemoting::IRemoteContext * * result
                    ) = 0;
        ...
        namespace AppRemoting {
            ...
            public:
                ...
                /* [propget] */virtual HRESULT STDMETHODCALLTYPE get_PoseMode(
                    /* [out, retval] */enum Microsoft::Holographic::AppRemoting::CameraPoseMode * result
                    ) = 0;
                /* [propput] */virtual HRESULT STDMETHODCALLTYPE put_PoseMode(
                    /* [in] */enum Microsoft::Holographic::AppRemoting::CameraPoseMode value
                    ) = 0;
                virtual HRESULT STDMETHODCALLTYPE BlitRemoteFrame(
                    /* [out, retval] */enum Microsoft::Holographic::AppRemoting::BlitResult * result
                    ) = 0;
                virtual HRESULT STDMETHODCALLTYPE CreateDataChannel(
                    /* [in] */byte channelId,
                    /* [in] */enum Microsoft::Holographic::AppRemoting::DataChannelPriority priority
                ...
                /* [propget] */virtual HRESULT STDMETHODCALLTYPE get_LastFrameStatistics(
                    /* [out, retval] */struct Microsoft::Holographic::AppRemoting::PlayerFrameStatistics * result
                    ) = 0;
...
#define __x_Microsoft_CHolographic_CAppRemoting_CICertificateChain_get_Length(This,result) \
...
#define __x_Microsoft_CHolographic_CAppRemoting_CICertificateValidator_get_PerformSystemValidation(This,result) \
    ( (This)->lpVtbl->get_PerformSystemValidation(This,result) )
...
HRESULT ( STDMETHODCALLTYPE *Connect )(
    ...
    /* [propget] */HRESULT ( STDMETHODCALLTYPE *get_ConnectionState )(
        __x_Microsoft_CHolographic_CAppRemoting_CIRemoteContext * This,
        /* [out, retval] */enum __x_Microsoft_CHolographic_CAppRemoting_CConnectionState * result
        );
...
#define __x_Microsoft_CHolographic_CAppRemoting_CIRemoteContext_get_ConnectionState(This,result) \
    ( (This)->lpVtbl->get_ConnectionState(This,result) )
...
HRESULT ( STDMETHODCALLTYPE *Connect )(
    ...
    /* [propget] */HRESULT ( STDMETHODCALLTYPE *get_PoseMode )(
        __x_Microsoft_CHolographic_CAppRemoting_CIPlayerContext * This,
        /* [out, retval] */enum __x_Microsoft_CHolographic_CAppRemoting_CCameraPoseMode * result
        );
    ...
    /* [propget] */HRESULT ( STDMETHODCALLTYPE *get_LastFrameStatistics )(
        __x_Microsoft_CHolographic_CAppRemoting_CIPlayerContext * This,
        /* [out, retval] */struct __x_Microsoft_CHolographic_CAppRemoting_CPlayerFrameStatistics * result
        );
    END_INTERFACE
...
#define __x_Microsoft_CHolographic_CAppRemoting_CIPlayerContext_get_ConnectionState(This,result) \
    ( (This)->lpVtbl->get_ConnectionState(This,result) )
...
#define __x_Microsoft_CHolographic_CAppRemoting_CIPlayerContext_get_PoseMode(This,result) \
    ( (This)->lpVtbl->get_PoseMode(This,result) )
...
#define __x_Microsoft_CHolographic_CAppRemoting_CIPlayerContext_get_LastFrameStatistics(This,result) \
    ( (This)->lpVtbl->get_LastFrameStatistics(This,result) )
