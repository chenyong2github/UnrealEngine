...
cd "%VS2017_X86_PATH%"
cmake -G "Visual Studio 15 2017" -DCMAKE_SUPPRESS_REGENERATION=1 -DVIVOXSDK_PATH=../../vivox-sdk/Include %PATH_TO_CMAKE_FILE%
...
cd "%VS2017_X64_PATH%"
cmake -G "Visual Studio 15 2017 Win64" -DCMAKE_SUPPRESS_REGENERATION=1 -DVIVOXSDK_PATH=../../vivox-sdk/Include %PATH_TO_CMAKE_FILE% -DUSE_LOGIN_SESSION_AUDIO_SETTINGS=1
