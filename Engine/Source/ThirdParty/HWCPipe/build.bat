...
REM Build ARMv7
%CMAKE_BIN%\cmake.exe -DANDROID_ABI=armeabi-v7a -DCMAKE_BUILD_TYPE=Release -DCMAKE_MAKE_PROGRAM=%CMAKE_BIN%\ninja.exe -G Ninja -DCMAKE_TOOLCHAIN_FILE=%ANDROID_NDK_ROOT%\build\cmake\android.toolchain.cmake -DANDROID_NATIVE_API_LEVEL=23 -H%CD%\include\ -Bbuild\armeabi-v7a\
