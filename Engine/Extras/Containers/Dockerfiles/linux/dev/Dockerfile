# This file was generated by ue4-docker version 0.0.92 with the following options:
# 
# - buildgraph_args: "-set:WithLinuxAArch64=false -set:WithClient=true -set:WithServer=true"
# - combine: true
...
WORKDIR /home/ue4/UnrealEngine
RUN ./Engine/Build/BatchFiles/RunUAT.sh BuildGraph -target="Make Installed Build Linux" -script=Engine/Build/InstalledEngineBuild.xml -set:HostPlatformOnly=true -set:WithDDC=true -set:WithLinuxAArch64=false -set:WithClient=true -set:WithServer=true && \
