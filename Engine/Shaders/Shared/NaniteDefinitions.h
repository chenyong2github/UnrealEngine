...
#define NANITE_DEBUG_FLAG_RENDER_ONLY_ROOT_DATA				0x80
...
// Any visualization modes after this point don't render in the post process pass
#define NANITE_VISUALIZE_FIRST_NON_POST_PROCESS				33u
#define NANITE_VISUALIZE_ROOT_GEOMETRY						33u
