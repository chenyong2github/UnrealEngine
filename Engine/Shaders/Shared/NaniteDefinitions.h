...
#define NANITE_RENDER_FLAG_IGNORE_VISIBLE_IN_RASTER			0x80
#define NANITE_RENDER_FLAG_IS_SCENE_CAPTURE					0x100
#define NANITE_RENDER_FLAG_IS_REFLECTION_CAPTURE			0x200
#define NANITE_RENDER_FLAG_IS_GAME_VIEW						0x400
#define NANITE_RENDER_FLAG_GAME_SHOW_FLAG_ENABLED			0x800
#define NANITE_RENDER_FLAG_EDITOR_SHOW_FLAG_ENABLED			0x1000
#define NANITE_RENDER_FLAG_PROGRAMMABLE_RASTER				0x2000
