...
#define PRIMITIVE_SCENE_DATA_FLAG_DISABLE_MATERIAL_INVALIDATIONS		0x20000000
...
#define INSTANCE_SCENE_DATA_FLAG_HAS_SPLINE_MESH_PARAMS		0x80 // Mobile allocates only 8 bits for instance flags
