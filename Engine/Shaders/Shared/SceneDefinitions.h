...
#define PRIMITIVE_SCENE_DATA_FLAG_WRITES_CUSTOM_DEPTH_STENCIL			0x80000
#define PRIMITIVE_SCENE_DATA_FLAG_DISABLE_MATERIAL_INVALIDATIONS		0x100000
#define PRIMITIVE_SCENE_DATA_FLAG_HOLDOUT								0x200000
#define PRIMITIVE_SCENE_DATA_FLAG_SPLINE_MESH							0x400000
// NOTE: Mobile allocates only 24 bits for primitive flags
