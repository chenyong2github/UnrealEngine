...
int32 FElectraH265VideoDecoderAndroidJava::InitializeDecoder(const FCreateParameters& InCreateParams)
{
	...
	if (bHaveDecoder)
	{
		...
		if (InCreateParams.CodecData && InCreateParams.CodecData->GetNumberOfSPS() > 0)
		{
			JEnv->SetIntField(CreateParams, FCreateParameters_Width, InCreateParams.CodecData->GetParsedSPS(0).GetWidth());
			JEnv->SetIntField(CreateParams, FCreateParameters_Height, InCreateParams.CodecData->GetParsedSPS(0).GetHeight());
