...
class PIXELSTREAMING_API FPixelStreamingAudioDeviceModule : public webrtc::AudioDeviceModule
{
public:
...
private:
	...
	TUniquePtr<IPixelStreamingAudioSubmixCapturer> Capturer;
	TUniquePtr<IPixelStreamingAudioPlayoutRequester> Requester;
