...
namespace UE::PixelStreaming
{
	...
	public:
		...
		void SetTargetScreenSize(TWeakPtr<FIntPoint> InScreenSize) override;
		TWeakPtr<FIntPoint> GetTargetScreenSize() override;
		...
		virtual TWeakPtr<SViewport> GetTargetViewport() override;
       	...
       	virtual void RegisterHandler(const FString& MessageType, const TFunction<void(FMemoryReader)>& Handler) override;
    protected:
