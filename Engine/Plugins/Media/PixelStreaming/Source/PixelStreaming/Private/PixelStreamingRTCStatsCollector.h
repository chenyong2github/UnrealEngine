...
class FPixelStreamingRTCStatsCollector : public webrtc::RTCStatsCollectorCallback
{
public:
	FPixelStreamingRTCStatsCollector();
	FPixelStreamingRTCStatsCollector(FPlayerId PlayerId);
