...
namespace UE::PixelStreaming
{
	...
	class FVideoEncoderAdapterSimulcast : public webrtc::VideoEncoder
	{
	public:
		FVideoEncoderAdapterSimulcast(FVideoEncoderFactorySimulcast& InSimulcastFactory, const webrtc::SdpVideoFormat& format);
		~FVideoEncoderAdapterSimulcast() override;
	...
	private:
		...
		FVideoEncoderFactorySimulcast& SimulcastEncoderFactory;
		...
		//int EncodeStream(const webrtc::VideoFrame& InputImage, TSharedPtr<FTextureTripleBuffer> LayerFrameSource, size_t StreamIdx, bool bSendKeyFrame);
		int EncodeVP8(const webrtc::VideoFrame& InputImage, const std::vector<webrtc::VideoFrameType>* FrameTypes, bool bSendKeyFrame);
		int EncodeVP9(const webrtc::VideoFrame& InputImage, const std::vector<webrtc::VideoFrameType>* FrameTypes, bool bSendKeyFrame);
