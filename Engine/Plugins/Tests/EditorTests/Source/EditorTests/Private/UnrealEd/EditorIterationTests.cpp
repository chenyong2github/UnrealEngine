...
*/
IMPLEMENT_COMPLEX_AUTOMATION_TEST(FIterationOpenAssets, "Project.Iteration.OpenAssets", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter);
