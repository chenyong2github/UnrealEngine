...
public:
	...
	*/
	...
	static bool CameraConnect(const FMagicLeapCameraConnect& ResultDelegate);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Camera Function Library | MagicLeap")
	static bool CameraDisconnect(const FMagicLeapCameraDisconnect& ResultDelegate);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Camera Function Library | MagicLeap")
	static bool CaptureImageToFileAsync(const FMagicLeapCameraCaptureImgToFile& ResultDelegate);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Camera Function Library | MagicLeap")
	static bool CaptureImageToTextureAsync(const FMagicLeapCameraCaptureImgToTexture& ResultDelegate);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Camera Function Library | MagicLeap")
	static bool StartRecordingAsync(const FMagicLeapCameraStartRecording& ResultDelegate);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Camera Function Library | MagicLeap")
	static bool StopRecordingAsync(const FMagicLeapCameraStopRecording& ResultDelegate);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Camera Function Library | MagicLeap")
	static bool SetLogDelegate(const FMagicLeapCameraLogMessage& LogDelegate);
