...
public:
	...
	virtual bool CameraConnect(const FMagicLeapCameraConnect& ResultDelegate) { return true; }
	virtual bool CameraDisconnect(const FMagicLeapCameraDisconnect& ResultDelegate) { return true; }
