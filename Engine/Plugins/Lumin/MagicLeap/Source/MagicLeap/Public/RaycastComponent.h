...
class MAGICLEAP_API UMagicLeapRaycastComponent
...
public:
	...
	virtual ~UMagicLeapRaycastComponent();
	...
	*/
	...
	bool RequestRaycast(const FMagicLeapRaycastQueryParams& RequestParams, const FRaycastResultDelegate& ResultDelegate);
...
private:
	...
	class FMagicLeapRaycastTrackerImpl *Impl;
...
public:
	UFUNCTION(BlueprintPure, BlueprintCallable, Category = "Raycast|MagicLeap", meta = (NativeMakeFunc, Direction="1,0,0", UpVector="0,0,1", Width="1", Height="1"))
