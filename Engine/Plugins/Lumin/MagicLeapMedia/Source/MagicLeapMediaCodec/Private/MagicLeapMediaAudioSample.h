...
/**
 * Implements a media audio sample for MagicLeapMedia.
 */
class FMagicLeapMediaAudioSample : public IMediaAudioSample, public IMediaPoolable
{
public:

	/** Default constructor. */
	FMagicLeapMediaAudioSample()
	: Channels(0)
	...
	/** Virtual destructor. */
	virtual ~FMagicLeapMediaAudioSample() { }
...
class FMagicLeapMediaAudioSamplePool : public TMediaObjectPool<FMagicLeapMediaAudioSample> { };
