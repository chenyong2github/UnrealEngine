...
namespace FLevelSnapshotsEditorResultsHelpers
{
	...
	TWeakPtr<FPropertyHandleHierarchy> FindCorrespondingHandle(const FLevelSnapshotPropertyChain& InPropertyChain, const FText& InDisplayName, const TWeakPtr<FPropertyHandleHierarchy>& HierarchyToSearch, bool& bFoundMatch);
