...
{
	/** 
	 * GPUBuffer pointer to the sample data to use during conversion 
	 * Only valid when GPUDirect is used
	 */
	TRefCountPtr<FRDGPooledBuffer> GPUBuffer = nullptr;

	/** System memory pointer to the sample data to use during conversion */
	const void* SystemBuffer = nullptr;
