...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTestCameraCalibration, "Plugins.CameraCalibration", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FTestCameraCalibration::RunTest(const FString& Parameters)
{
	CameraCalibrationTestUtil::TestBilinearFindGrid(*this);
