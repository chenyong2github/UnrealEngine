...
class SDMXControlConsoleSpinBoxVertical
...
public:
	...
	SLATE_BEGIN_ARGS(SDMXControlConsoleSpinBoxVertical<NumericType>)
			...
			[
				...
				[
					...
					[
						...
						.Text(this, &SDMXControlConsoleSpinBoxVertical<NumericType>::GetValueAsText)
						.MinDesiredWidth(this, &SDMXControlConsoleSpinBoxVertical<NumericType>::GetTextMinDesiredWidth)
				...
				[
					...
					[
						...
						.Text(this, &SDMXControlConsoleSpinBoxVertical<NumericType>::GetValueAsText)
						.OnIsTypedCharValid(this, &SDMXControlConsoleSpinBoxVertical<NumericType>::IsCharacterValid)
						.OnTextChanged( this, &SDMXControlConsoleSpinBoxVertical<NumericType>::TextField_OnTextChanged)
						.OnTextCommitted( this, &SDMXControlConsoleSpinBoxVertical<NumericType>::TextField_OnTextCommitted)
		...
		if (!bUnlimitedSpinRange)
		{
			...
			if (!FMath::IsNearlyEqual(CachedSliderExponent, 1.f))
			{
				if (SliderExponentNeutralValue.IsSet() && SliderExponentNeutralValue.Get() > GetMinSliderValue() && SliderExponentNeutralValue.Get() < GetMaxSliderValue())
				{
					...
					using namespace UE::DMX::ControlConsole::SDMXControlConsoleSpinBoxVertical::Private;
	...
	{
		// SDMXControlConsoleSpinBoxVertical is focusable.
		return true;
	}
