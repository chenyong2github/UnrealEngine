...
{
	DECLARE_DELEGATE_OneParam(FDMXFixturePatchRowDelegate, const TSharedRef<SDMXControlConsoleFixturePatchRowWidget>&)

public:
	SLATE_BEGIN_ARGS(SDMXControlConsoleFixturePatchRowWidget)
	{}
