...
{
public:
	SLATE_BEGIN_ARGS(SDMXControlConsoleFaderGroup)
	{}
	...
	void Construct(const FArguments& InArgs, const TWeakPtr<SDMXControlConsoleFaderGroupView>& InFaderGroupView);
...
private:
	...
	TWeakPtr<SDMXControlConsoleFaderGroupView> FaderGroupView;
