...
#include "SDMXControlConsolePortSelector.h"
...
#define LOCTEXT_NAMESPACE "SDMXControlConsolePortSelector"

BEGIN_SLATE_FUNCTION_BUILD_OPTIMIZATION
void SDMXControlConsolePortSelector::Construct(const FArguments& InArgs)
{
	...
	[
		...
		[
			...
			[
				...
				.OnCheckStateChanged(this, &SDMXControlConsolePortSelector::OnSendToAllPortsCheckBoxChanged)
		...
		[
			...
			[
				...
				.OnPortSelected(this, &SDMXControlConsolePortSelector::HandlePortSelected)
			]
		]
	];
...
bool SDMXControlConsolePortSelector::IsSendToAllPorts() const
{
...
FGuid SDMXControlConsolePortSelector::GetSelectedPortGuid() const
{
...
void SDMXControlConsolePortSelector::UpdateSelectedPorts()
{
	check(SendToAllPortsCheckBox.IsValid());
	check(PortSelector.IsValid());
...
void SDMXControlConsolePortSelector::OnSendToAllPortsCheckBoxChanged(const ECheckBoxState NewCheckState)
{
	UpdateSelectedPorts();
	OnPortsSelected.ExecuteIfBound();
}

void SDMXControlConsolePortSelector::HandlePortSelected()
{
	UpdateSelectedPorts();
	OnPortsSelected.ExecuteIfBound();
}
