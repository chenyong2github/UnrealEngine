...
#include "DMXControlConsoleStyle.h"
...
FDMXControlConsoleStyle::FDMXControlConsoleStyle()
	: FSlateStyleSet("DMXControlConsoleStyle")
{
	...
	if (ensureMsgf(Plugin.IsValid(), TEXT("Cannot find Plugin 'DMXEngine' hence cannot set the DMXControlConsoleStyle root directory.")))
	{
...
const FDMXControlConsoleStyle& FDMXControlConsoleStyle::Get()
{
	static const FDMXControlConsoleStyle Inst;
	return Inst;
}
