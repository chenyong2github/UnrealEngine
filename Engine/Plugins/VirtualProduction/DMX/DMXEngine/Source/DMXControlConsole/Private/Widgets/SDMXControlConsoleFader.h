...
template<typename NumericType> class SDMXControlConsoleSpinBoxVertical;
...
class SDMXControlConsoleFader
	: public SCompoundWidget
{	
public:
	SLATE_BEGIN_ARGS(SDMXControlConsoleFader)
	{}
...
private:
	...
	TSharedPtr<SDMXControlConsoleSpinBoxVertical<uint32>> FaderSpinBox;
};
