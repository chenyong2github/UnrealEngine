...
{
	RegisterNomadTabSpawner(FDMXEditorTabNames::ChannelsMonitorTabName,
	...
	RegisterNomadTabSpawner(FDMXEditorTabNames::ActivityMonitorTabName,
	...
	RegisterNomadTabSpawner(FDMXEditorTabNames::OutputConsoleTabName,
