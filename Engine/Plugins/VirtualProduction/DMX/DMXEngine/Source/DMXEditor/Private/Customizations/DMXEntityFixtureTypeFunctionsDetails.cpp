...
TSharedRef<IDetailCustomization> FDMXEntityFixtureTypeFunctionsDetails::MakeInstance(TWeakPtr<FDMXEditor> InDMXEditorPtr)
{
	return MakeShared<FDMXEntityFixtureTypeFunctionsDetails>(InDMXEditorPtr);
}
