...
FDMXMVRGeneralSceneDescription::FDMXMVRGeneralSceneDescription()
{}

FDMXMVRGeneralSceneDescription::FDMXMVRGeneralSceneDescription(TSharedRef<FXmlFile> GeneralSceneDescription)
{
	ParseMVRFixtures(GeneralSceneDescription);
}

void FDMXMVRGeneralSceneDescription::ParseMVRFixtures(const TSharedRef<FXmlFile>& GeneralSceneDescription)
{
