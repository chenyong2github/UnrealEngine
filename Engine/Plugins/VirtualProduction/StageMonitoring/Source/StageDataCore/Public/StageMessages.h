...
public:
	//Will use current instance information to fill in descriptor.
	void FillWithInstanceData();
 ...
 */
USTRUCT()
struct STAGEDATACORE_API FFramePerformanceProviderMessage : public FStageProviderPeriodicMessage
{
	GENERATED_BODY()
 ...
 */
USTRUCT()
struct STAGEDATACORE_API FHitchDetectionMessage : public FStageProviderEventMessage
{
	GENERATED_BODY()
