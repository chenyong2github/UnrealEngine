...
PACKAGE_SCOPE:
	...
	struct FPendingInviteData
	{
		...
		TSharedPtr<const FUniqueNetIdRail> InviterUserId;
	 ...
	 */
	void QueryAcceptedUserInvitation(TSharedRef<const FUniqueNetIdRail> InLocalUser, TSharedRef<const FUniqueNetIdRail> InRemoteUser);
