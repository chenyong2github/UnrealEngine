...
void FMassMovementEditorModule::StartupModule()
{
	...
	PropertyModule.RegisterCustomPropertyTypeLayout(TEXT("MassMovementConfigRef"), FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FMassMovementConfigRefDetails::MakeInstance));
...
void FMassMovementEditorModule::ShutdownModule()
{
	...
	if (FModuleManager::Get().IsModuleLoaded(TEXT("PropertyEditor")))
	{
		...
		PropertyModule.UnregisterCustomPropertyTypeLayout(TEXT("MassMovementConfigRef"));
