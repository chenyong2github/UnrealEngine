...
#define UE4_VIRTUAL_MSGPACK_DEFINE(...)                                                \
...
// the lambdas body).
#define UE4_RPC_BIND(FuncName, FuncBody) TEXT(FuncName), [this](FRPCServer& Serv) { Serv.bind(FuncName, FuncBody); }
