...
class UnrealEnv(gym.Env):
    ...
    def _setup_agents(self, reacquire):
        ...
        if self.__agent_id != INVALID_ID:
            ...
            action_space = spaces.gym_space_from_ue4ml(response)
            ...
            observation_space = spaces.gym_space_from_ue4ml(response)
    ...
    def render(self):
        # do nothing for now, UE4 instance will do the rendering on its own as part of 'step' call
        pass
