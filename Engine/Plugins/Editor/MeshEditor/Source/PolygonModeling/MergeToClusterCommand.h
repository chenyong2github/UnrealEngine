...
private:
	void MergeToCluster(IMeshEditorModeEditingContract& MeshEditorMode, TArray<AActor*>& SelectedActors);
	void MergeMultipleMeshes(IMeshEditorModeEditingContract& MeshEditorMode, TArray<AActor*>& SelectedActors);
