...
#include "CollapseAllHierarchyCommand.generated.h"

DECLARE_LOG_CATEGORY_EXTERN(LogCollapseAllHierarchyCommand, Log, All);

/** Performs merging of the currently selected meshes */
UCLASS()
class UCollapseAllHierarchyCommand : public UMeshEditorInstantCommand, public FGeometryCollectionCommandCommon
{
public:
	GENERATED_BODY()
