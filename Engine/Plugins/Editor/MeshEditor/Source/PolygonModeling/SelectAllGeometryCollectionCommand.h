...
#include "SelectAllGeometryCollectionCommand.generated.h"

DECLARE_LOG_CATEGORY_EXTERN(LogSelectAllGeometryCommand, Log, All);

/** Select All chunks in mesh */
UCLASS()
class USelectAllGeometryCollectionCommand : public UMeshEditorInstantCommand, public FGeometryCollectionCommandCommon
{
public:
	GENERATED_BODY()
