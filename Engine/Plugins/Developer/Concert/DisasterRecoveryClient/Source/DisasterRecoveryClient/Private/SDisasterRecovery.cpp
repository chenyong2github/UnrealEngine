		...
		[
			...
			[
				...
				[
					...
					.ToolTipText(LOCTEXT("RecoverTooltip", "Recover your assets to the state they were up to the selected recovery point (included)"))
				...
				[
					...
					.ToolTipText(LOCTEXT("CancelRecoveryTooltip", "Don't recover, resume work using the assets as they are on disk (last saved), losing unsaved work."))
