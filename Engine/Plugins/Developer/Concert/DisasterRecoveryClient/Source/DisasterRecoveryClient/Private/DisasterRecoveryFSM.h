 ...
 * @param Client The client configured with the recovery server URL, the recovery session name and recovery archive name.
 ...
 */
void StartRecovery(IConcertClientRef Client, const FString& SessionNameToRecover, bool bLiveDataOnly);
