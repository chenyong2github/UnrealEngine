...
class ISkeinSourceControlWorker
{
public:
	/**
	 ...
	 */
	virtual bool Execute(class FSkeinSourceControlCommand& InCommand) = 0;
...
typedef TSharedRef<ISkeinSourceControlWorker, ESPMode::ThreadSafe> FSkeinSourceControlWorkerRef;
