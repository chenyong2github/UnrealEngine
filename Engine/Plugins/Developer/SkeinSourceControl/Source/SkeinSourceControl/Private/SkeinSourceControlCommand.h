...
/**
 * Used to execute Skein commands multi-threaded.
 */
class FSkeinSourceControlCommand : public IQueuedWork
{
public:

	FSkeinSourceControlCommand(const TSharedRef<class ISourceControlOperation, ESPMode::ThreadSafe>& InOperation, const TSharedRef<class ISkeinSourceControlWorker, ESPMode::ThreadSafe>& InWorker, const FSourceControlOperationComplete& InOperationCompleteDelegate = FSourceControlOperationComplete() );
...
public:
	/** Path to the Skein binary */
	FString SkeinBinaryPath;

	/** Path to the root of the project */
	FString SkeinProjectRoot;
	...
	TSharedRef<class ISkeinSourceControlWorker, ESPMode::ThreadSafe> Worker;
