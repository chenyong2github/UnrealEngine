...
*/
class FBridgeMessageHandler : public FGenericApplicationMessageHandler
{
	
public:

	FBridgeMessageHandler(const TSharedPtr<FGenericApplicationMessageHandler>& InTargetHandler);

	FBridgeMessageHandler();

	virtual ~FBridgeMessageHandler();
