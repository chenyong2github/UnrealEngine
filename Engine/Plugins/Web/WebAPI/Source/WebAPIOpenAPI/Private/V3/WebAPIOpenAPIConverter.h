	...
	namespace WebAPI
	{
		namespace OpenAPI
		{
			...
			public:
				...
				template <>
				TSharedPtr<OpenAPI::V3::FSchemaObject> ResolveReference(const FString& InDefinitionName);

				template <>
				TSharedPtr<OpenAPI::V3::FParameterObject> ResolveReference(const FString& InDefinitionName);

				template <>
				TSharedPtr<OpenAPI::V3::FResponseObject> ResolveReference(const FString& InDefinitionName);

				template <>
				TSharedPtr<OpenAPI::V3::FSecuritySchemeObject> ResolveReference(const FString& InDefinitionName);

				template <>
				TSharedPtr<OpenAPI::V3::FRequestBodyObject> ResolveReference(const FString& InDefinitionName);
...
*/
				...
				/** Modifies an existing Model using the supplied source object. */
				template <>
				bool ConvertModel(const TSharedPtr<OpenAPI::V3::FParameterObject>& InSrcSchema, const FWebAPITypeNameVariant& InModelTypeName, const TObjectPtr<UWebAPIModel>& OutModel);
