...
namespace UE
{
	...
	namespace Json
	{
		inline bool FromJson(const TSharedRef<FJsonObject>& InJsonObject, UE::WebAPI::OpenAPI::V3::FPathsObject& OutObject)
		{
		...
		inline bool FromJson(const TSharedRef<FJsonObject>& InJsonObject, UE::WebAPI::OpenAPI::V3::FSecurityRequirementObject& OutObject)
		{
			return UE::Json::TryGet(MakeShared<FJsonValueObject>(InJsonObject), OutObject);
		}
	}
