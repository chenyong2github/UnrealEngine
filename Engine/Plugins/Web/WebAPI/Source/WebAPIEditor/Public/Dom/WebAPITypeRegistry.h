...
public:
	 ...
	 */
	const TObjectPtr<UWebAPITypeInfo>& GetOrMakeGeneratedType(const EWebAPISchemaType& InSchemaType, const FString& InName, const FString& InJsonName, const FString& InPrefix = TEXT(""), FName InDeclarationType = NAME_None);
	const TObjectPtr<UWebAPITypeInfo>& GetOrMakeGeneratedType(const EWebAPISchemaType& InSchemaType, const FString& InName, const FString& InJsonName, const TObjectPtr<UWebAPITypeInfo>& InTemplateTypeInfo);
