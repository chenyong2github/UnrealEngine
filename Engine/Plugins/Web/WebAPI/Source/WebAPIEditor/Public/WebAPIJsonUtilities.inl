...
namespace UE::Json
{
	...
	UE::Json::TryGet(const TSharedPtr<FJsonValue>& InJsonValue, ValueType& OutValue)
	{
	...
	template <typename ValueType>
	constexpr typename TEnableIf<TypeTraits::TIsNumeric<ValueType>::Value, bool>::Type
	UE::Json::TryGetField(const TSharedPtr<FJsonObject>& InJsonObject, const FString& InFieldName, ValueType& OutValue)
	{
