...
void SVariantManager::OnObjectTransacted(UObject* Object, const class FTransactionObjectEvent& Event)
{
	...
	if (TargetActor != nullptr)
	{
		...
		{
			if (Object->IsA(USceneComponent::StaticClass()) && Event.GetChangedProperties().Contains(GET_MEMBER_NAME_CHECKED(USceneComponent, USceneComponent::GetVisiblePropertyName())))
			{
