...
int32 MelangeGetInt32(cineware::BaseList2D* Object, cineware::Int32 Parameter)
{
	if (Object)
	{
		...
		if (Object->GetParameter(Parameter, Data, cineware::DESCFLAGS_GET::NONE) && Data.GetType() == cineware::DA_LONG)
		{
...
int64 MelangeGetInt64(cineware::BaseList2D* Object, cineware::Int32 Parameter)
{
	...
	{
		cineware::GeData Data;
		if (Object->GetParameter(Parameter, Data, cineware::DESCFLAGS_GET::NONE) && Data.GetType() == cineware::DA_LLONG)
		{
...
double MelangeGetDouble(cineware::BaseList2D* Object, cineware::Int32 Parameter)
{
	...
	{
		cineware::GeData Data;
		if (Object->GetParameter(Parameter, Data, cineware::DESCFLAGS_GET::NONE))
		{
...
FVector MelangeGetVector(cineware::BaseList2D* Object, cineware::Int32 Parameter)
{
	...
	{
		cineware::GeData Data;
		if (Object->GetParameter(Parameter, Data, cineware::DESCFLAGS_GET::NONE) && Data.GetType() == cineware::DA_VECTOR)
		{
...
FMatrix MelangeGetMatrix(cineware::BaseList2D* Object, cineware::Int32 Parameter)
{
	...
	{
		cineware::GeData Data;
		if (Object->GetParameter(Parameter, Data, cineware::DESCFLAGS_GET::NONE) && Data.GetType() == cineware::DA_MATRIX)
		{
...
cineware::BaseList2D* MelangeGetLink(cineware::BaseList2D* Object, cineware::Int32 Parameter)
{
	...
	{
		cineware::GeData Data;
		if (Object->GetParameter(Parameter, Data, cineware::DESCFLAGS_GET::NONE) && Data.GetType() == cineware::DA_ALIASLINK)
		{
			auto lnk = Data.GetBaseLink();
			if (lnk)
			{
				return lnk->ForceGetLink();
			}
			return nullptr;
		}
	}
...
{
	return FMatrix(MelangeVectorToFVector(Matrix.sqmat.v1),
				   MelangeVectorToFVector(Matrix.sqmat.v2),
				   MelangeVectorToFVector(Matrix.sqmat.v3),
				   MelangeVectorToFVector(Matrix.off));
}

FString MelangeStringToFString(const cineware::String& MelangeString)
{
	cineware::Char* tmp = MelangeString.GetCStringCopy();
...
FString GeDataToString(const cineware::GeData& Data)
{
	...
	case cineware::DA_ALIASLINK:
	{
		...
		if (lnk)
		{
			cineware::BaseList2D* Target = lnk->ForceGetLink();
...
FString MelangeParameterValueToString(cineware::BaseList2D* Object, cineware::Int32 ParameterID)
{
	...
	{
		cineware::GeData Data;
		if (Object->GetParameter(ParameterID, Data, cineware::DESCFLAGS_GET::NONE))
		{
