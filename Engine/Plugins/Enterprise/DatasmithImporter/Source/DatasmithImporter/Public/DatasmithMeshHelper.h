...
namespace DatasmithMeshHelper
{
	 ...
	 */
	DATASMITHIMPORTER_API int32 GetPolygonCount(const FMeshDescription& Mesh);
	 ...
	 */
	DATASMITHIMPORTER_API int32 GetTriangleCount(const FMeshDescription& Mesh);
	 ...
	 */
	DATASMITHIMPORTER_API void ExtractVertexPositions(const FMeshDescription& Mesh, TArray<FVector>& Positions);
	 ...
	 */
	DATASMITHIMPORTER_API void PrepareAttributeForStaticMesh(FMeshDescription& Mesh);
	 ...
	 */
	DATASMITHIMPORTER_API void FillUStaticMesh(UStaticMesh* StaticMesh, int32 LodIndex, FRawMesh& RawMesh, const TMap<int32, FName>* InMaterialMapInverse = nullptr);
	DATASMITHIMPORTER_API void FillUStaticMesh(UStaticMesh* StaticMesh, int32 LodIndex, FDatasmithMesh& DSMesh);
	DATASMITHIMPORTER_API void FillUStaticMeshByCopy(UStaticMesh* StaticMesh, int LodIndex, FMeshDescription MeshDescription);
	DATASMITHIMPORTER_API void FillUStaticMesh(UStaticMesh* StaticMesh, int LodIndex, FMeshDescription&& MeshDescription);
	/**
	 ...
	 */
	DATASMITHIMPORTER_API void PrepareStaticMaterials(UStaticMesh* StaticMesh, int32 MaterialCount);
	 ...
	 */
	DATASMITHIMPORTER_API void BuildMaterialMappingFromStaticMesh(UStaticMesh* StaticMesh, TMap<FName, int32>& MaterialMap, TMap<int32, FName>& MaterialMapInverse);
	 ...
	 * @return DATASMITHIMPORTER_API void
	 */
	DATASMITHIMPORTER_API void HashMeshLOD(UStaticMesh* StaticMesh, int32 LodIndex, FMD5& MD5);
	 ...
	 * @param MD5   Hash to update
	 */
	DATASMITHIMPORTER_API void HashMeshDescription(const FMeshDescription& Mesh, FMD5& MD5);
	 ...
	 */
	DATASMITHIMPORTER_API FName DefaultSlotName(int32 MaterialIndex);

	DATASMITHIMPORTER_API int32 GetNumUVChannel(const FMeshDescription& Mesh);
	DATASMITHIMPORTER_API bool HasUVChannel(const FMeshDescription& Mesh, int32 ChannelIndex);

	DATASMITHIMPORTER_API bool HasUVData(const FMeshDescription& Mesh, int32 ChannelIndex);

	DATASMITHIMPORTER_API bool RequireUVChannel(FMeshDescription& Mesh, int32 ChannelIndex);
	 ...
	 */
	DATASMITHIMPORTER_API void CreateDefaultUVs(FDatasmithMesh& DatasmithMesh);
	 ...
	 */
	DATASMITHIMPORTER_API void CreateDefaultUVs(FMeshDescription& MeshDescription);
	 ...
	 */
	DATASMITHIMPORTER_API bool IsMeshValid(const FMeshDescription& Mesh, FVector BuildScale=FVector::OneVector);
}
