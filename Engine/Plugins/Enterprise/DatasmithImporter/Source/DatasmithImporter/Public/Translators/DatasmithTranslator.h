 ...
 */
class DATASMITHIMPORTER_API IDatasmithTranslator
{
public:
...
namespace Datasmith
{
	...
	namespace Details
	{
		void DATASMITHIMPORTER_API RegisterTranslatorImpl(const FTranslatorRegisterInformation& Info);
		void DATASMITHIMPORTER_API UnregisterTranslatorImpl(const FTranslatorRegisterInformation& Info);
	};
