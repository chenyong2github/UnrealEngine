...
struct FGLTFMaterialUtility
{
	...
	static FGLTFPropertyBakeOutput BakeMaterialProperty(const FIntPoint& OutputSize, EMaterialProperty Property, const UMaterialInterface* Material, int32 TexCoord, FMeshDescription* MeshDescription = nullptr, TArray<int32>* MeshMaterialIndices = nullptr, bool bCopyAlphaFromRedChannel = false);
