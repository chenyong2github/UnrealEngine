...
class FGLTFPositionVertexBufferConverter final : public TGLTFConverter<FGLTFJsonAccessorIndex, const FPositionVertexBuffer*>
{
	...
	FGLTFJsonAccessorIndex Convert(const FString& Name, const FPositionVertexBuffer* VertexBuffer) override;
};
...
class FGLTFColorVertexBufferConverter final : public TGLTFConverter<FGLTFJsonAccessorIndex, const FColorVertexBuffer*>
{
	...
	FGLTFJsonAccessorIndex Convert(const FString& Name, const FColorVertexBuffer* VertexBuffer) override;
};
...
class FGLTFNormalVertexBufferConverter final : public TGLTFConverter<FGLTFJsonAccessorIndex, const FStaticMeshVertexBuffer*>
{
	...
	FGLTFJsonAccessorIndex Convert(const FString& Name, const FStaticMeshVertexBuffer* VertexBuffer) override;
};
...
class FGLTFUVVertexBufferConverter final : public TGLTFConverter<FGLTFJsonAccessorIndex, const FStaticMeshVertexBuffer*, int32>
{
	...
	FGLTFJsonAccessorIndex Convert(const FString& Name, const FStaticMeshVertexBuffer* VertexBuffer, int32 UVIndex) override;
};
...
class FGLTFBoneIndexVertexBufferConverter final : public TGLTFConverter<FGLTFJsonAccessorIndex, const FSkinWeightVertexBuffer*, int32, FGLTFBoneMap>
{
	...
	FGLTFJsonAccessorIndex Convert(const FString& Name, const FSkinWeightVertexBuffer* VertexBuffer, int32 InfluenceOffset, FGLTFBoneMap BoneMap) override;

	template <typename IndexType>
	FGLTFJsonAccessorIndex Convert(const FString& Name, const FSkinWeightVertexBuffer* VertexBuffer, int32 JointsGroupIndex, FGLTFBoneMap BoneMap);
};
...
class FGLTFBoneWeightVertexBufferConverter final : public TGLTFConverter<FGLTFJsonAccessorIndex, const FSkinWeightVertexBuffer*, int32>
{
	...
	FGLTFJsonAccessorIndex Convert(const FString& Name, const FSkinWeightVertexBuffer* VertexBuffer, int32 WeightsGroupIndex) override;
};
