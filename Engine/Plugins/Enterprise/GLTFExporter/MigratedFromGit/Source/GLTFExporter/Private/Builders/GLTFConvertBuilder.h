...
public:
	...
	FGLTFJsonAccessorIndex GetOrAddJointAccessor(const FSkinWeightVertexBuffer* VertexBuffer, int32 InfluenceOffset, const FString& DesiredName = TEXT(""));
	FGLTFJsonAccessorIndex GetOrAddWeightAccessor(const FSkinWeightVertexBuffer* VertexBuffer, int32 InfluenceOffset, const FString& DesiredName = TEXT(""));
