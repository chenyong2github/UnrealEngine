...
public:
	...
	FGLTFUVAnalysisConverter UVAnalysisConverter;
	...
	FGLTFJsonMaterialIndex GetOrAddMaterial(const UMaterialInterface* Material, const FGLTFMeshData* MeshData = nullptr, const TArray<int32>& SectionIndices = {});
