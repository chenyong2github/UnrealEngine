...
class FLevelSnapshotsEditorFilterClass : public TSharedFromThis<FLevelSnapshotsEditorFilterClass>
{
public:
	FLevelSnapshotsEditorFilterClass(UClass* Class);
	 ...
	 */
	FLevelSnapshotsEditorFilterClass( const FString& InClassName, const FString& InClassDisplayName );

	FLevelSnapshotsEditorFilterClass( const FLevelSnapshotsEditorFilterClass& InCopyObject);
	 ...
	 */
	void AddChild( TSharedPtr<FLevelSnapshotsEditorFilterClass> Child );
	 ...
	 */
	void AddUniqueChild(TSharedPtr<FLevelSnapshotsEditorFilterClass> NewChild);
	...
	TArray<TSharedPtr<FLevelSnapshotsEditorFilterClass>>& GetChildrenList()
	{
		return ChildrenList;
	}
...
private:
	...
	/** List of children. */
	TArray<TSharedPtr<FLevelSnapshotsEditorFilterClass>> ChildrenList;
...
public:
	...
	TWeakPtr< FLevelSnapshotsEditorFilterClass > ParentNode;
