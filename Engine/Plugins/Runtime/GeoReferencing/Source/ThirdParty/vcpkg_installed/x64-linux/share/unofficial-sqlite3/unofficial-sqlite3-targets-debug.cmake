...
set_target_properties(unofficial::sqlite3::sqlite3 PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libsqlite3.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS unofficial::sqlite3::sqlite3 )
list(APPEND _IMPORT_CHECK_FILES_FOR_unofficial::sqlite3::sqlite3 "${_IMPORT_PREFIX}/debug/lib/libsqlite3.a" )
