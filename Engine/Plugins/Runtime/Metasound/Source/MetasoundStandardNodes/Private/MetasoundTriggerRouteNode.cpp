...
namespace Metasound
{
	...
	REGISTER_TRIGGER_ROUTE_NOTE(int32, 6)
	REGISTER_TRIGGER_ROUTE_NOTE(int32, 7)
	REGISTER_TRIGGER_ROUTE_NOTE(int32, 8)
	...
	REGISTER_TRIGGER_ROUTE_NOTE(float, 6)
	REGISTER_TRIGGER_ROUTE_NOTE(float, 7)
	REGISTER_TRIGGER_ROUTE_NOTE(float, 8)
	...
	REGISTER_TRIGGER_ROUTE_NOTE(bool, 6)
	REGISTER_TRIGGER_ROUTE_NOTE(bool, 7)
	REGISTER_TRIGGER_ROUTE_NOTE(bool, 8)

	REGISTER_TRIGGER_ROUTE_NOTE(FAudioBuffer, 2)
	REGISTER_TRIGGER_ROUTE_NOTE(FAudioBuffer, 3)
	REGISTER_TRIGGER_ROUTE_NOTE(FAudioBuffer, 4)
	REGISTER_TRIGGER_ROUTE_NOTE(FAudioBuffer, 5)
	REGISTER_TRIGGER_ROUTE_NOTE(FAudioBuffer, 6)
	REGISTER_TRIGGER_ROUTE_NOTE(FAudioBuffer, 7)
	REGISTER_TRIGGER_ROUTE_NOTE(FAudioBuffer, 8)
}
