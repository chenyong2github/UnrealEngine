...
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(void);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(bool);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(int8);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(uint8);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(int16);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(uint16);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(int32);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(uint32);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(int64);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(uint64);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(float);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(double);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(FString);
DECLARE_METASOUND_ENVIRONMENT_VARIABLE_TYPE(FName);
