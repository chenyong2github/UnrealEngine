...
#include "OpenXRHandTrackingFunctionLibrary.generated.h"

UCLASS(ClassGroup = OpenXR)
class OPENXRHANDTRACKING_API UOpenXRHandTrackingFunctionLibrary :
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "HandTracking|OpenXR")
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "HandTracking|OpenXR")
	static bool GetHandJointTransform(EControllerHand Hand, EOpenXRHandKeypoint Keypoint, FTransform& Transform, float& Radius);
};
