...
namespace UnrealBuildTool.Rules
{
	public class AzureSpatialAnchorsForWMR : ModuleRules
	{
		public AzureSpatialAnchorsForWMR(ReadOnlyTargetRules Target) : base(Target)
		{
			...
			{
				RuntimeDependencies.Add(System.IO.Path.Combine("$(EngineDir)/Binaries/ThirdParty/HoloLens/ARM64", "Microsoft.Azure.SpatialAnchors.dll"));
				RuntimeDependencies.Add(System.IO.Path.Combine("$(EngineDir)/Binaries/ThirdParty/HoloLens/ARM64", "Microsoft.Azure.SpatialAnchors.winmd"));
			}
