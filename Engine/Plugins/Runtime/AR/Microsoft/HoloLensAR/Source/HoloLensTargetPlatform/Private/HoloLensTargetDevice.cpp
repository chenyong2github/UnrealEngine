...
bool FHoloLensTargetDevice::Launch(const FString& AppId, EBuildConfigurations::Type BuildConfiguration, EBuildTargetType BuildTarget, const FString& Params, uint32* OutProcessId)
{
	return false;
}
