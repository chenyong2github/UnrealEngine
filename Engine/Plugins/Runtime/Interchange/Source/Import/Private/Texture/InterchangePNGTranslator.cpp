...
bool UInterchangePNGTranslator::Translate(const UInterchangeSourceData* SourceData, Interchange::FBaseNodeContainer& BaseNodeContainer) const
{
...
const TOptional<Interchange::FImportImage> UInterchangePNGTranslator::GetPayloadData(const UInterchangeSourceData* SourceData, const FString& PayLoadKey) const
{
	if (!SourceData)
	{
