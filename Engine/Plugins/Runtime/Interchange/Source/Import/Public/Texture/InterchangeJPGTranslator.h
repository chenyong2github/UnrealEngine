...
class INTERCHANGEIMPORTPLUGIN_API UInterchangeJPGTranslator : public UInterchangeTranslatorBase, public IInterchangeTexturePayloadInterface
{
	GENERATED_BODY()
public:
	 ...
	 *
	 * @param InSourceData - The source data containing the JPG data
