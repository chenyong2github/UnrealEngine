...
void UDestructibleComponent::BeginPlay()
{
	...
	UE_LOG(LogDestructible, Warning, TEXT("DestructibleComponent is deprecated. Destruction is now supported by UGeometryCollection. Please update your assets before upgrading to the next release."));
#endif
}
