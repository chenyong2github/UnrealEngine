...
/**
 * World condition to match tags of the Smart Object's owning Actor (which must have an AbilitySystemComponent).
 */
...
protected:
	...
	/** Smart Object's owning actor for which the tags must match the query. The Actor must have an AbilitySystemComponent. */
