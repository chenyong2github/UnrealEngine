...
public:
	...
	* 
	 ...
	 */
	bool GetViewports(const UWorld* InWorld, TArray<FString>& OutViewports) const;
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "nDisplay", meta = (EditCondition = "!bRenderAllViewports"))
