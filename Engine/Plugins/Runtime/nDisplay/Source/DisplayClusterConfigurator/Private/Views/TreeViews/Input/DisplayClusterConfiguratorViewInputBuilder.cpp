...
FDisplayClusterConfiguratorViewInputBuilder::FDisplayClusterConfiguratorViewInputBuilder(const TSharedRef<FDisplayClusterConfiguratorBlueprintEditor>& InToolkit)
