...
public:
	...
	virtual void GenerateWidgetForItemColumn(TSharedPtr< SHorizontalBox > Box, const TAttribute<FText>& FilterText, FIsSelected InIsSelected) override;
	virtual TSharedRef< SWidget > GenerateWidgetForGroupColumn(const FName& DataColumnName) override { return SNullWidget::NullWidget; }
