...
namespace DisplayClusterHelpers
{
	...
	namespace str
	{
		...
		static void TrimStringValue(FString& InLine, bool bTrimQuotes = true)
		{
			...
			InLine.RemoveFromStart(DisplayClusterStrings::common::KeyValSeparator);
		...
		// Example: {item1, item2, item3, item4} => "item1,item2,item3,item4"
		template<typename T>
		static FString ArrayToStr(const TArray<T>& InData, const FString& InSeparator = DisplayClusterStrings::common::ArrayValSeparator, bool bAddQuotes = true)
		{
		...
		template<typename TKey, typename TVal>
		FString MapToStr(const TMap<TKey, TVal>& InData, const FString& InPairSeparator = DisplayClusterStrings::common::PairSeparator, const FString& InKeyValSeparator = DisplayClusterStrings::common::KeyValSeparator, bool bAddQuoutes = true)
		{
			static const auto Quotes = TEXT("\"");
		...
		static bool ExtractValue(const FString& InLine, const FString& InParamName, T& OutValue, bool bInTrimQuotes = true)
		{
			...
			const FString FullParamName = InParamName + DisplayClusterStrings::common::KeyValSeparator;
