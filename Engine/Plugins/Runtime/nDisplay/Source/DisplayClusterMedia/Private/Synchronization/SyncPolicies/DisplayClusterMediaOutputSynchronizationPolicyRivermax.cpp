...
#include "Synchronization/DisplayClusterMediaOutputSynchronizationPolicyRivermax.h"
...
bool UDisplayClusterMediaOutputSynchronizationPolicyRivermax::IsCaptureTypeSupported(UMediaCapture* MediaCapture) const
{
...
double UDisplayClusterMediaOutputSynchronizationPolicyRivermax::GetTimeBeforeNextSyncPoint()
{
