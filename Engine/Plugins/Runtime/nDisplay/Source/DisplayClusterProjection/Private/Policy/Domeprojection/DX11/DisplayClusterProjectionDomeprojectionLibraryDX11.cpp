	...
	if (!DllHandle)
	{
		...
		if (!DllHandle)
		{
			...
			if (DllHandle)
			{
				...
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpCreateContextD3D11"), dpCreateContextFunc ? *StrOk : *StrFail);
				...
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpDestroyContextD3D11"), dpDestroyContextFunc ? *StrOk : *StrFail);
				...
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpLoadConfigurationFromFileD3D11"), dpLoadConfigurationFromFileFunc ? *StrOk : *StrFail);
				...
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpSetClippingPlanesD3D11"), dpSetClippingPlanesFunc ? *StrOk : *StrFail);
				...
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpSetActiveChannelD3D11"), dpSetActiveChannelFunc ? *StrOk : *StrFail);
				...
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpSetCorrectionPassD3D11"), dpSetCorrectionPassFunc ? *StrOk : *StrFail);
				...
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpSetCorrectionPassD3D11_1"), dpSetCorrectionPass1Func ? *StrOk : *StrFail);
				...
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpSetFlipWarpmeshVerticesYD3D11"), dpSetFlipWarpmeshVerticesYFunc ? *StrOk : *StrFail);
				...
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpSetFlipWarpmeshTexcoordsVD3D11"), dpSetFlipWarpmeshTexcoordsVFunc ? *StrOk : *StrFail);

				// dpPreDrawD3D11_1
				dpPreDrawFunc = (dpPreDrawD3D11_1)FPlatformProcess::GetDllExport((HMODULE)DllHandle, TEXT("dpPreDrawD3D11_1"));
				check(dpPreDrawFunc);
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpPreDrawD3D11_1"), dpPreDrawFunc ? *StrOk : *StrFail);

				// dpPostDrawD3D11
				dpPostDrawFunc = (dpPostDrawD3D11)FPlatformProcess::GetDllExport((HMODULE)DllHandle, TEXT("dpPostDrawD3D11"));
				check(dpPostDrawFunc);
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpPostDrawD3D11"), dpPostDrawFunc ? *StrOk : *StrFail);
				...
				UE_LOG(LogDisplayClusterProjectionDomeprojection, Log, TEXT("Domeprojection API: %s - %s."), TEXT("dpGetOrientation"), dpGetOrientationFunc ? *StrOk : *StrFail);
			}
			else
			{
