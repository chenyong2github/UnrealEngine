 ...
 */
class FDisplayClusterTextureShare
...
public:
	virtual ~FDisplayClusterTextureShare()
		{ Release(); };

public:
	//////////////////////////////////////////////////////////////////////////////////////////////
	// FDisplayClusterTextureShare
	//////////////////////////////////////////////////////////////////////////////////////////////
	...
	virtual void PerformUpdateViewport(FViewport* MainViewport, const TArray<FDisplayClusterRenderViewport>& RenderViewports) override;
...
private:
	...
	void InitializeResources(FViewport* MainViewport, const TArray<FDisplayClusterRenderViewport>& RenderViewports);
