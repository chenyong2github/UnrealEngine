...
C_COMPILER="$UE_ENGINE_DIR/Extras/ThirdPartyNotUE/SDKs/HostLinux/Linux_x64/v19_clang-11.0.1-centos7/x86_64-unknown-linux-gnu/bin/clang"
CXX_COMPILER="$UE_ENGINE_DIR/Extras/ThirdPartyNotUE/SDKs/HostLinux/Linux_x64/v19_clang-11.0.1-centos7/x86_64-unknown-linux-gnu/bin/clang++"
...
LIBS="$UE_THIRD_PARTY_DIR/Unix/LibCxx/lib/Linux/$ARCH_NAME/libc++.a $UE_THIRD_PARTY_DIR/Unix/LibCxx/lib/Linux/$ARCH_NAME/libc++abi.a"
...
cmake3 --build build --config Release --target install -- -j $NUM_CPU
