...
bool UOpenColorIOEditorBlueprintLibrary::ApplyTextureColorTransform(const FOpenColorIOColorConversionSettings& ConversionSettings, UTexture* InOutTexture, bool bSynchronous)
{	
