...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Movie Scene | Keys", meta = (DisplayName = "Get Time (Event)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Movie Scene | Keys", meta = (DisplayName = "Set Time (Event)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Movie Scene | Keys", meta = (DisplayName = "Get Value (Event)"))
