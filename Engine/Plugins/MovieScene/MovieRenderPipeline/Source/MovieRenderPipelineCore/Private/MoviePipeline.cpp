...
void UMoviePipeline::Shutdown()
{
	...
	// the existing work already processed. This is called at the end of the normal flow, or a blocking
	// shutdown is requested (such as engine shutdown). If called at the end of the normal flow, most
