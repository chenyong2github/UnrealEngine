...
private:
	...
	bool OnDoesItemMatchFilterText(const FText& FilterText, const TSharedPtr<FNiagaraAction_NewNode>& Item);
	int32 OnGetItemWeightForSelection(const TSharedPtr<FNiagaraAction_NewNode>& Item, const TArray<FString>& FilterTerms, const TArray<FString>& SanitizedFilterTerms) const;
