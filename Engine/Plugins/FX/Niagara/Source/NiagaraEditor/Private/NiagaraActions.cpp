...
TOptional<FNiagaraVariable> FNiagaraMenuAction_Parameter::GetParameterVariable() const
{
	return ParameterVariable;
}

void FNiagaraMenuAction_Parameter::SetParameterVariable(const FNiagaraVariable& InParameterVariable)
{
	ParameterVariable = InParameterVariable;
}
