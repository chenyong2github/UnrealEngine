...
public:
	...
	NIAGARA_SYSTEM_INSTANCE_CONTROLLER_SHIM(GetBatcher, const)
	...
	NIAGARA_SYSTEM_INSTANCE_CONTROLLER_SHIM(WaitForAsyncTickAndFinalize,)
...
private:
	...
	void SetVariable(FName InVariableName, FVector4 InValue);
