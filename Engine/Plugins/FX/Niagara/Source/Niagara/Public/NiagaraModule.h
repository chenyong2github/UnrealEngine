...
public:
	...
	FORCEINLINE static const FNiagaraVariable&  GetVar_Particles_RibbonSideVector() { return Particles_RibbonSideVector; }
...
private:
	...
	static FNiagaraVariable Particles_RibbonSideVector;
