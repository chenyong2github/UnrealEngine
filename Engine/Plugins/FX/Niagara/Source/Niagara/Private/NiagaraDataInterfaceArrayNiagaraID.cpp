...
UNiagaraDataInterfaceArrayNiagaraID::UNiagaraDataInterfaceArrayNiagaraID(FObjectInitializer const& ObjectInitializer)
	: UNiagaraDataInterfaceArray(ObjectInitializer)
{
	Proxy.Reset(new FNDIArrayProxyImpl<FNiagaraID, UNiagaraDataInterfaceArrayNiagaraID>(this));
}
