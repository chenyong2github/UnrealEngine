...
{
	FNiagaraDataInterfaceArgs(FNiagaraDataInterfaceProxy* InDataInterface, FNiagaraSystemInstanceID InSystemInstanceID, const FNiagaraGpuComputeDispatchInterface* InComputeDispatchInterface)
...
struct FNiagaraDataInterfaceStageArgs : public FNiagaraDataInterfaceArgs
{
	FNiagaraDataInterfaceStageArgs(FNiagaraDataInterfaceProxy* InDataInterface, FNiagaraSystemInstanceID InSystemInstanceID, const FNiagaraGpuComputeDispatchInterface* InComputeDispatchInterface, const FNiagaraComputeInstanceData* InComputeInstanceData, const FNiagaraSimStageData* InSimStageData, bool InIsOutputStage, bool InIsIterationStage)
		: FNiagaraDataInterfaceArgs(InDataInterface, InSystemInstanceID, InComputeDispatchInterface)
