...
public:
	...
	*/
	...
	NIAGARASHADER_API void BuildScriptParametersMetadata(const TArray<FNiagaraDataInterfaceGPUParamInfo>& InDIParamInfo);
	TSharedRef<FNiagaraShaderScriptParametersMetadata> GetScriptParametersMetadata() const { return ScriptParametersMetadata.ToSharedRef(); }
