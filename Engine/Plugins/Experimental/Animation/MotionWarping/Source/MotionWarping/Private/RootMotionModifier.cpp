...
URootMotionModifier_Warp* URootMotionModifier_Warp::AddRootMotionModifierSimpleWarp(UMotionWarpingComponent* InMotionWarpingComp, const UAnimSequenceBase* InAnimation, float InStartTime, float InEndTime,
	...
	bool bInWarpTranslation, bool bInIgnoreZAxis, bool bInWarpRotation, EMotionWarpRotationType InRotationType, float InWarpRotationTimeMultiplier)
{
	...
	{
		URootMotionModifier_Warp* NewModifier = NewObject<URootMotionModifier_Warp>(InMotionWarpingComp);
