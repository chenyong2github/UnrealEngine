...
struct ANIMNEXT_API FInterfaceKey
{
...
// Key value for cached anim interface state
struct ANIMNEXT_API FInterfaceKeyWithId : FInterfaceKey
{
...
// Key value for cached anim interface state
struct ANIMNEXT_API FInterfaceKeyWithIdAndStack : FInterfaceKeyWithId
{
