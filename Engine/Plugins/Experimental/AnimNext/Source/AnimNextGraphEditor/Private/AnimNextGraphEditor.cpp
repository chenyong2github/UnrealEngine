...
void FGraphEditor::InitEditor(const EToolkitMode::Type InMode, const TSharedPtr<IToolkitHost>& InInitToolkitHost, UAnimNextGraph* InAnimNextGraph)
{
	...
	AnimNextGraph_EditorData = UE::AnimNext::GraphUncookedOnly::FUtils::GetEditorData(AnimNextGraph);
	...
	FAssetEditorToolkit::InitAssetEditor(InMode, InInitToolkitHost, AppIdentifier, FTabManager::FLayout::NullLayout, bCreateDefaultStandaloneMenu, bCreateDefaultToolbar, InAnimNextGraph);
