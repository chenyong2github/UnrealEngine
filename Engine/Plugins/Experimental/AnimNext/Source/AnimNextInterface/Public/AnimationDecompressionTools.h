...
public:
	...
	static void GetAnimationPose(const UAnimSequence* AnimSequence
		, FAnimationLODPose& OutAnimationPoseData
	...
	*/
	static void GetBonePose(const UAnimSequence* AnimSequence, const FAnimExtractContext& ExtractionContext, FAnimationLODPose& OutAnimationPoseData, bool bForceUseRawData = false);

	static void GetBonePose_Additive(const UAnimSequence* AnimSequence, const FAnimExtractContext& ExtractionContext, FAnimationLODPose& OutAnimationPoseData);
	static void GetBonePose_AdditiveMeshRotationOnly(const UAnimSequence* AnimSequence, const FAnimExtractContext& ExtractionContext, FAnimationLODPose& OutAnimationPoseData);

	// Decompress and retarget animation data using provided RetargetTransforms
	static void DecompressPose(FAnimationLODPose& OutAnimationPoseData,
	...
	static void RetargetBoneTransform(const FAnimationReferencePose& ReferencePose
