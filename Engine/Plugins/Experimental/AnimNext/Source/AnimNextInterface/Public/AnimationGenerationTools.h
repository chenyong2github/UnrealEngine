...
class ANIMNEXTINTERFACE_API FGenerationTools
{
public:
	...
	static void RemapPose(int32 LODLevel
		...
		, const FAnimationReferencePose& RefPose
		, FAnimationLODPose& TargetPose); // TODO : see how to deal with heap and stack variants without duplicating functions (and if possible without templating the function)
	...
	static void RemapPose(int32 LODLevel
		, const FAnimationReferencePose& RefPose
		, const FAnimationLODPose& SourcePose
