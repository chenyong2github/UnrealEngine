...
/*static*/ void FGenerationTools::RemapPose(int32 LODLevel, const FPoseContext& SourcePose, const FAnimationReferencePose& RefPose, FAnimationLODPose& TargetPose)
{
...
// This function expects both poses to have the same LOD (number of bones and indexes)
// The target pose should be assigned to the correct reference pose prior to this call
/*static*/ void FGenerationTools::RemapPose(int32 LODLevel, const FAnimationReferencePose& RefPose, const FAnimationLODPose& SourcePose, FPoseContext& TargetPose)
{
	const TArrayView<const FBoneIndexType> LODBoneIndexes = RefPose.GetLODBoneIndexes(LODLevel);
	const int32 NumBones = LODBoneIndexes.Num();
