...
static bool UseRawDataForPoseExtraction(const UAnimSequence* AnimSequence, FAnimationLODPose& AnimationPoseData)
{
...
/*static*/ void FDecompressionTools::GetAnimationPose(const UAnimSequence* AnimSequence, FAnimationLODPose& OutAnimationPoseData, const FAnimExtractContext& ExtractionContext)
{
...
void FDecompressionTools::GetBonePose(const UAnimSequence* AnimSequence, const FAnimExtractContext& ExtractionContext, FAnimationLODPose& OutAnimationPoseData, bool bForceUseRawData /*= false*/)
{
...
void FDecompressionTools::GetBonePose_Additive(const UAnimSequence* AnimSequence, const FAnimExtractContext& ExtractionContext, FAnimationLODPose& OutAnimationPoseData)
{
}

void FDecompressionTools::GetBonePose_AdditiveMeshRotationOnly(const UAnimSequence* AnimSequence, const FAnimExtractContext& ExtractionContext, FAnimationLODPose& OutAnimationPoseData)
{
}
...
void FDecompressionTools::DecompressPose(FAnimationLODPose& OutAnimationPoseData,
...
void FDecompressionTools::DecompressPose(FAnimationLODPose& OutAnimationPoseData,
										...
										const FRootMotionReset& RootMotionReset)
{
	const FAnimationReferencePose& ReferencePose = OutAnimationPoseData.GetRefPose();
	const TArrayView<const FBoneIndexType>LODBoneIndexes = OutAnimationPoseData.GetLODBoneIndexes();
	const TArrayView<const FBoneIndexType> SkeletoonToLODBoneIndexes = ReferencePose.GetSkeletoonToLODBoneIndexes(0); // Full list of Skeleton to LOD conversion
...
void FDecompressionTools::RetargetBoneTransform(const FAnimationReferencePose& ReferencePose
