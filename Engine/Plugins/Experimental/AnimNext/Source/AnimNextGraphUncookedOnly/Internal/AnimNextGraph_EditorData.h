...
class UAnimNextGraph_EditorData : public UObject, public IRigVMClientHost, public IRigVMGraphFunctionHost
{
	...
	ANIMNEXTGRAPHUNCOOKEDONLY_API void Initialize(bool bRecompileVM);
	...
	ANIMNEXTGRAPHUNCOOKEDONLY_API URigVMGraph* GetVMGraphForEdGraph(const UEdGraph* InGraph) const;
