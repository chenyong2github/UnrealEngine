...
UENUM()
enum class EVertexDeltaModelActivationFunction : uint8
{
	Relu,
	LRelu,
	Tanh
...
UENUM()
enum class EVertexDeltaModelLossFunction : uint8
{
	L1,
	MSE,
	Shrinkage
...
public:
	...
	EVertexDeltaModelLossFunction GetLossFunction() const { return LossFunction; }
	EVertexDeltaModelActivationFunction GetActivationFunction() const { return ActivationFunction; }
...
public:
	...
	EVertexDeltaModelActivationFunction ActivationFunction = EVertexDeltaModelActivationFunction::LRelu;

	/** The loss function to use during model training. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, AdvancedDisplay, Category = "Training Settings")
	EVertexDeltaModelLossFunction LossFunction = EVertexDeltaModelLossFunction::L1;
