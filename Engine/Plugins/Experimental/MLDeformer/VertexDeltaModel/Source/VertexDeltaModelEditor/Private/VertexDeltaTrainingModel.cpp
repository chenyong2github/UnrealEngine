...
void UVertexDeltaTrainingModel::UpdateVertexDeltaMeanAndScale(const TArray<float>& VertexDeltas, FVector& InOutMeanVertexDelta, FVector& InOutVertexDeltaScale, float& InOutCount)
{
...
bool UVertexDeltaTrainingModel::ComputeVertexDeltaStatistics(uint32 LODIndex)
{
	using namespace UE::VertexDeltaModel;

	FVertexDeltaEditorModel* VertexDeltaEditorModel = GetVertexDeltaEditorModel();
	UVertexDeltaModel* VertexDeltaModel = VertexDeltaEditorModel->GetVertexDeltaModel();
...
bool UVertexDeltaTrainingModel::ComputeDeltasStatistics()
{
	const UVertexDeltaModel* VertexDeltaModel = GetVertexDeltaModel();
