...
#define IMPLEMENT_VERTEX_FACTORY_TYPE_EX_TEMP(FactoryClass,ShaderFilename,bUsedWithMaterials,bSupportsStaticLighting,bSupportsDynamicLighting,bPrecisePrevWorldPos,bSupportsPositionOnly,bSupportsCachingMeshDrawCommands,bSupportsPrimitiveIdStream,bSupportsNaniteRendering) \
...
IMPLEMENT_VERTEX_FACTORY_TYPE_EX_TEMP(TWaterVertexFactory</*bWithWaterSelectionSupport = */ false>, "/Plugin/Water/Private/WaterMeshVertexFactory.ush", true, false, true, true, false, false, true, false);
...
IMPLEMENT_VERTEX_FACTORY_TYPE_EX_TEMP(TWaterVertexFactory</*bWithWaterSelectionSupport = */ true>, "/Plugin/Water/Private/WaterMeshVertexFactory.ush", true, false, true, true, false, false, true, false);
