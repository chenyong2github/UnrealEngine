...
/**
 * This class provides an example of how to connect an FEdMode to the 
 * InteractiveTools framework. The various FEdMode input event handlers 
 ...
 * The functions here are basically just forwarders.
 */
class FSampleToolsEditorMode : public FEdMode
{
public:
	const static FEditorModeID EM_SampleToolsEditorModeId;
public:
	FSampleToolsEditorMode();
	virtual ~FSampleToolsEditorMode();
...
protected:
	...
	/**
	 * This is the ToolsContext adapter that attaches to the FEdMode. 
	 * We forward FEdMode event handler functions to this implementation.
	 * This UObject is explicitly kept alive by adding it to the Collector in ::AddReferencedObjects()
	 */
