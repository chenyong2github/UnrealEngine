...
public:
	FChaosFleshEditorStyle() : FSlateStyleSet("ChaosFleshEditorStyle")
	{
		...
		Set("ClassIcon.FleshAsset", new FSlateVectorImageBrush(RootToContentDir(TEXT("FleshAsset_16.svg")), Icon16x16));
		Set("ClassThumbnail.FleshAsset", new FSlateVectorImageBrush(RootToContentDir(TEXT("FleshAsset_64.svg")), Icon64x64));
