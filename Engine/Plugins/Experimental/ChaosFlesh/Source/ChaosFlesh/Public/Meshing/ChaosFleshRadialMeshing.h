...
void CHAOSFLESH_API ComputeHexMeshFaces(const TArray<int32>& HexElements, TArray<FUintVector2>& CommonFaces);

template <typename Func1, typename Func2, typename Func3>
void CHAOSFLESH_API ComputeMeshFaces(const TArray<int32>& mesh, Func1 GreaterThan, Func2 Equal, TArray<FUintVector2>& CommonFaces, Func3 GenerateFace, int32 PointsPerFace);
