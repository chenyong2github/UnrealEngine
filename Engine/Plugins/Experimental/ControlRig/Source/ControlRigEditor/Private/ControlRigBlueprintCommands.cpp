...
void FControlRigBlueprintCommands::RegisterCommands()
{
	...
	UI_COMMAND(StoreNodeSnippet1, "Store Node Snippet 1", "Stores the selected node(s) into snippet 1", EUserInterfaceActionType::Button, FInputChord(EKeys::One, EModifierKey::Alt));
	UI_COMMAND(StoreNodeSnippet2, "Store Node Snippet 2", "Stores the selected node(s) into snippet 2", EUserInterfaceActionType::Button, FInputChord(EKeys::Two, EModifierKey::Alt));
	UI_COMMAND(StoreNodeSnippet3, "Store Node Snippet 3", "Stores the selected node(s) into snippet 3", EUserInterfaceActionType::Button, FInputChord(EKeys::Three, EModifierKey::Alt));
	UI_COMMAND(StoreNodeSnippet4, "Store Node Snippet 4", "Stores the selected node(s) into snippet 4", EUserInterfaceActionType::Button, FInputChord(EKeys::Four, EModifierKey::Alt));
	UI_COMMAND(StoreNodeSnippet5, "Store Node Snippet 5", "Stores the selected node(s) into snippet 5", EUserInterfaceActionType::Button, FInputChord(EKeys::Five, EModifierKey::Alt));
	UI_COMMAND(StoreNodeSnippet6, "Store Node Snippet 6", "Stores the selected node(s) into snippet 6", EUserInterfaceActionType::Button, FInputChord(EKeys::Six, EModifierKey::Alt));
	UI_COMMAND(StoreNodeSnippet7, "Store Node Snippet 7", "Stores the selected node(s) into snippet 7", EUserInterfaceActionType::Button, FInputChord(EKeys::Seven, EModifierKey::Alt));
	UI_COMMAND(StoreNodeSnippet8, "Store Node Snippet 8", "Stores the selected node(s) into snippet 8", EUserInterfaceActionType::Button, FInputChord(EKeys::Eight, EModifierKey::Alt));
	UI_COMMAND(StoreNodeSnippet9, "Store Node Snippet 9", "Stores the selected node(s) into snippet 9", EUserInterfaceActionType::Button, FInputChord(EKeys::Nine, EModifierKey::Alt));
	UI_COMMAND(StoreNodeSnippet0, "Store Node Snippet 0", "Stores the selected node(s) into snippet 0", EUserInterfaceActionType::Button, FInputChord(EKeys::Zero, EModifierKey::Alt));
}
