...
void SGraphPinBoneNameValueWidget::Construct(const FArguments& InArgs)
{
	...
	TSharedRef<SWidget> ComboBoxMenuContent =
		...
		[
			...
			[
				...
				.OnTextChanged(this, &SGraphPinBoneNameValueWidget::OnSearchTextChanged)
			]
			...
			[
				...
				.OnGenerateRow(this, &SGraphPinBoneNameValueWidget::GenerateMenuItemRow)
				.OnSelectionChanged(this, &SGraphPinBoneNameValueWidget::OnSelectionChanged_Internal)
	...
	if (InArgs._Content.Widget == SNullWidget::NullWidget)
	{
		SAssignNew(ButtonContent, STextBlock)
			.Text(NSLOCTEXT("SGraphPinBoneNameValueWidget", "ContentWarning", "No Content Provided"))
	...
	SComboButton::Construct(SComboButton::FArguments()
		...
		.OnMenuOpenChanged(this, &SGraphPinBoneNameValueWidget::OnMenuOpenChanged)
		.IsFocusable(true)
		);
...
void SGraphPinBoneNameValueWidget::ClearSelection()
{
	ComboListView->ClearSelection();
}

void SGraphPinBoneNameValueWidget::SetSelectedItem(TSharedPtr<FString> InSelectedItem)
{
...
TSharedPtr<FString> SGraphPinBoneNameValueWidget::GetSelectedItem()
{
	return SelectedItem;
}

void SGraphPinBoneNameValueWidget::RefreshOptions()
{
...
TSharedRef<ITableRow> SGraphPinBoneNameValueWidget::GenerateMenuItemRow(TSharedPtr<FString> InItem, const TSharedRef<STableViewBase>& OwnerTable)
{
...
void SGraphPinBoneNameValueWidget::OnMenuOpenChanged(bool bOpen)
{
	if (bOpen == false)
	{
		if (TListTypeTraits<TSharedPtr<FString>>::IsPtrValid(SelectedItem))
...
void SGraphPinBoneNameValueWidget::OnSearchTextChanged(const FText& ChangedText)
{
...
FReply SGraphPinBoneNameValueWidget::OnButtonClicked()
{
