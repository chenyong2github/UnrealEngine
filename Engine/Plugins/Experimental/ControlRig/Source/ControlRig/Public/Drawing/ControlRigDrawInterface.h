...
public:
	...
	void DrawLines(const FTransform& WorldOffset, const FRigVMFixedArray<FVector>& Positions, const FLinearColor& Color, float Thickness = 0.f);
	void DrawLineStrip(const FTransform& WorldOffset, const FRigVMFixedArray<FVector>& Positions, const FLinearColor& Color, float Thickness = 0.f);
	...
	void DrawAxes(const FTransform& WorldOffset, const FRigVMFixedArray<FTransform>& Transforms, float Size, float Thickness = 0.f);
	...
	void DrawHierarchy(const FTransform& WorldOffset, URigHierarchy* Hierarchy, EControlRigDrawHierarchyMode::Type Mode, float Scale, const FLinearColor& Color, float Thickness);
