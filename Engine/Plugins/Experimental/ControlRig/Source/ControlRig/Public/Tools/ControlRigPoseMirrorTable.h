...
public:
	...
	void GetMirrorTransform(const FRigControlCopy& ControlCopy,  bool bIsMatched,FVector& OutGlobalTranslation, FQuat& OutGlobalRotation, FQuat& OutLocalRotation) const;
