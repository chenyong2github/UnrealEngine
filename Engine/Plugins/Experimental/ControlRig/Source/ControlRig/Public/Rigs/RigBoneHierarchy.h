...
private:
	...
	FRigHierarchyElementAdded OnBoneAdded;
	FRigHierarchyElementRemoved OnBoneRemoved;
	FRigHierarchyElementRenamed OnBoneRenamed;
	FRigHierarchyElementReparented OnBoneReparented;
#endif
