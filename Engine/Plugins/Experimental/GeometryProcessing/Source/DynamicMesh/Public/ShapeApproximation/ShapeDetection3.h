...
namespace UE
{
	namespace Geometry
	{
		 ...
		 */
		bool IsSphereMesh(const FDynamicMesh3& Mesh, FSphere3d& SphereOut, double RelativeDeviationTol = 0.025 )
		{
		 ...
		 */
		bool IsBoxMesh(const FDynamicMesh3& Mesh, FOrientedBox3d& BoxOut, double AngleToleranceDeg = 0.1)
		{
		 ...
		 */
		bool IsCapsuleMesh(const FDynamicMesh3& Mesh, FCapsule3d& CapsuleOut, double RelativeDeviationTol = 0.025)
		{
