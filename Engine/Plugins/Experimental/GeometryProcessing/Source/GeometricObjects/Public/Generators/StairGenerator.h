 ...
 */
class GEOMETRICOBJECTS_API FFloatingStairGenerator : public FLinearStairGenerator
{
public:
 ...
 * Generate an oriented Curved Stair mesh.
 */
class GEOMETRICOBJECTS_API FSpiralStairGenerator : public FCurvedStairGenerator
{
public:
