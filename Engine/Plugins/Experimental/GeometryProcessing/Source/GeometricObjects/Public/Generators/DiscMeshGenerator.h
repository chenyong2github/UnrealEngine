 ...
 */
class GEOMETRICOBJECTS_API FDiscMeshGenerator : public FMeshShapeGenerator
{
public:
	/** Radius */
	float Radius;
...
*/
class GEOMETRICOBJECTS_API FPuncturedDiscMeshGenerator : public FDiscMeshGenerator
{
public:
	/** Hole Radius */
	float HoleRadius;
