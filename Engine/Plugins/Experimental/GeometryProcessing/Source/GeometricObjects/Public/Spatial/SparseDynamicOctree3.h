...
public:
	TBitArray<> BitArray;
	uint32 MaxIndex = 0;
	GEOMETRICOBJECTS_API static constexpr int32 GrowChunkSize = 0xFFF;
...
{
	GEOMETRICOBJECTS_API static constexpr uint32 InvalidID = TNumericLimits<uint32>::Max();;
	GEOMETRICOBJECTS_API static constexpr uint8 InvalidLevel = TNumericLimits<uint8>::Max();
 ...
 * 
 */
class GEOMETRICOBJECTS_API FSparseDynamicOctree3
{
