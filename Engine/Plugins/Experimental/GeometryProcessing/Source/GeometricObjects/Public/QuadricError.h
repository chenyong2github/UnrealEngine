...
struct TQuadricError 
{
	...
	*/
	...
	bool SolveAxEqualsb(FVector3<RealType>& OutResult, const RealType bvecx, const RealType bvecy, const RealType bvecz, const RealType minThresh = 1000.0*TMathUtil<RealType>::Epsilon) const 
	{
	...
	static FVector3<RealType> MultiplySymmetricMatrix(const RealType SM[6], const FVector3<RealType>& vec)
	{
