...
struct TMatrix3
{
	 ...
	 */
	TMatrix3<RealType>(const FVector3<RealType>& U, const FVector3<RealType>& V)
	...
	TMatrix3(const FVector3<RealType>& V1, const FVector3<RealType>& V2, const FVector3<RealType>& V3, bool bRows)
	{
		if (bRows)
		{
			Row0 = V1;
	...
	static TMatrix3<RealType> AxisAngleR(const FVector3<RealType>& Axis, RealType AngleRad)
	{
	...
	static TMatrix3<RealType> AxisAngleD(const FVector3<RealType>& Axis, RealType AngleDeg)
	{
