...
namespace UE
{
	namespace Geometry
	{
		template bool GEOMETRICOBJECTS_API IsInside(const TSphere3<float>& OuterSphere, const TSphere3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TSphere3<double>& OuterSphere, const TSphere3<double>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TSphere3<float>& OuterSphere, const TCapsule3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TSphere3<double>& OuterSphere, const TCapsule3<double>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TSphere3<float>& OuterSphere, const TOrientedBox3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TSphere3<double>& OuterSphere, const TOrientedBox3<double>& InnerSphere);

		template bool GEOMETRICOBJECTS_API IsInside(const TCapsule3<float>& OuterSphere, const TCapsule3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TCapsule3<double>& OuterSphere, const TCapsule3<double>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TCapsule3<float>& OuterSphere, const TSphere3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TCapsule3<double>& OuterSphere, const TSphere3<double>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TCapsule3<float>& OuterSphere, const TOrientedBox3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TCapsule3<double>& OuterSphere, const TOrientedBox3<double>& InnerSphere);

		template bool GEOMETRICOBJECTS_API IsInside(const TOrientedBox3<float>& OuterSphere, const TOrientedBox3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TOrientedBox3<double>& OuterSphere, const TOrientedBox3<double>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TOrientedBox3<float>& OuterSphere, const TSphere3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TOrientedBox3<double>& OuterSphere, const TSphere3<double>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TOrientedBox3<float>& OuterSphere, const TCapsule3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API IsInside(const TOrientedBox3<double>& OuterSphere, const TCapsule3<double>& InnerSphere);
	}
}
