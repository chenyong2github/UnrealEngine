...
namespace UE
{
	namespace Geometry
	{
		template bool GEOMETRICOBJECTS_API TestIntersection(const THalfspace3<float>& Halfspace, const TSphere3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API TestIntersection(const THalfspace3<double>& Halfspace, const TSphere3<double>& InnerSphere);
		template bool GEOMETRICOBJECTS_API TestIntersection(const THalfspace3<float>& Halfspace, const TCapsule3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API TestIntersection(const THalfspace3<double>& Halfspace, const TCapsule3<double>& InnerSphere);
		template bool GEOMETRICOBJECTS_API TestIntersection(const THalfspace3<float>& Halfspace, const TOrientedBox3<float>& InnerSphere);
		template bool GEOMETRICOBJECTS_API TestIntersection(const THalfspace3<double>& Halfspace, const TOrientedBox3<double>& InnerSphere);
	}
}
