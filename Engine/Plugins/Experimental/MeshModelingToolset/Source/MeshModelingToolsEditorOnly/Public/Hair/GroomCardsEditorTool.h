...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API UEditGroomCardsToolActionPropertySet : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API USelectGroomCardsToolActions : public UEditGroomCardsToolActionPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API UEditGroomCardsToolActions : public UEditGroomCardsToolActionPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API UGroomCardsInfoToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API UGroomCardsEditorTool : public UMeshSurfacePointTool, public IClickBehaviorTarget
{
	GENERATED_BODY()
...
class MESHMODELINGTOOLSEDITORONLY_API FEditGroomCardsTopologyPreEditChange : public FToolCommandChange
{
public:
...
class MESHMODELINGTOOLSEDITORONLY_API FEditGroomCardsTopologyPostEditChange : public FToolCommandChange
{
public:
	virtual void Apply(UObject* Object) override;
	virtual void Revert(UObject* Object) override;
...
class MESHMODELINGTOOLSEDITORONLY_API FBeginGroomCardsEditChange : public FToolCommandChange
{
public:
	int32 CardGroupID = -1;
...
class MESHMODELINGTOOLSEDITORONLY_API FEndGroomCardsEditChange : public FToolCommandChange
{
public:
