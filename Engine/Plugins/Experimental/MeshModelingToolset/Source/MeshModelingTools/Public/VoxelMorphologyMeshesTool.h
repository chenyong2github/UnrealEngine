...
public:
	...
	// not exposed as an option because the SDF method will give bad results for self intersecting batches of meshes
	// but left here for now; TODO: decide to re-enable if we add a solidify pass, or just delete
