...
UCLASS()
class MESHMODELINGTOOLS_API UOffsetMeshToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
UCLASS()
class MESHMODELINGTOOLS_API UOffsetWeightMapSetProperties : public UWeightMapSetProperties
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLS_API UIterativeOffsetProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLS_API UImplicitOffsetProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UOffsetMeshTool : public UBaseMeshProcessingTool
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UOffsetMeshToolBuilder : public UBaseMeshProcessingToolBuilder
{
	GENERATED_BODY()
public:
