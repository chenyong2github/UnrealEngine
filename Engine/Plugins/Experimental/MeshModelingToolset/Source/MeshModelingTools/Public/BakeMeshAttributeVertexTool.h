 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UBakeMeshAttributeVertexToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
UCLASS()
class MESHMODELINGTOOLS_API UBakeMeshAttributeVertexToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
UCLASS()
class MESHMODELINGTOOLS_API UBakeMeshAttributeVertexToolColorProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
UCLASS()
class MESHMODELINGTOOLS_API UBakeMeshAttributeVertexToolChannelProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MESHMODELINGTOOLS_API UBakeMeshAttributeVertexTool : public UMultiSelectionTool, public UE::Geometry::IGenericDataOperatorFactory<UE::Geometry::FMeshVertexBaker>
{
	GENERATED_BODY()
