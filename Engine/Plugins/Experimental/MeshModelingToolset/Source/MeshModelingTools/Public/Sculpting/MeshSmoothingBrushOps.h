...
UCLASS()
class MESHMODELINGTOOLS_API UBaseSmoothBrushOpProps : public UMeshSculptBrushOpProps
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLS_API USmoothBrushOpProps : public UBaseSmoothBrushOpProps
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLS_API USecondarySmoothBrushOpProps : public UBaseSmoothBrushOpProps
{
	GENERATED_BODY()
public:
	/** Strength of the Brush */
...
UCLASS()
class MESHMODELINGTOOLS_API USmoothFillBrushOpProps : public UBaseSmoothBrushOpProps
{
	GENERATED_BODY()
public:
	/** Strength of the Brush */
...
UCLASS()
class MESHMODELINGTOOLS_API UFlattenBrushOpProps : public UMeshSculptBrushOpProps
{
	GENERATED_BODY()
public:
	/** Strength of the Brush */
...
UCLASS()
class MESHMODELINGTOOLS_API UEraseBrushOpProps : public UMeshSculptBrushOpProps
{
	GENERATED_BODY()
public:
	/** Strength of the Brush */
