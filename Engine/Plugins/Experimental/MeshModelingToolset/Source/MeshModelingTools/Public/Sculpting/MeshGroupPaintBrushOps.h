...
class MESHMODELINGTOOLS_API FMeshTriangleGroupEditBrushOp : public FMeshSculptBrushOp
{
public:
...
UCLASS()
class MESHMODELINGTOOLS_API UGroupEraseBrushOpProps : public UMeshSculptBrushOpProps
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLS_API UGroupPaintBrushOpProps : public UMeshSculptBrushOpProps
{
	GENERATED_BODY()
public:
