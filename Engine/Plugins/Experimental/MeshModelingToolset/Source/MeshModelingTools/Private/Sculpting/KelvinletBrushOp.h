...
UCLASS()
class MESHMODELINGTOOLS_API UScaleKelvinletBrushOpProps : public   UBaseKelvinletBrushOpProps
{
	GENERATED_BODY()
...
UCLASS()
class MESHMODELINGTOOLS_API UPullKelvinletBrushOpProps : public UBaseKelvinletBrushOpProps
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLS_API USharpPullKelvinletBrushOpProps : public UBaseKelvinletBrushOpProps
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLS_API UTwistKelvinletBrushOpProps : public  UBaseKelvinletBrushOpProps
{
	GENERATED_BODY()
