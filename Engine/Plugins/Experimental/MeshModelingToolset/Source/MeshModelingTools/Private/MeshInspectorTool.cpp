...
void UMeshInspectorTool::Setup()
{
	...
	InputMeshDescription = MakeShared<FMeshDescription>(*Cast<IMeshDescriptionProvider>(Target)->GetMeshDescription());
	...
	MeshAnalysis->Update(*PreviewMesh->GetPreviewDynamicMesh(), TargetComponent->GetWorldTransform());
