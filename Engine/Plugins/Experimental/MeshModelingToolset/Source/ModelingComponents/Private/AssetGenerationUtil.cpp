...
FString AssetGenerationUtil::GetComponentAssetBaseName( UPrimitiveComponent* Component)
{
	...
	FString ResultName = AssetGenerationUtil::StripGeneratedAssetSuffixFromName(Component->GetName());
	...
	if (StaticMeshComponent != nullptr)
	{
		...
		if (SourceMesh)
		{
			...
			ResultName = AssetGenerationUtil::StripGeneratedAssetSuffixFromName(AssetName);
		}
	}
