...
#include "OptimusDataInterfaceSkeletalMeshRead.generated.h"
...
class OPTIMUSCORE_API UOptimusSkeletalMeshReadDataInterface : public UOptimusComputeDataInterface
{
	GENERATED_BODY()
...
class UOptimusSkeletalMeshReadDataProvider : public UComputeDataProvider
{
	GENERATED_BODY()
...
class FOptimusSkeletalMeshReadDataProviderProxy : public FComputeDataProviderRenderProxy
{
public:
	FOptimusSkeletalMeshReadDataProviderProxy(USkeletalMeshComponent* SkeletalMeshComponent);
