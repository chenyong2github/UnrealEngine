...
TSharedRef<FOptimusHLSLSyntaxHighlighter> FOptimusHLSLSyntaxHighlighter::Create(
	...
	)
{
	...
	return MakeShareable(new FOptimusHLSLSyntaxHighlighter(FSyntaxTokenizer::Create(TokenizerRules), InSyntaxTextStyle));
}
...
void FOptimusHLSLSyntaxHighlighter::ParseTokens(
