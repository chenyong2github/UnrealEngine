...
public:
	...
	SLATE_BEGIN_ARGS(SRadialSlider)
		...
		SLATE_ARGUMENT(UCurveFloat*, ValueRemapCurve)
	...
	/** Get the ValueRemapCurve attribute */
	UCurveFloat* GetValueRemapCurve() const { return ValueRemapCurve; }
	...
	/** Set the ValueRemapCurve attribute */
	void SetValueRemapCurve(UCurveFloat* InValueRemapCurve) { ValueRemapCurve = InValueRemapCurve; }
