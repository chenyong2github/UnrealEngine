...
class FVirtualCameraPixelStreamingPresetEditorModule : public IModuleInterface
{
public:
	...
	void RegisterPlacementModeItems()
	{
			...
			; Info && GEditor)
		{
			FAssetData VirtualCamera2ActorAssetData(
				TEXT("/VCamPixelStreamingPreset/VCamActor"),
				TEXT("/VCamPixelStreamingPreset"),
				TEXT("VCamActor"),
			...
			const UClass* VCamActorBlueprintClass = LoadClass<UObject>(nullptr, TEXT("/VCamPixelStreamingPreset/VCamActor.VCamActor_C"));
			UE_CLOG(VCamActorBlueprintClass == nullptr, LogVirtualCameraPixelStreamingPresetEditor, Warning, TEXT("Failed to load '/VCamPixelStreamingPreset/VCamActor.VCamActor_C'. Has the Blueprint been moved?"));
		}
	}
...
IMPLEMENT_MODULE(FVirtualCameraPixelStreamingPresetEditorModule, VCamPixelStreamingPresetEditor)
