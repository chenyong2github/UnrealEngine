...
UCLASS()
class MESHMODELINGTOOLSEXP_API UNewMeshMaterialProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLSEXP_API UExistingMeshMaterialProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLSEXP_API UMeshEditingViewProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
