...
bool UInterchangeRectLightFactoryNode::GetCustomBarnDoorAngle(float& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(BarnDoorAngle, float)
}

bool UInterchangeRectLightFactoryNode::SetCustomBarnDoorAngle(float AttributeValue, bool bAddApplyDelegate)
{
	IMPLEMENT_NODE_ATTRIBUTE_SETTER(UInterchangeRectLightFactoryNode, BarnDoorAngle, float, URectLightComponent)
}

bool UInterchangeRectLightFactoryNode::GetCustomBarnDoorLength(float& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(BarnDoorLength, float)
}

bool UInterchangeRectLightFactoryNode::SetCustomBarnDoorLength(float AttributeValue, bool bAddApplyDelegate)
{
	IMPLEMENT_NODE_ATTRIBUTE_SETTER(UInterchangeRectLightFactoryNode, BarnDoorLength, float, URectLightComponent)
}
*/