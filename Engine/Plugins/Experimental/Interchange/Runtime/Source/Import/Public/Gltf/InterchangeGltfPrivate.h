...
namespace UE::Interchange
{
	...
	namespace Gltf::Private
	{
		...
		int32 GetRootNodeIndex(const TMap<int32, int32>& CurrentToParentNodeIdxMap, const TArray<int32>& NodeIndices);

		bool GetSkeletalMeshDescriptionForPayLoadKey(const GLTF::FAsset& GltfAsset, const TMap<int32, int32>& CurrentToParentNodeIdxMap,
