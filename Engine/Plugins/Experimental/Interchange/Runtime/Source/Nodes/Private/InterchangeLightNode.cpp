...
bool UInterchangeLightNode::GetCustomIntensityUnits(ELightUnits& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(IntensityUnits, ELightUnits)
}

bool UInterchangeLightNode::SetCustomIntensityUnits(ELightUnits AttributeValue)
{
	IMPLEMENT_NODE_ATTRIBUTE_SETTER_NODELEGATE(IntensityUnits, ELightUnits)
}
...
bool UInterchangeRectLightNode::GetCustomBarnDoorAngle(float& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(BarnDoorAngle, float)
}

bool UInterchangeRectLightNode::SetCustomBarnDoorAngle(float AttributeValue)
{
	IMPLEMENT_NODE_ATTRIBUTE_SETTER_NODELEGATE(BarnDoorAngle, float)
}

bool UInterchangeRectLightNode::GetCustomBarnDoorLength(float& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(BarnDoorLength, float)
}

bool UInterchangeRectLightNode::SetCustomBarnDoorLength(float AttributeValue)
{
	IMPLEMENT_NODE_ATTRIBUTE_SETTER_NODELEGATE(BarnDoorLength, float)
}
*/
