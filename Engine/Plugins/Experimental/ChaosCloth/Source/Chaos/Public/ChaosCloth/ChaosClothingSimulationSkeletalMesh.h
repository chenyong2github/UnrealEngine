...
PRAGMA_DISABLE_DEPRECATION_WARNINGS  // TODO: CHAOS_IS_CLOTHINGSIMULATIONMESH_ABSTRACT
		virtual const USkeletalMeshComponent* GetSkeletalMeshComponent() const override { return Cast<USkeletalMeshComponent>(GetSkinnedMeshComponent()); }
PRAGMA_ENABLE_DEPRECATION_WARNINGS
#else
		...
		virtual const TArray<FMeshToMeshVertData>& GetTransitionUpSkinData(int32 LODIndex) const override;
		virtual const TArray<FMeshToMeshVertData>& GetTransitionDownSkinData(int32 LODIndex) const override;
