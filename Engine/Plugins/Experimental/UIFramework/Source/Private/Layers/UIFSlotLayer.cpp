	...
	InUIWidget->LocalCreateWidgetAsync([WeakSelf, WeakUIWidget, InSlotName]()
		{
			...
			{
				if (TObjectPtr<UUIFWidget>* FoundWidget = StrongSelf->LocalSlotContents.Find(InSlotName))
				{
...
void UUIFSlotLayer::LocalRemoveWidget(UUIFWidget* InUIWidget, FName InSlotName)
{
	...
	if (TObjectPtr<UUIFWidget>* FoundWidget = LocalSlotContents.Find(InSlotName))
	{
