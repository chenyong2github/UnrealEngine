	...
	void RegisterPlacementModeItems()
	{
			...
			; Info && GEditor)
		{
			FAssetData VirtualCamera2ActorAssetData(
				TEXT("/VirtualCameraPixelStreamingPreset/VCamActor"),
				TEXT("/VirtualCameraPixelStreamingPreset"),
				TEXT("VCamActor"),
			...
			const UClass* VCamActorBlueprintClass = LoadClass<UObject>(nullptr, TEXT("/VirtualCameraPixelStreamingPreset/VCamActor.VCamActor_C"));
			UE_CLOG(VCamActorBlueprintClass == nullptr, LogVirtualCameraPixelStreamingPresetEditor, Warning, TEXT("Failed to load '/VirtualCameraPixelStreamingPreset/VCamActor.VCamActor_C'. Has the Blueprint been moved?"));
		}
	}
...
IMPLEMENT_MODULE(FVirtualCameraPixelStreamingPresetEditorModule, VirtualCameraPixelStreamingPresetEditor)
