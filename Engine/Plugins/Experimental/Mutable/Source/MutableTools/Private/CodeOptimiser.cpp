...
//-------------------------------------------------------------------------------------------------
void mu::DuplicatedDataRemoverAST( ASTOpList& roots )
{
...
void mu::DuplicatedCodeRemoverAST( ASTOpList& roots )
{
...
//---------------------------------------------------------------------------------------------
bool mu::ConstantGeneratorAST( const CompilerOptions::Private* options, Ptr<ASTOp>& root,
