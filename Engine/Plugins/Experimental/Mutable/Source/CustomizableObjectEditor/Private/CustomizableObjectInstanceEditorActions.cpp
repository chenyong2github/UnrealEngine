...
void FCustomizableObjectInstanceEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND( BakeInstance, "Bake Instance from Instance", "Create baked unreal resources for the current instance.", EUserInterfaceActionType::Button, FInputChord());
