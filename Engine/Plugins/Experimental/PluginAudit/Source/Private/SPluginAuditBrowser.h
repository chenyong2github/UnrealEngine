...
private:
	...
	enum class EDoesPluginDependGameplayTagSource
	{
		Yes,
		No,
		UnknownTag
	...
	static EDoesPluginDependGameplayTagSource DoesPluginDependOnGameplayTagSource(const UGameplayTagsManager& Manager, const TSharedPtr<IPlugin>& DependentPlugin, FName TagName, TArray<TSharedPtr<IPlugin>>& OutPossibleSources);
