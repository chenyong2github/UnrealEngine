...
public:
	...
	/** Enum to be used for vector targets */
	static UEnum* FieldVectorTargetEnum;

	/** Enum to be used for scalar targets */
	static UEnum* FieldScalarTargetEnum;

	/** Enum to be used for integer targets */
	static UEnum* FieldIntegerTargetEnum;
