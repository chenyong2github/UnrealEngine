...
namespace DmlUtil
{
	...
	inline bool IsSameShape(const NNECore::Internal::FTensor& Left, const NNECore::Internal::FTensor& Right)
	{
	...
	inline uint64 CalculateBufferSize(const FTensorDesc& DmlTensor, const NNECore::Internal::FTensor& Desc)
	{
...
public:
	...
	virtual bool Initialize(FDeviceContextDml* DevCtx, TArrayView<const NNECore::Internal::FTensor> InputTensors, TArrayView<const NNECore::Internal::FTensor> OutputTensors, const NNECore::FAttributeMap& Attributes) = 0;
...
class FOperatorDmlConv : public FOperatorDml
{
	...
	{
		if (StringVal.Compare(TEXT("NOTSET")) == 0) 
		{
			return EAutoPad::NOTSET;
		}
		else if (StringVal.Compare(TEXT("SAME_UPPER")) == 0)
		{
			return EAutoPad::SAME_UPPER;
		}
		else if (StringVal.Compare(TEXT("SAME_LOWER")) == 0)
		{
			return EAutoPad::SAME_LOWER;
		}
		else if (StringVal.Compare(TEXT("VALID")) == 0)
		{
