...
void FGroomEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(ViewMode_Guide,			"Guide",			"View guide",					EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(ViewMode_GuideInfluence, "GuideInfluence",	"View guide influence",			EUserInterfaceActionType::Button, FInputChord());
