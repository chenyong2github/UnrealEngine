...
bool UE::RenderPages::Private::FRenderPagesUtils::IsImage(const FString& ImagePath)
{
...
UTexture2D* UE::RenderPages::Private::FRenderPagesUtils::GetImage(const FString& ImagePath, UTexture2D* Texture2D, bool& bOutReusedGivenTexture2D)
{
	static IImageWrapperModule* ImageWrapperModule = FModuleManager::LoadModulePtr<IImageWrapperModule>("ImageWrapper");
	if (ImageWrapperModule == nullptr)
	{
...
UTexture2D* UE::RenderPages::Private::FRenderPagesUtils::BytesToImage(const TArray<uint8>& ByteArray, const EImageFormat ImageFormat)
{
	static IImageWrapperModule* ImageWrapperModule = FModuleManager::LoadModulePtr<IImageWrapperModule>("ImageWrapper");
	if (ImageWrapperModule == nullptr)
	{
...
UTexture2D* UE::RenderPages::Private::FRenderPagesUtils::BytesToExistingImage(const TArray<uint8>& ByteArray, const EImageFormat ImageFormat, UTexture2D* Texture2D, bool& bOutReusedGivenTexture2D)
{
	static IImageWrapperModule* ImageWrapperModule = FModuleManager::LoadModulePtr<IImageWrapperModule>("ImageWrapper");
	if (ImageWrapperModule == nullptr)
	{
...
UTexture2D* UE::RenderPages::Private::FRenderPagesUtils::DataToTexture2D(int32 Width, int32 Height, const void* Src, SIZE_T Count)
{
...
UTexture2D* UE::RenderPages::Private::FRenderPagesUtils::DataToExistingTexture2D(int32 Width, int32 Height, const void* Src, SIZE_T Count, UTexture2D* Texture2D, bool& bOutReusedGivenTexture2D)
{
...
TArray<FString> UE::RenderPages::Private::FRenderPagesUtils::GetFiles(const FString& Directory, const bool bRecursive)
{
	class FRenderPagesUtilsGetFilesVisitor : public IPlatformFile::FDirectoryVisitor
	{
	public:
	...
	FRenderPagesUtilsGetFilesVisitor GetFilesVisitor;
	if (bRecursive)
	{
...
TArray<uint8> UE::RenderPages::Private::FRenderPagesUtils::GetFileData(const FString& File)
{
	TArray<uint8> Data;
...
void UE::RenderPages::Private::FRenderPagesUtils::DeleteDirectory(const FString& Directory)
{
	IFileManager::Get().DeleteDirectory(*Directory, false, true);
}

void UE::RenderPages::Private::FRenderPagesUtils::EmptyDirectory(const FString& Directory)
{
	class FRenderPagesUtilsEmptyDirectoryVisitor : public IPlatformFile::FDirectoryVisitor
	{
	public:
		virtual bool Visit(const TCHAR* FileName, const bool bIsDirectory) override
		{
	...
	FRenderPagesUtilsEmptyDirectoryVisitor GetFilesVisitor;
	FPlatformFileManager::Get().GetPlatformFile().IterateDirectoryRecursively(*Directory, GetFilesVisitor);
}


FString UE::RenderPages::Private::FRenderPagesUtils::NormalizeOutputDirectory(const FString& OutputDirectory)
{
