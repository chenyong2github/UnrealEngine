...
public:
	...
	void SetIsCustomStartFrame(bool bNewOverrideStartFrame) { bOverrideStartFrame = bNewOverrideStartFrame; }
	...
	void SetIsCustomEndFrame(bool bNewOverrideEndFrame) { bOverrideEndFrame = bNewOverrideEndFrame; }
	...
	void SetIsCustomResolution(bool bNewOverrideResolution) { bOverrideResolution = bNewOverrideResolution; }
