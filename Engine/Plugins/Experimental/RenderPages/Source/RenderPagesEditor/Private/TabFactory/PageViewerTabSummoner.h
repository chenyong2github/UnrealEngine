...
{
	/**
	 * The page viewer tab factory.
	 */
	struct FPageViewerTabSummoner : FWorkflowTabFactory
	{
	public:
	...
	public:
		FPageViewerTabSummoner(TSharedPtr<IRenderPageCollectionEditor> InBlueprintEditor);
