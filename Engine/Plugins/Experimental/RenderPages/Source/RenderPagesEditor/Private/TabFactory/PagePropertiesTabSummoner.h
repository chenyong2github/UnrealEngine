...
{
	/**
	 * The page properties tab factory.
	 */
	struct FPagePropertiesTabSummoner : FWorkflowTabFactory
	{
	public:
	...
	public:
		FPagePropertiesTabSummoner(TSharedPtr<IRenderPageCollectionEditor> InBlueprintEditor);
