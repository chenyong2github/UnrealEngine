...
{
	/**
	 * The remote control entity widget, copied over from the remote control plugin, and slightly modified and cleaned up for usage in the render pages plugin.
	 *
	 * @Note if you inherit from this struct, you must call SRenderPagesExposedEntity::Initialize.
	 */
	struct SRenderPagesRemoteControlEntity : SRenderPagesRemoteControlTreeNode
	{
