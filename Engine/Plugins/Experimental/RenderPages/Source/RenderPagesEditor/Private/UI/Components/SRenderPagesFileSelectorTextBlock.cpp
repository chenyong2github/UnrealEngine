...
#define LOCTEXT_NAMESPACE "SRenderPagesFileSelectorTextBlock"


BEGIN_SLATE_FUNCTION_BUILD_OPTIMIZATION

void UE::RenderPages::Private::SRenderPagesFileSelectorTextBlock::Construct(const FArguments& InArgs)
{
	...
	[
		...
		[
			...
			.OnClicked(this, &SRenderPagesFileSelectorTextBlock::OnOpenDirectoryDialog)
			[
				SNew(STextBlock)
...
void UE::RenderPages::Private::SRenderPagesFileSelectorTextBlock::SetText(TAttribute<FText> InText)
{
	SetText(InText.IsSet() ? InText.Get() : FText());
}

void UE::RenderPages::Private::SRenderPagesFileSelectorTextBlock::SetText(const FText& InText)
{
	Text = InText;
...
FReply UE::RenderPages::Private::SRenderPagesFileSelectorTextBlock::OnOpenDirectoryDialog()
{
