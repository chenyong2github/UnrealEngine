...
public:
	...
	FOnNameCollisionDelegate OnNameCollisionDelegate; // Same prop name and type name as UPyTestVectorDelegate::FOnNameCollisionDelegate, but different params.
};
...
public:
	...
	/** Called when a new item is selected in the combobox. */
	UPROPERTY(BlueprintAssignable, Category = "Python|Internal")
	FOnNameCollisionDelegate OnNameCollisionDelegate; // Same prop name and type name as UPyTestStructDelegate::FOnNameCollisionDelegate, but different params.
};
