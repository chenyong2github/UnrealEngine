...
extern ONNX_API const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_onnx_2fonnx_2doperators_2dml_2eproto;
ONNX_API ::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_onnx_2fonnx_2doperators_2dml_2eproto_metadata_getter(int index);
namespace onnx {
class FunctionProto;
...
class ONNX_API FunctionProto PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_onnx_2fonnx_2doperators_2dml_2eproto_metadata_getter(kIndexInFileMessages);
  }
