...
extern ONNX_API const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_onnx_2fonnx_2ddata_2eproto;
ONNX_API ::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_onnx_2fonnx_2ddata_2eproto_metadata_getter(int index);
namespace onnx {
class MapProto;
...
constexpr SequenceProto_DataType SequenceProto_DataType_DataType_MAX = SequenceProto_DataType_MAP;
...
class ONNX_API SequenceProto PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_onnx_2fonnx_2ddata_2eproto_metadata_getter(kIndexInFileMessages);
  }
