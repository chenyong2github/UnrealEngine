...
struct NNICPUExecutionProviderInfo {
  // bool create_arena{true};

  explicit NNICPUExecutionProviderInfo(bool use_arena)
      // : create_arena(use_arena)
  {}

  NNICPUExecutionProviderInfo() = default;
};
...
class NNICPUExecutionProvider : public IExecutionProvider {
 public:
  explicit NNICPUExecutionProvider(const NNICPUExecutionProviderInfo& info)
