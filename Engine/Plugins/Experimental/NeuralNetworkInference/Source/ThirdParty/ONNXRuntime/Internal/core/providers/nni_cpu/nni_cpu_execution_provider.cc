...
// std::shared_ptr<KernelRegistry> NNICPUExecutionProvider::GetKernelRegistry() const {
...
// std::unique_ptr<IDataTransfer> NNICPUExecutionProvider::GetDataTransfer() const {
