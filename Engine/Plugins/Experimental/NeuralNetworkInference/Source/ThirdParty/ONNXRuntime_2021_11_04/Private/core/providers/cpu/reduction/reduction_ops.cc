...
bool CommonFastReduceSwitch(OpKernelContext* ctx,
  ...
  fast_kind = OptimizeShapeForFastReduce(
      reduced_dims, input_axes.empty() ? axes_ : input_axes, fast_shape,
      output_shape, fast_axes, keepdims_ != 0, noop_with_empty_axes); // WITH_UE: C4800: Implicit conversion from 'int64_t' to bool. Possible information loss
