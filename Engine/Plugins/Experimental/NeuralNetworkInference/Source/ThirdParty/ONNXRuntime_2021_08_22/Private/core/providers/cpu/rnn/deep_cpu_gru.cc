...
Status DeepCpuGruOp::ComputeImpl(OpKernelContext& context) const {
  ...
  if (direction_ == Direction::kBidirectional) {
    ...
    detail::UniDirectionalGru<T> fw(alloc, seq_length, batch_size, input_size, hidden_size_,
                                    linear_before_reset_!=0, Direction::kForward, bias_1, initial_hidden_1, // WITH_UE: C4800: Implicit conversion from 'int32_t' to bool. Possible information loss
    ...
    detail::UniDirectionalGru<T> bw(alloc, seq_length, batch_size, input_size, hidden_size_,
                                    linear_before_reset_!=0, Direction::kReverse, bias_2, initial_hidden_2, // WITH_UE: C4800: Implicit conversion from 'int32_t' to bool. Possible information loss
    ...
    detail::UniDirectionalGru<T> gru_p(alloc, seq_length, batch_size, input_size, hidden_size_,
                                       linear_before_reset_!=0, direction_, bias_1, initial_hidden_1, // WITH_UE: C4800: Implicit conversion from 'int32_t' to bool. Possible information loss
                                       activation_funcs_.Entries()[0],
                                       activation_funcs_.Entries()[1],
                                       clip_, thread_pool);
