...
DEFINE_LOG_CATEGORY_STATIC(LogNeuralNetworkInferenceBackEnd, Display, All);

class FNeuralNetworkInferenceBackEndUtils
{
public:
	/**
...
bool FNeuralNetworkInferenceBackEndUtils::SizeSanityChecks(const TArray<FNeuralTensor*>& InTensorArray, const int32 InNum)
{
	return SizeSanityChecks(InTensorArray, InNum, InNum);
}

template <typename ValueType, typename ContainerType>
ValueType FNeuralNetworkInferenceBackEndUtils::Product(const ContainerType& InContainer)
{
