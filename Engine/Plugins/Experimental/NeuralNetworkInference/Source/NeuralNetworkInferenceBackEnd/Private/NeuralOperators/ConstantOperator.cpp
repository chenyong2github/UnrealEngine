	...
	: FConstantOperator(FNeuralTensor())
{
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::FConstantOperator(): \"sparse_value\" not implemented yet."));
	}
	else if (const FAttributeProto* ValueAttribute = FModelProto::FindElementInArray(TEXT("value"), InNodeProto.Attribute, /*bMustValueBeFound*/false))
	{
		if (ValueAttribute->Type == EAttributeProtoAttributeType::TENSOR)
		{
			...
			{
				UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::FConstantOperator(): SetFromTensorProto() failed."));
			}
		}
		// Sanity check
		else
		{
			UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::FConstantOperator(): Not implemented type used, ValueAttribute->Type = %d."), (int32)ValueAttribute->Type);
		}
	}
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::FConstantOperator(): \"value\" not implemented yet."));
	}
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::FConstantOperator(): \"value_floats\" not implemented yet."));
	}
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::FConstantOperator(): \"value_int\" not implemented yet."));
	}
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::FConstantOperator(): \"value_ints\" not implemented yet."));
	}
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::FConstantOperator(): \"value_string\" not implemented yet."));
	}
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::FConstantOperator(): \"value_strings\" not implemented yet."));
	}
	else
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::FConstantOperator(): No valid attributes found in NodeProto."));
	}
}
...
bool FConstantOperator::ConfigureOutputAndInternalVariablesAndSanityChecks()
{
	...
	if (InlinedTensor > -1)
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::ConfigureOutputAndInternalVariablesAndSanityChecks(): InlinedTensor must be -1, but found %d."), InlinedTensor);
		return bIsLoaded;
	}
	// Input sanity checks
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::ConfigureOutputAndInternalVariablesAndSanityChecks(): There cannot be any input tensors, but found %d."), NumberInputTensors);
		return bIsLoaded;
	}
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::ConfigureOutputAndInternalVariablesAndSanityChecks(): There must be exactly 1 output tensor, but found %d."), NumberOutputTensors);
		return bIsLoaded;
	}
	// Variable sanity check
	if (Tensor.IsEmpty())
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::ConfigureOutputAndInternalVariablesAndSanityChecks(): Tensor cannot be empty."));
		return bIsLoaded;
	}
	// Return true
	bIsLoaded = true;
...
void FConstantOperator::ForwardCPU()
{
	...
	if (!bIsLoaded)
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::ForwardCPU(): bIsLoaded was false."));
		return;
	}
...
{
	UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FConstantOperator::ForwardGPU_RenderThread(): Constant does not implement the GPU forward pass, only CPU one."));
}
