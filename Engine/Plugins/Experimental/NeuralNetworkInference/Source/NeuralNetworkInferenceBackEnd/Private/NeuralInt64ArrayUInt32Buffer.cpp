...
void FNeuralInt64ArrayUInt32Buffer::CreateAndLoadSRVBuffer(const TCHAR* InDebugName)
{
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FNeuralInt64ArrayUInt32Buffer::CreateAndLoadSRVBuffer(): UInt32ReadBuffer was not nullptr."));
	}
	// Create GPU memory for it
	FNeuralNetworkInferenceBackEndUtilsGPU::CreateAndLoadSRVBuffer(UInt32ReadBuffer, UInt32Array, InDebugName);
}
