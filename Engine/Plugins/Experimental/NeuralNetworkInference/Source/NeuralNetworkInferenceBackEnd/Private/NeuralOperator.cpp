...
int32 FNeuralOperator::SetInputTensorsAndGetInlinedIndex(const TArray<FNeuralTensor*>& InInputTensors)
{
	...
	{
		UE_LOG(LogNeuralNetworkInferenceBackEnd, Warning, TEXT("FNeuralOperator::SetInputTensorsAndGetInlinedIndex(): EstimateInlinedTensorFromPotentialOnes() returned false."));
		InlinedTensor = -2;
	}
