...
class NEURALNETWORKINFERENCEBACKEND_API FBatchNormalizationOperator : public FNeuralOperator
{
public:
	FBatchNormalizationOperator(const bool bIsInlinedTensor, const FNodeProto& InNodeProto);
