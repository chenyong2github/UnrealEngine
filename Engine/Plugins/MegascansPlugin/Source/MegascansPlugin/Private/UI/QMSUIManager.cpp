...
void FQMSUIManagerImpl::SetupMenuItem() 
{
	...
	NewMenuExtender->AddMenuExtension("LevelEditor",
		...
		NULL,
		FMenuExtensionDelegate::CreateRaw(this, &FQMSUIManagerImpl::AddPluginMenu));
...
void FQMSUIManagerImpl::AddPluginMenu(FMenuBuilder& MenuBuilder)
{
	MenuBuilder.BeginSection("CustomMenu", TAttribute<FText>(FText::FromString("Megascans")));

	MenuBuilder.AddMenuEntry(
		LOCTEXT("OpenWindow", "Megascans"),
		LOCTEXT("ToolTip", "Open Megascans import settings"),
		FSlateIcon(),
