...
class FOptimusToolsSkelMeshEditorMode;
class IToolkitHost;
class STextBlock;
class SButton;
...
{
public:
	FOptimusToolsSkelMeshEditorModeToolkit();
	~FOptimusToolsSkelMeshEditorModeToolkit();
	...
	void GetToolPaletteNames(TArray<FName>& InPaletteName) const;
	FText GetToolPaletteDisplayName(FName PaletteName) const;
	void BuildToolPalette(FName PaletteName, class FToolBarBuilder& ToolbarBuilder);
