...
public:	
	...
	UE_DEPRECATED(4.23, "LiveLinkComponent is deprecated, use the new LiveLink library.")
	UFUNCTION(BlueprintCallable, Category = "LiveLink", meta=(DeprecatedFunction, DeprecationMessage="LiveLinkComponent is deprecated, use the new LiveLink library."))
