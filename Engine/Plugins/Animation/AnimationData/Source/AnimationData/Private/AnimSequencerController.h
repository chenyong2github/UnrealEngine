...
extern int32 GDirectControlRigMode;
...
public:
	...
	virtual const IAnimationDataModel* const GetModel() const override { return Model; }
...
private:
	...
	bool SetBoneCurveKeys(const FName& BoneName, const TArray<FTransform>& Keys, const TArray<float>& TimeValue) const;
...
private: 
	...
	UPROPERTY(transient)
	TObjectPtr<UAnimationSequencerDataModel> Model;
