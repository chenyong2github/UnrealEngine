...
void FIKRetargetCommands::RegisterCommands()
{
	...
	UI_COMMAND(ImportRetargetPose, "Import from Retarget Pose Asset", "Import a retarget pose asset.", EUserInterfaceActionType::Button, FInputChord());
	...
	UI_COMMAND(ExportRetargetPose, "Export Retarget Pose Asset", "Export current retarget pose as an asset.", EUserInterfaceActionType::Button, FInputChord());
}
