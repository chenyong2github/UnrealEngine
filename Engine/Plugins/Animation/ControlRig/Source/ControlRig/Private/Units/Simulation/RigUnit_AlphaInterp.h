 ...
 */
USTRUCT(meta=(DisplayName="Alpha Interpolate", Keywords="Alpha,Lerp,LinearInterpolate", Category = "Simulation|Time", PrototypeName = "AlphaInterp", MenuDescSuffix = "(Float)"))
