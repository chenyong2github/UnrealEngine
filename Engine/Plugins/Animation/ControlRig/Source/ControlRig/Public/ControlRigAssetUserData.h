...
*/
UCLASS(Abstract)
class CONTROLRIG_API UNameSpacedUserData : public UAssetUserData
{
	GENERATED_BODY()
...
public:
	...
	struct CONTROLRIG_API FUserData
	{
	public:
...
class CONTROLRIG_API UDataAssetLink : public UNameSpacedUserData
{
	GENERATED_BODY()
