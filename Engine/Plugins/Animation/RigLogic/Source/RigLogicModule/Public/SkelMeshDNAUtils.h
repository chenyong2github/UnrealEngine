...
private:
	...
	inline static void GetLODRange(ELodUpdateOption UpdateOption, const int32& LODNum, int32& LODStart, int32& LODEnd)
	{
		LODStart = 0;
		LODEnd = LODNum;
		...
		else if (UpdateOption == ELodUpdateOption::LOD0Only)
		{
			LODEnd = LODEnd > 0 ? 1 : 0;
		}
	}
