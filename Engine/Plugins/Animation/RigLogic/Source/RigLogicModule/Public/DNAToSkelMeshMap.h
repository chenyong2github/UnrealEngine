...
public:
	...
	void InitVertexMap(IDNAReader* DNAReader);
	...
	TArray<TArray<TArray<int32>>>& GetBlendShapeVertexDeltaIndices()
	{
		return BlendShapeVertexDeltaIndices;
	}

	TArray<TArray<int32>> ImportVtxToDNAMeshIndex;
	TArray<TArray<int32>> ImportVtxToDNAVtxIndex;
	TArray<TArray<int32>> ImportDNAVtxToUEVtxIndex;
...
private:
	...
	TArray<TArray<TArray<int32>>> BlendShapeVertexDeltaIndices;
