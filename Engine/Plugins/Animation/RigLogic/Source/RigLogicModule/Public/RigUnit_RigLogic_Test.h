...
struct FRigUnit_RigLogic::TestAccessor
{
	...
	void Exec_MapInputCurve(FSharedRigRuntimeContext* Context, FRigCurveContainer* TestCurveContainer);
	...
	void Exec_MapJoints(FSharedRigRuntimeContext* Context, FRigBoneHierarchy* MockHierachy);
	...
	void Exec_MapMorphTargets(FSharedRigRuntimeContext* Context, FRigCurveContainer* TestCurveContainer);

	/** MapMaskMultipliers Tests **/
	TSharedPtr<TestBehaviorReader> CreateBehaviorReaderOneAnimatedMap(FString AnimatedMapNameStr);

	void Exec_MapMaskMultipliers(FSharedRigRuntimeContext* Context, FRigCurveContainer* TestCurveContainer);
	...
	void Exec_UpdateJoints(FSharedRigRuntimeContext* Context, FRigHierarchyContainer* TestHierarchyContainer, FRigUnit_RigLogic_JointUpdateParams& JointUpdateParams);
